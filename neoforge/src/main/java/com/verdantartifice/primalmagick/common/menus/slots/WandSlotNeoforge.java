 ...
 * @author Daedalus4096
 */
public class WandSlotNeoforge extends FilteredSlotNeoforge implements IWandSlot {
    ...
    public WandSlotNeoforge(IItemHandler inventoryIn, int index, int xPosition, int yPosition, boolean allowStaves) {
