...
public class CapabilityEvents {
    ...
    public static void onRegisterCapabilities(final RegisterCapabilitiesEvent event) {
        ...
        event.registerBlockEntity(Capabilities.Item.BLOCK, BlockEntityTypesPM.RITUAL_LECTERN.get(), (be, face) -> cast(be.getRawItemHandler(face)));
        event.registerBlockEntity(Capabilities.Item.BLOCK, BlockEntityTypesPM.RUNECARVING_TABLE.get(), (be, face) -> cast(be.getRawItemHandler(face)));
        event.registerBlockEntity(Capabilities.Item.BLOCK, BlockEntityTypesPM.SANGUINE_CRUCIBLE.get(), (be, face) -> cast(be.getRawItemHandler(face)));
        event.registerBlockEntity(Capabilities.Item.BLOCK, BlockEntityTypesPM.SCRIBE_TABLE.get(), (be, face) -> cast(be.getRawItemHandler(face)));
