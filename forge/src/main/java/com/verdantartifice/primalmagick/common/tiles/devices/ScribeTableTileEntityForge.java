...
public class ScribeTableTileEntityForge extends ScribeTableTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public ScribeTableTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
