...
public class RitualAltarTileEntityForge extends RitualAltarTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public RitualAltarTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
