...
public class WandChargerTileEntityForge extends WandChargerTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public WandChargerTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
