...
public class AutoChargerTileEntityForge extends AutoChargerTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public AutoChargerTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
