...
public class ResearchTableTileEntityForge extends ResearchTableTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public ResearchTableTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
