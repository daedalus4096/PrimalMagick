...
public class EssenceCaskTileEntityForge extends EssenceCaskTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public EssenceCaskTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
