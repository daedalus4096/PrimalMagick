...
public class ManaRelayBlockItemForge extends ManaRelayBlockItem implements IHasCustomRendererForge {
    private IClientItemExtensions renderProps;

    public ManaRelayBlockItemForge(Block block, Item.Properties properties) {
