...
public class RunecarvingTableTileEntityForge extends RunecarvingTableTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public RunecarvingTableTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
