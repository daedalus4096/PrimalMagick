...
public class SanguineCrucibleTileEntityForge extends SanguineCrucibleTileEntity implements IHasItemHandlerCapabilityForge {
    protected final NonNullList<LazyOptional<IItemHandler>> itemHandlerOpts;

    public SanguineCrucibleTileEntityForge(BlockPos pos, BlockState state) {
        super(pos, state);
