...
public class ItemRegistration {
    ...
    public static final RegistryObject<BlockItem> MARBLE_RAW = registerSupplier("marble_raw", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_RAW), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SLAB = registerSupplier("marble_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_STAIRS = registerSupplier("marble_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_WALL = registerSupplier("marble_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICKS = registerSupplier("marble_bricks", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_BRICKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_SLAB = registerSupplier("marble_brick_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_BRICK_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_STAIRS = registerSupplier("marble_brick_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_BRICK_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_WALL = registerSupplier("marble_brick_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_BRICK_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_PILLAR = registerSupplier("marble_pillar", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_PILLAR), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_CHISELED = registerSupplier("marble_chiseled", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_CHISELED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_RUNED = registerSupplier("marble_runed", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_RUNED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_TILES = registerSupplier("marble_tiles", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_TILES), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BOOKSHELF = registerSupplier("marble_bookshelf", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_BOOKSHELF), new Item.Properties()));

    // Register enchanted marble block items
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED = registerSupplier("marble_enchanted", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_SLAB = registerSupplier("marble_enchanted_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_STAIRS = registerSupplier("marble_enchanted_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_WALL = registerSupplier("marble_enchanted_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICKS = registerSupplier("marble_enchanted_bricks", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_BRICKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_SLAB = registerSupplier("marble_enchanted_brick_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_BRICK_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_STAIRS = registerSupplier("marble_enchanted_brick_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_BRICK_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_WALL = registerSupplier("marble_enchanted_brick_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_BRICK_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_PILLAR = registerSupplier("marble_enchanted_pillar", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_PILLAR), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_CHISELED = registerSupplier("marble_enchanted_chiseled", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_CHISELED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_RUNED = registerSupplier("marble_enchanted_runed", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_RUNED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BOOKSHELF = registerSupplier("marble_enchanted_bookshelf", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_ENCHANTED_BOOKSHELF), new Item.Properties()));

    // Register smoked marble block items
    public static final RegistryObject<BlockItem> MARBLE_SMOKED = registerSupplier("marble_smoked", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_SLAB = registerSupplier("marble_smoked_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_STAIRS = registerSupplier("marble_smoked_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_WALL = registerSupplier("marble_smoked_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICKS = registerSupplier("marble_smoked_bricks", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_BRICKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_SLAB = registerSupplier("marble_smoked_brick_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_BRICK_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_STAIRS = registerSupplier("marble_smoked_brick_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_BRICK_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_WALL = registerSupplier("marble_smoked_brick_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_BRICK_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_PILLAR = registerSupplier("marble_smoked_pillar", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_PILLAR), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_CHISELED = registerSupplier("marble_smoked_chiseled", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_CHISELED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_RUNED = registerSupplier("marble_smoked_runed", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_RUNED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BOOKSHELF = registerSupplier("marble_smoked_bookshelf", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_SMOKED_BOOKSHELF), new Item.Properties()));

    // Register hallowed marble block items
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED = registerSupplier("marble_hallowed", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_SLAB = registerSupplier("marble_hallowed_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_STAIRS = registerSupplier("marble_hallowed_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_WALL = registerSupplier("marble_hallowed_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICKS = registerSupplier("marble_hallowed_bricks", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_BRICKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_SLAB = registerSupplier("marble_hallowed_brick_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_BRICK_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_STAIRS = registerSupplier("marble_hallowed_brick_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_BRICK_STAIRS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_WALL = registerSupplier("marble_hallowed_brick_wall", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_BRICK_WALL), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_PILLAR = registerSupplier("marble_hallowed_pillar", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_PILLAR), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_CHISELED = registerSupplier("marble_hallowed_chiseled", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_CHISELED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_RUNED = registerSupplier("marble_hallowed_runed", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_RUNED), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BOOKSHELF = registerSupplier("marble_hallowed_bookshelf", () -> new BlockItem(BlocksPM.get(BlocksPM.MARBLE_HALLOWED_BOOKSHELF), new Item.Properties()));

    // Register sunwood block items
    public static final RegistryObject<BlockItem> SUNWOOD_LOG = registerSupplier("sunwood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_SUNWOOD_LOG = registerSupplier("stripped_sunwood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_SUNWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_WOOD = registerSupplier("sunwood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_SUNWOOD_WOOD = registerSupplier("stripped_sunwood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_SUNWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_LEAVES = registerSupplier("sunwood_leaves", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_LEAVES), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_SAPLING = registerSupplier("sunwood_sapling", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_SAPLING), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_PLANKS = registerSupplier("sunwood_planks", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_PLANKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_SLAB = registerSupplier("sunwood_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_STAIRS = registerSupplier("sunwood_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNWOOD_STAIRS), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> SUNWOOD_PILLAR = registerSupplier("sunwood_pillar", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.SUNWOOD_PILLAR), 300, new Item.Properties()));

    // Register moonwood block items
    public static final RegistryObject<BlockItem> MOONWOOD_LOG = registerSupplier("moonwood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_MOONWOOD_LOG = registerSupplier("stripped_moonwood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_MOONWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_WOOD = registerSupplier("moonwood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_MOONWOOD_WOOD = registerSupplier("stripped_moonwood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_MOONWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_LEAVES = registerSupplier("moonwood_leaves", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_LEAVES), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_SAPLING = registerSupplier("moonwood_sapling", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_SAPLING), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_PLANKS = registerSupplier("moonwood_planks", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_PLANKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_SLAB = registerSupplier("moonwood_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_STAIRS = registerSupplier("moonwood_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.MOONWOOD_STAIRS), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> MOONWOOD_PILLAR = registerSupplier("moonwood_pillar", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.MOONWOOD_PILLAR), 300, new Item.Properties()));
    
    // Register hallowood block items
    public static final RegistryObject<BlockItem> HALLOWOOD_LOG = registerSupplier("hallowood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_HALLOWOOD_LOG = registerSupplier("stripped_hallowood_log", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_HALLOWOOD_LOG), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_WOOD = registerSupplier("hallowood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_HALLOWOOD_WOOD = registerSupplier("stripped_hallowood_wood", () -> new BlockItem(BlocksPM.get(BlocksPM.STRIPPED_HALLOWOOD_WOOD), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_LEAVES = registerSupplier("hallowood_leaves", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_LEAVES), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_SAPLING = registerSupplier("hallowood_sapling", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_SAPLING), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_PLANKS = registerSupplier("hallowood_planks", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_PLANKS), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_SLAB = registerSupplier("hallowood_slab", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_SLAB), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_STAIRS = registerSupplier("hallowood_stairs", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWOOD_STAIRS), new Item.Properties()));
    ...
    public static final RegistryObject<DoubleHighBlockItem> EMBERFLOWER = registerSupplier("emberflower", () -> new DoubleHighBlockItem(BlocksPM.get(BlocksPM.EMBERFLOWER), new Item.Properties()));

    // Register infused stone block items
    public static final RegistryObject<BlockItem> INFUSED_STONE_EARTH = registerSupplier("infused_stone_earth", () -> new BlockItem(BlocksPM.get(BlocksPM.INFUSED_STONE_EARTH), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SEA = registerSupplier("infused_stone_sea", () -> new BlockItem(BlocksPM.get(BlocksPM.INFUSED_STONE_SEA), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SKY = registerSupplier("infused_stone_sky", () -> new BlockItem(BlocksPM.get(BlocksPM.INFUSED_STONE_SKY), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SUN = registerSupplier("infused_stone_sun", () -> new BlockItem(BlocksPM.get(BlocksPM.INFUSED_STONE_SUN), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_MOON = registerSupplier("infused_stone_moon", () -> new BlockItem(BlocksPM.get(BlocksPM.INFUSED_STONE_MOON), new Item.Properties()));
    
    // Register budding gem block items
    public static final RegistryObject<BlockItem> SYNTHETIC_AMETHYST_CLUSTER = registerSupplier("synthetic_amethyst_cluster", () -> new BlockItem(BlocksPM.get(BlocksPM.SYNTHETIC_AMETHYST_CLUSTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_AMETHYST_BUD = registerSupplier("large_synthetic_amethyst_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.LARGE_SYNTHETIC_AMETHYST_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_AMETHYST_BUD = registerSupplier("medium_synthetic_amethyst_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.MEDIUM_SYNTHETIC_AMETHYST_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_AMETHYST_BUD = registerSupplier("small_synthetic_amethyst_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.SMALL_SYNTHETIC_AMETHYST_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_AMETHYST_BLOCK = registerSupplier("damaged_budding_amethyst_block", () -> new BlockItem(BlocksPM.get(BlocksPM.DAMAGED_BUDDING_AMETHYST_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_AMETHYST_BLOCK = registerSupplier("chipped_budding_amethyst_block", () -> new BlockItem(BlocksPM.get(BlocksPM.CHIPPED_BUDDING_AMETHYST_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_AMETHYST_BLOCK = registerSupplier("flawed_budding_amethyst_block", () -> new BlockItem(BlocksPM.get(BlocksPM.FLAWED_BUDDING_AMETHYST_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_DIAMOND_CLUSTER = registerSupplier("synthetic_diamond_cluster", () -> new BlockItem(BlocksPM.get(BlocksPM.SYNTHETIC_DIAMOND_CLUSTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_DIAMOND_BUD = registerSupplier("large_synthetic_diamond_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.LARGE_SYNTHETIC_DIAMOND_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_DIAMOND_BUD = registerSupplier("medium_synthetic_diamond_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.MEDIUM_SYNTHETIC_DIAMOND_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_DIAMOND_BUD = registerSupplier("small_synthetic_diamond_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.SMALL_SYNTHETIC_DIAMOND_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_DIAMOND_BLOCK = registerSupplier("damaged_budding_diamond_block", () -> new BlockItem(BlocksPM.get(BlocksPM.DAMAGED_BUDDING_DIAMOND_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_DIAMOND_BLOCK = registerSupplier("chipped_budding_diamond_block", () -> new BlockItem(BlocksPM.get(BlocksPM.CHIPPED_BUDDING_DIAMOND_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_DIAMOND_BLOCK = registerSupplier("flawed_budding_diamond_block", () -> new BlockItem(BlocksPM.get(BlocksPM.FLAWED_BUDDING_DIAMOND_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_EMERALD_CLUSTER = registerSupplier("synthetic_emerald_cluster", () -> new BlockItem(BlocksPM.get(BlocksPM.SYNTHETIC_EMERALD_CLUSTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_EMERALD_BUD = registerSupplier("large_synthetic_emerald_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.LARGE_SYNTHETIC_EMERALD_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_EMERALD_BUD = registerSupplier("medium_synthetic_emerald_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.MEDIUM_SYNTHETIC_EMERALD_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_EMERALD_BUD = registerSupplier("small_synthetic_emerald_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.SMALL_SYNTHETIC_EMERALD_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_EMERALD_BLOCK = registerSupplier("damaged_budding_emerald_block", () -> new BlockItem(BlocksPM.get(BlocksPM.DAMAGED_BUDDING_EMERALD_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_EMERALD_BLOCK = registerSupplier("chipped_budding_emerald_block", () -> new BlockItem(BlocksPM.get(BlocksPM.CHIPPED_BUDDING_EMERALD_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_EMERALD_BLOCK = registerSupplier("flawed_budding_emerald_block", () -> new BlockItem(BlocksPM.get(BlocksPM.FLAWED_BUDDING_EMERALD_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_QUARTZ_CLUSTER = registerSupplier("synthetic_quartz_cluster", () -> new BlockItem(BlocksPM.get(BlocksPM.SYNTHETIC_QUARTZ_CLUSTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_QUARTZ_BUD = registerSupplier("large_synthetic_quartz_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.LARGE_SYNTHETIC_QUARTZ_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_QUARTZ_BUD = registerSupplier("medium_synthetic_quartz_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.MEDIUM_SYNTHETIC_QUARTZ_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_QUARTZ_BUD = registerSupplier("small_synthetic_quartz_bud", () -> new BlockItem(BlocksPM.get(BlocksPM.SMALL_SYNTHETIC_QUARTZ_BUD), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_QUARTZ_BLOCK = registerSupplier("damaged_budding_quartz_block", () -> new BlockItem(BlocksPM.get(BlocksPM.DAMAGED_BUDDING_QUARTZ_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_QUARTZ_BLOCK = registerSupplier("chipped_budding_quartz_block", () -> new BlockItem(BlocksPM.get(BlocksPM.CHIPPED_BUDDING_QUARTZ_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_QUARTZ_BLOCK = registerSupplier("flawed_budding_quartz_block", () -> new BlockItem(BlocksPM.get(BlocksPM.FLAWED_BUDDING_QUARTZ_BLOCK), new Item.Properties()));

    // Register skyglass block items
    public static final RegistryObject<BlockItem> SKYGLASS = registerSupplier("skyglass", () -> new BlockItem(BlocksPM.get(BlocksPM.SKYGLASS), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BLACK = registerSupplier("stained_skyglass_black", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_BLACK), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BLUE = registerSupplier("stained_skyglass_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BROWN = registerSupplier("stained_skyglass_brown", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_BROWN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_CYAN = registerSupplier("stained_skyglass_cyan", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_CYAN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_GRAY = registerSupplier("stained_skyglass_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_GREEN = registerSupplier("stained_skyglass_green", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_GREEN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIGHT_BLUE = registerSupplier("stained_skyglass_light_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_LIGHT_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIGHT_GRAY = registerSupplier("stained_skyglass_light_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_LIGHT_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIME = registerSupplier("stained_skyglass_lime", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_LIME), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_MAGENTA = registerSupplier("stained_skyglass_magenta", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_MAGENTA), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_ORANGE = registerSupplier("stained_skyglass_orange", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_ORANGE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PINK = registerSupplier("stained_skyglass_pink", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PINK), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PURPLE = registerSupplier("stained_skyglass_purple", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PURPLE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_RED = registerSupplier("stained_skyglass_red", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_RED), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_WHITE = registerSupplier("stained_skyglass_white", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_WHITE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_YELLOW = registerSupplier("stained_skyglass_yellow", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_YELLOW), new Item.Properties()));

    // Register skyglass pane block items
    public static final RegistryObject<BlockItem> SKYGLASS_PANE = registerSupplier("skyglass_pane", () -> new BlockItem(BlocksPM.get(BlocksPM.SKYGLASS_PANE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BLACK = registerSupplier("stained_skyglass_pane_black", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_BLACK), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BLUE = registerSupplier("stained_skyglass_pane_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BROWN = registerSupplier("stained_skyglass_pane_brown", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_BROWN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_CYAN = registerSupplier("stained_skyglass_pane_cyan", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_CYAN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_GRAY = registerSupplier("stained_skyglass_pane_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_GREEN = registerSupplier("stained_skyglass_pane_green", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_GREEN), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIGHT_BLUE = registerSupplier("stained_skyglass_pane_light_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_LIGHT_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIGHT_GRAY = registerSupplier("stained_skyglass_pane_light_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_LIGHT_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIME = registerSupplier("stained_skyglass_pane_lime", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_LIME), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_MAGENTA = registerSupplier("stained_skyglass_pane_magenta", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_MAGENTA), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_ORANGE = registerSupplier("stained_skyglass_pane_orange", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_ORANGE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_PINK = registerSupplier("stained_skyglass_pane_pink", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_PINK), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_PURPLE = registerSupplier("stained_skyglass_pane_purple", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_PURPLE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_RED = registerSupplier("stained_skyglass_pane_red", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_RED), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_WHITE = registerSupplier("stained_skyglass_pane_white", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_WHITE), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_YELLOW = registerSupplier("stained_skyglass_pane_yellow", () -> new BlockItem(BlocksPM.get(BlocksPM.STAINED_SKYGLASS_PANE_YELLOW), new Item.Properties()));

    // Register ritual candle block items
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BLACK = registerSupplier("ritual_candle_black", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_BLACK), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BLUE = registerSupplier("ritual_candle_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BROWN = registerSupplier("ritual_candle_brown", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_BROWN), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_CYAN = registerSupplier("ritual_candle_cyan", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_CYAN), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_GRAY = registerSupplier("ritual_candle_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_GREEN = registerSupplier("ritual_candle_green", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_GREEN), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIGHT_BLUE = registerSupplier("ritual_candle_light_blue", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_LIGHT_BLUE), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIGHT_GRAY = registerSupplier("ritual_candle_light_gray", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_LIGHT_GRAY), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIME = registerSupplier("ritual_candle_lime", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_LIME), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_MAGENTA = registerSupplier("ritual_candle_magenta", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_MAGENTA), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_ORANGE = registerSupplier("ritual_candle_orange", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_ORANGE), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_PINK = registerSupplier("ritual_candle_pink", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_PINK), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_PURPLE = registerSupplier("ritual_candle_purple", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_PURPLE), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_RED = registerSupplier("ritual_candle_red", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_RED), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_WHITE = registerSupplier("ritual_candle_white", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_WHITE), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_YELLOW = registerSupplier("ritual_candle_yellow", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_CANDLE_YELLOW), new Item.Properties()));

    // Register mana font block items
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_EARTH = registerSupplier("ancient_font_earth", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ANCIENT_FONT_EARTH), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SEA = registerSupplier("ancient_font_sea", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ANCIENT_FONT_SEA), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SKY = registerSupplier("ancient_font_sky", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ANCIENT_FONT_SKY), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SUN = registerSupplier("ancient_font_sun", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ANCIENT_FONT_SUN), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_MOON = registerSupplier("ancient_font_moon", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ANCIENT_FONT_MOON), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_EARTH = registerSupplier("artificial_font_earth", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_EARTH), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SEA = registerSupplier("artificial_font_sea", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_SEA), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SKY = registerSupplier("artificial_font_sky", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_SKY), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SUN = registerSupplier("artificial_font_sun", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_SUN), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_MOON = registerSupplier("artificial_font_moon", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_MOON), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_BLOOD = registerSupplier("artificial_font_blood", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_BLOOD), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_INFERNAL = registerSupplier("artificial_font_infernal", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_INFERNAL), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_VOID = registerSupplier("artificial_font_void", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_VOID), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_HALLOWED = registerSupplier("artificial_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.ARTIFICIAL_FONT_HALLOWED), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_EARTH = registerSupplier("forbidden_font_earth", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_EARTH), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SEA = registerSupplier("forbidden_font_sea", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_SEA), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SKY = registerSupplier("forbidden_font_sky", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_SKY), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SUN = registerSupplier("forbidden_font_sun", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_SUN), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_MOON = registerSupplier("forbidden_font_moon", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_MOON), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_BLOOD = registerSupplier("forbidden_font_blood", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_BLOOD), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_INFERNAL = registerSupplier("forbidden_font_infernal", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_INFERNAL), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_VOID = registerSupplier("forbidden_font_void", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_VOID), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_HALLOWED = registerSupplier("forbidden_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.FORBIDDEN_FONT_HALLOWED), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_EARTH = registerSupplier("heavenly_font_earth", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_EARTH), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SEA = registerSupplier("heavenly_font_sea", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_SEA), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SKY = registerSupplier("heavenly_font_sky", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_SKY), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SUN = registerSupplier("heavenly_font_sun", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_SUN), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_MOON = registerSupplier("heavenly_font_moon", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_MOON), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_BLOOD = registerSupplier("heavenly_font_blood", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_BLOOD), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_INFERNAL = registerSupplier("heavenly_font_infernal", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_INFERNAL), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_VOID = registerSupplier("heavenly_font_void", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_VOID), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_HALLOWED = registerSupplier("heavenly_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.get(BlocksPM.HEAVENLY_FONT_HALLOWED), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    
    // Register device block items
    public static final RegistryObject<BurnableBlockItem> ARCANE_WORKBENCH = registerSupplier("arcane_workbench", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.ARCANE_WORKBENCH), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> WAND_ASSEMBLY_TABLE = registerSupplier("wand_assembly_table", () -> new BlockItem(BlocksPM.get(BlocksPM.WAND_ASSEMBLY_TABLE), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> WOOD_TABLE = registerSupplier("wood_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.WOOD_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> ANALYSIS_TABLE = registerSupplier("analysis_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.ANALYSIS_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> ESSENCE_FURNACE = registerSupplier("essence_furnace", () -> new BlockItem(BlocksPM.get(BlocksPM.ESSENCE_FURNACE), new Item.Properties()));
    public static final RegistryObject<BlockItem> CALCINATOR_BASIC = registerSupplier("calcinator_basic", () -> new BlockItem(BlocksPM.get(BlocksPM.CALCINATOR_BASIC), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> CALCINATOR_ENCHANTED = registerSupplier("calcinator_enchanted", () -> new BlockItem(BlocksPM.get(BlocksPM.CALCINATOR_ENCHANTED), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> CALCINATOR_FORBIDDEN = registerSupplier("calcinator_forbidden", () -> new BlockItem(BlocksPM.get(BlocksPM.CALCINATOR_FORBIDDEN), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> CALCINATOR_HEAVENLY = registerSupplier("calcinator_heavenly", () -> new BlockItem(BlocksPM.get(BlocksPM.CALCINATOR_HEAVENLY), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> WAND_INSCRIPTION_TABLE = registerSupplier("wand_inscription_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.WAND_INSCRIPTION_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<SpellcraftingAltarBlockItem> SPELLCRAFTING_ALTAR = registerSupplier("spellcrafting_altar", () -> new SpellcraftingAltarBlockItem(BlocksPM.get(BlocksPM.SPELLCRAFTING_ALTAR), new Item.Properties()));
    public static final RegistryObject<BlockItem> WAND_CHARGER = registerSupplier("wand_charger", () -> new BlockItem(BlocksPM.get(BlocksPM.WAND_CHARGER), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> RESEARCH_TABLE = registerSupplier("research_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.RESEARCH_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNLAMP = registerSupplier("sunlamp", () -> new BlockItem(BlocksPM.get(BlocksPM.SUNLAMP), new Item.Properties()));
    public static final RegistryObject<BlockItem> SPIRIT_LANTERN = registerSupplier("spirit_lantern", () -> new BlockItem(BlocksPM.get(BlocksPM.SPIRIT_LANTERN), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_ALTAR = registerSupplier("ritual_altar", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_ALTAR), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> OFFERING_PEDESTAL = registerSupplier("offering_pedestal", () -> new BlockItem(BlocksPM.get(BlocksPM.OFFERING_PEDESTAL), new Item.Properties()));
    public static final RegistryObject<BlockItem> INCENSE_BRAZIER = registerSupplier("incense_brazier", () -> new BlockItem(BlocksPM.get(BlocksPM.INCENSE_BRAZIER), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> RITUAL_LECTERN = registerSupplier("ritual_lectern", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.RITUAL_LECTERN), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_BELL = registerSupplier("ritual_bell", () -> new BlockItem(BlocksPM.get(BlocksPM.RITUAL_BELL), new Item.Properties()));
    public static final RegistryObject<BlockItem> BLOODLETTER = registerSupplier("bloodletter", () -> new BlockItem(BlocksPM.get(BlocksPM.BLOODLETTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> SOUL_ANVIL = registerSupplier("soul_anvil", () -> new BlockItem(BlocksPM.get(BlocksPM.SOUL_ANVIL), new Item.Properties()));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_BASIC = registerSupplier("runescribing_altar_basic", () -> new BlockItem(BlocksPM.get(BlocksPM.RUNESCRIBING_ALTAR_BASIC), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_ENCHANTED = registerSupplier("runescribing_altar_enchanted", () -> new BlockItem(BlocksPM.get(BlocksPM.RUNESCRIBING_ALTAR_ENCHANTED), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_FORBIDDEN = registerSupplier("runescribing_altar_forbidden", () -> new BlockItem(BlocksPM.get(BlocksPM.RUNESCRIBING_ALTAR_FORBIDDEN), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_HEAVENLY = registerSupplier("runescribing_altar_heavenly", () -> new BlockItem(BlocksPM.get(BlocksPM.RUNESCRIBING_ALTAR_HEAVENLY), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> RUNECARVING_TABLE = registerSupplier("runecarving_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.RUNECARVING_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> RUNIC_GRINDSTONE = registerSupplier("runic_grindstone", () -> new BlockItem(BlocksPM.get(BlocksPM.RUNIC_GRINDSTONE), new Item.Properties()));
    public static final RegistryObject<BlockItem> HONEY_EXTRACTOR = registerSupplier("honey_extractor", () -> new BlockItem(BlocksPM.get(BlocksPM.HONEY_EXTRACTOR), new Item.Properties()));
    public static final RegistryObject<BlockItem> PRIMALITE_GOLEM_CONTROLLER = registerSupplier("primalite_golem_controller", () -> new BlockItem(BlocksPM.get(BlocksPM.PRIMALITE_GOLEM_CONTROLLER), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> HEXIUM_GOLEM_CONTROLLER = registerSupplier("hexium_golem_controller", () -> new BlockItem(BlocksPM.get(BlocksPM.HEXIUM_GOLEM_CONTROLLER), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> HALLOWSTEEL_GOLEM_CONTROLLER = registerSupplier("hallowsteel_golem_controller", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWSTEEL_GOLEM_CONTROLLER), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BlockItem> SANGUINE_CRUCIBLE = registerSupplier("sanguine_crucible", () -> new BlockItem(BlocksPM.get(BlocksPM.SANGUINE_CRUCIBLE), new Item.Properties()));
    public static final RegistryObject<BlockItem> CONCOCTER = registerSupplier("concocter", () -> new BlockItem(BlocksPM.get(BlocksPM.CONCOCTER), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> CELESTIAL_HARP = registerSupplier("celestial_harp", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.CELESTIAL_HARP), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> ENTROPY_SINK = registerSupplier("entropy_sink", () -> new BlockItem(BlocksPM.get(BlocksPM.ENTROPY_SINK), new Item.Properties()));
    public static final RegistryObject<BlockItem> AUTO_CHARGER = registerSupplier("auto_charger", () -> new BlockItem(BlocksPM.get(BlocksPM.AUTO_CHARGER), new Item.Properties()));
    public static final RegistryObject<BlockItem> ESSENCE_TRANSMUTER = registerSupplier("essence_transmuter", () -> new BlockItem(BlocksPM.get(BlocksPM.ESSENCE_TRANSMUTER), new Item.Properties()));
    public static final RegistryObject<BlockItem> DISSOLUTION_CHAMBER = registerSupplier("dissolution_chamber", () -> new BlockItem(BlocksPM.get(BlocksPM.DISSOLUTION_CHAMBER), new Item.Properties()));
    public static final RegistryObject<BlockItem> ZEPHYR_ENGINE = registerSupplier("zephyr_engine", () -> new BlockItem(BlocksPM.get(BlocksPM.ZEPHYR_ENGINE), new Item.Properties()));
    public static final RegistryObject<BlockItem> VOID_TURBINE = registerSupplier("void_turbine", () -> new BlockItem(BlocksPM.get(BlocksPM.VOID_TURBINE), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_ENCHANTED = registerSupplier("essence_cask_enchanted", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.ESSENCE_CASK_ENCHANTED), 300, new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_FORBIDDEN = registerSupplier("essence_cask_forbidden", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.ESSENCE_CASK_FORBIDDEN), 300, new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_HEAVENLY = registerSupplier("essence_cask_heavenly", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.ESSENCE_CASK_HEAVENLY), 300, new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> WAND_GLAMOUR_TABLE = registerSupplier("wand_glamour_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.WAND_GLAMOUR_TABLE), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> INFERNAL_FURNACE = registerSupplier("infernal_furnace", () -> new BlockItem(BlocksPM.get(BlocksPM.INFERNAL_FURNACE), new Item.Properties()));
    public static final RegistryObject<BlockItem> MANA_NEXUS = registerSupplier("mana_nexus", () -> new BlockItem(BlocksPM.get(BlocksPM.MANA_NEXUS), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> MANA_SINGULARITY = registerSupplier("mana_singularity", () -> new BlockItem(BlocksPM.get(BlocksPM.MANA_SINGULARITY), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BlockItem> MANA_SINGULARITY_CREATIVE = registerSupplier("mana_singularity_creative", () -> new BlockItem(BlocksPM.get(BlocksPM.MANA_SINGULARITY_CREATIVE), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> SCRIBE_TABLE = registerSupplier("scribe_table", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.SCRIBE_TABLE), 300, new Item.Properties()));

    // Register miscellaneous block items
    public static final RegistryObject<ItemNameBlockItem> REFINED_SALT = registerSupplier("refined_salt", () -> new ItemNameBlockItem(BlocksPM.get(BlocksPM.SALT_TRAIL), new Item.Properties()));
    public static final RegistryObject<BlockItem> ROCK_SALT_ORE = registerSupplier("rock_salt_ore", () -> new BlockItem(BlocksPM.get(BlocksPM.ROCK_SALT_ORE), new Item.Properties()));
    public static final RegistryObject<BlockItem> QUARTZ_ORE = registerSupplier("quartz_ore", () -> new BlockItem(BlocksPM.get(BlocksPM.QUARTZ_ORE), new Item.Properties()));
    public static final RegistryObject<BlockItem> PRIMALITE_BLOCK = registerSupplier("primalite_block", () -> new BlockItem(BlocksPM.get(BlocksPM.PRIMALITE_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> HEXIUM_BLOCK = registerSupplier("hexium_block", () -> new BlockItem(BlocksPM.get(BlocksPM.HEXIUM_BLOCK), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWSTEEL_BLOCK = registerSupplier("hallowsteel_block", () -> new BlockItem(BlocksPM.get(BlocksPM.HALLOWSTEEL_BLOCK), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> IGNYX_BLOCK = registerSupplier("ignyx_block", () -> new BurnableBlockItem(BlocksPM.get(BlocksPM.IGNYX_BLOCK), 128000, new Item.Properties()));
    public static final RegistryObject<BlockItem> SALT_BLOCK = registerSupplier("salt_block", () -> new BlockItem(BlocksPM.get(BlocksPM.SALT_BLOCK), new Item.Properties()));
    public static final RegistryObject<ItemNameBlockItem> TREEFOLK_SEED = registerSupplier("treefolk_seed", () -> new ItemNameBlockItem(BlocksPM.get(BlocksPM.TREEFOLK_SPROUT), new Item.Properties()));
    public static final RegistryObject<BlockItem> ENDERWARD = registerSupplier("enderward", () -> new BlockItem(BlocksPM.get(BlocksPM.ENDERWARD), new Item.Properties().stacksTo(16)));
