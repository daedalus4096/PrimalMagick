...
public class EntityTypeTagsProviderPMForge extends EntityTypeTagsProvider {
    public EntityTypeTagsProviderPMForge(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider, ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        this.tag(EntityTypeTagsPM.PIXIES).add(EntityTypesPM.BASIC_EARTH_PIXIE.get(), EntityTypesPM.GRAND_EARTH_PIXIE.get(), EntityTypesPM.MAJESTIC_EARTH_PIXIE.get(),
                ...
                EntityTypesPM.BASIC_GUARDIAN_PIXIE.get(), EntityTypesPM.GRAND_GUARDIAN_PIXIE.get(), EntityTypesPM.MAJESTIC_GUARDIAN_PIXIE.get());
