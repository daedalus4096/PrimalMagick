...
public class MobEffectTagsProviderPMForge extends IntrinsicHolderTagsProvider<MobEffect> {
    public MobEffectTagsProviderPMForge(PackOutput output, CompletableFuture<HolderLookup.Provider> future, ExistingFileHelper helper) {
        super(output, Registries.MOB_EFFECT, future, mobEffect -> BuiltInRegistries.MOB_EFFECT.getResourceKey(mobEffect).get(), Constants.MOD_ID, helper);
    }
