...
public class ItemModelProviderPMForge extends ModelProvider<ItemModelBuilderPMForge> {
    ...
    private ItemModelBuilderPMForge builder(ResourceLocation loc) {
    ...
    private ItemModelBuilderPMForge itemWithParent(Item item, ResourceLocation parent) {
    ...
    private ItemModelBuilderPMForge shieldItem(ShieldItem item, ResourceLocation particleTexture) {
        return this.builder(item)
                .parent(new ModelFile.UncheckedModelFile("builtin/entity"))
                .guiLight(GuiLight.FRONT)
    ...
    private ItemModelBuilderPMForge shieldBlockingModel(ShieldItem item, ResourceLocation particleTexture) {
    ...
    private ItemModelBuilderPMForge armorItemWithTrims(ArmorItem item, ResourceLocation trimOverlayLoc, List<Holder<TrimMaterial>> trims) {
    ...
    private ItemModelBuilderPMForge trimmedArmorModel(ArmorItem item, ResourceLocation trimOverlayLoc, Holder<TrimMaterial> trim) {
