...
public class BlockTagsProviderPMForge extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        this.tag(BlockTags.FLOWER_POTS).add(BlocksPM.POTTED_SUNWOOD_SAPLING.get(), BlocksPM.POTTED_MOONWOOD_SAPLING.get(), BlocksPM.POTTED_HALLOWOOD_SAPLING.get());
