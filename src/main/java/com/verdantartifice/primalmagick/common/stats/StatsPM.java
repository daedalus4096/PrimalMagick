...
public class StatsPM {
    ...
    public static final Stat MANA_SPENT_TOTAL = Stat.builder("mana_spent_total").hasHint().build();
    public static final Stat MANA_SPENT_EARTH = Stat.builder("mana_spent_earth").hasHint().build();
    public static final Stat MANA_SPENT_SEA = Stat.builder("mana_spent_sea").hasHint().build();
    public static final Stat MANA_SPENT_SKY = Stat.builder("mana_spent_sky").hasHint().build();
    public static final Stat MANA_SPENT_SUN = Stat.builder("mana_spent_sun").hasHint().build();
    public static final Stat MANA_SPENT_MOON = Stat.builder("mana_spent_moon").hasHint().build();
    public static final Stat MANA_SPENT_BLOOD = Stat.builder("mana_spent_blood").hidden().hasHint().build();
    public static final Stat MANA_SPENT_INFERNAL = Stat.builder("mana_spent_infernal").hidden().hasHint().build();
    public static final Stat MANA_SPENT_VOID = Stat.builder("mana_spent_void").hidden().hasHint().build();
    public static final Stat MANA_SPENT_HALLOWED = Stat.builder("mana_spent_hallowed").hidden().hasHint().build();
