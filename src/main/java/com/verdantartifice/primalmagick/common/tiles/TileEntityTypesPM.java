...
public class TileEntityTypesPM {
    ...
    public static final RegistryObject<BlockEntityType<ManaBatteryTileEntity>> MANA_BATTERY = TILE_ENTITIES.register("mana_battery", () -> BlockEntityType.Builder.of(ManaBatteryTileEntity::new, BlocksPM.MANA_NEXUS.get(), BlocksPM.MANA_SINGULARITY.get()).build(null));
}
