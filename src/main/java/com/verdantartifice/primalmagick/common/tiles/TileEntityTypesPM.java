...
public class TileEntityTypesPM {
    ...
    public static final RegistryObject<BlockEntityType<CarvedBookshelfTileEntity>> CARVED_BOOKSHELF = TILE_ENTITIES.register("carved_bookshelf", () -> BlockEntityType.Builder.of(CarvedBookshelfTileEntity::new, BlocksPM.MARBLE_BOOKSHELF.get()).build(null));
}
