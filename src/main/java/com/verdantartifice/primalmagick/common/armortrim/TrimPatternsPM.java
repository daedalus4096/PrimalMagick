...
public class TrimPatternsPM {
    ...
    protected static final Component RUNIC_ARMOR_TRIM_APPLIES_TO = Component.translatable(Util.makeDescriptionId("tooltip", new ResourceLocation(PrimalMagick.MODID, "smithing_template.runic_armor_trim.applies_to"))).withStyle(DESCRIPTION_FORMAT);
    protected static final Component RUNIC_ARMOR_TRIM_INGREDIENTS = Component.translatable(Util.makeDescriptionId("tooltip", new ResourceLocation(PrimalMagick.MODID, "smithing_template.runic_armor_trim.ingredients"))).withStyle(DESCRIPTION_FORMAT);
    protected static final Component RUNIC_ARMOR_TRIM_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("tooltip", new ResourceLocation(PrimalMagick.MODID, "smithing_template.runic_armor_trim.base_slot_description")));
    protected static final Component RUNIC_ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("tooltip", new ResourceLocation(PrimalMagick.MODID, "smithing_template.runic_armor_trim.additions_slot_description")));
    ...
    protected static final List<ResourceLocation> RUNIC_TRIMMABLE_MATERIAL_ICONS = List.of(new ResourceLocation(PrimalMagick.MODID, "item/empty_rune_slot"));
    ...
    private static ResourceKey<TrimPattern> registryKey(String name) {
        return ResourceKey.create(Registries.TRIM_PATTERN, new ResourceLocation(PrimalMagick.MODID, name));
    }
