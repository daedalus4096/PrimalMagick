...
public class PacketHandler {
    ...
    public static void registerMessages() {
        ...
        INSTANCE.registerMessage(disc++, SetLastResearchTopicPacket.class, SetLastResearchTopicPacket::encode, SetLastResearchTopicPacket::decode, SetLastResearchTopicPacket.Handler::onMessage);
    }
