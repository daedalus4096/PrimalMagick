...
public class ResearchNames {
    ...
    public static final RegistryObject<ResearchName> SPELLS_CAST_SUPREME = register("spells_cast_supreme", () -> new ResearchName("t_spells_cast_supreme"));
    public static final RegistryObject<ResearchName> SPELLS_CRAFTED_EXPERT = register("spells_crafted_expert", () -> new ResearchName("t_spells_crafted_expert"));
    public static final RegistryObject<ResearchName> SPELL_COST_MASTER = register("spell_cost_master", () -> new ResearchName("t_spell_cost_master"));
    public static final RegistryObject<ResearchName> SPELL_COST_SUPREME = register("spell_cost_supreme", () -> new ResearchName("t_spell_cost_supreme"));
    public static final RegistryObject<ResearchName> FOUND_SHRINE_EARTH = register("found_shrine_earth", () -> new ResearchName("m_found_shrine_earth"));
    public static final RegistryObject<ResearchName> FOUND_SHRINE_SEA = register("found_shrine_sea", () -> new ResearchName("m_found_shrine_sea"));
    public static final RegistryObject<ResearchName> FOUND_SHRINE_SKY = register("found_shrine_sky", () -> new ResearchName("m_found_shrine_sky"));
    public static final RegistryObject<ResearchName> FOUND_SHRINE_SUN = register("found_shrine_sun", () -> new ResearchName("m_found_shrine_sun"));
    public static final RegistryObject<ResearchName> FOUND_SHRINE_MOON = register("found_shrine_moon", () -> new ResearchName("m_found_shrine_moon"));
    public static final RegistryObject<ResearchName> MANA_SPENT_EARTH_EXPERT = register("mana_spent_earth_expert", () -> new ResearchName("t_mana_spent_earth_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_SEA_EXPERT = register("mana_spent_sea_expert", () -> new ResearchName("t_mana_spent_sea_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_SKY_EXPERT = register("mana_spent_sky_expert", () -> new ResearchName("t_mana_spent_sky_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_SUN_EXPERT = register("mana_spent_sun_expert", () -> new ResearchName("t_mana_spent_sun_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_MOON_EXPERT = register("mana_spent_moon_expert", () -> new ResearchName("t_mana_spent_moon_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_BLOOD_EXPERT = register("mana_spent_blood_expert", () -> new ResearchName("t_mana_spent_blood_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_INFERNAL_EXPERT = register("mana_spent_infernal_expert", () -> new ResearchName("t_mana_spent_infernal_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_VOID_EXPERT = register("mana_spent_void_expert", () -> new ResearchName("t_mana_spent_void_expert"));
    public static final RegistryObject<ResearchName> MANA_SPENT_HALLOWED_EXPERT = register("mana_spent_hallowed_expert", () -> new ResearchName("t_mana_spent_hallowed_expert"));
    public static final RegistryObject<ResearchName> ENV_EARTH = register("env_earth", () -> new ResearchName("m_env_earth"));
    public static final RegistryObject<ResearchName> ENV_SEA = register("env_sea", () -> new ResearchName("m_env_sea"));
