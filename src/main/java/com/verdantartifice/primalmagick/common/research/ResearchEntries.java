...
*/
    ...
    private static void bootstrapManaweavingEntries(BootstrapContext<ResearchEntry> context) {
        ...
        register(context, COMPLETE_MANAWEAVING, key -> ResearchEntry.builder(key).discipline(discipline).flags(ResearchEntry.Flags.builder().hidden()).icon(ICON_MANAWEAVING).finale(discipline)
                ...
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                        .attunement(Sources.BLOOD, 1).attunement(Sources.INFERNAL, 1).attunement(Sources.VOID, 1).attunement(Sources.HALLOWED, 1).end()
                .build());
        register(context, WAND_CHARGER, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.WAND_CHARGER.get()).parent(BASIC_MANAWEAVING)
                ...
                .build());
        register(context, MANA_SALTS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.MANA_SALTS.get()).parent(WAND_CHARGER)
        ...
        register(context, STAVES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).parent(EXPERT_MANAWEAVING).parent(WAND_GEM_ADEPT)
                ...
                .stage().end()
                .build());
        register(context, WAND_CORE_HEARTWOOD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.HEARTWOOD_WAND_CORE_ITEM.get()).parent(ADVANCED_WANDMAKING)
        ...
        register(context, EARTHSHATTER_HAMMER, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.EARTHSHATTER_HAMMER.get())
                ...
                .build());
        register(context, SUNLAMP, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.SUNLAMP.get()).parent(EXPERT_MANAWEAVING).parent(PRIMALITE)
        ...
        register(context, WAND_CAP_PRIMALITE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMALITE_WAND_CAP_ITEM.get())
                ...
                .build());
        register(context, WAND_CAP_HEXIUM, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.HEXIUM_WAND_CAP_ITEM.get())
                ...
                .build());
        register(context, WAND_CAP_HALLOWSTEEL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.HALLOWSTEEL_WAND_CAP_ITEM.get())
        ...
        register(context, WAND_CORE_OBSIDIAN, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.OBSIDIAN_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, WAND_CORE_CORAL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.CORAL_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, WAND_CORE_BAMBOO, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.BAMBOO_WAND_CORE_ITEM.get())
                .parent(EXPERT_MANAWEAVING).parent(WAND_CORE_OBSIDIAN)
                ...
                .build());
        register(context, WAND_CORE_SUNWOOD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.SUNWOOD_WAND_CORE_ITEM.get())
                .parent(EXPERT_MANAWEAVING).parent(WAND_CORE_OBSIDIAN)
                ...
                .build());
        register(context, WAND_CORE_MOONWOOD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.MOONWOOD_WAND_CORE_ITEM.get())
                .parent(EXPERT_MANAWEAVING).parent(WAND_CORE_OBSIDIAN)
                ...
                .build());
        register(context, WAND_CORE_BONE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.BONE_WAND_CORE_ITEM.get())
        ...
        register(context, WAND_CORE_BLAZE_ROD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.BLAZE_ROD_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, WAND_CORE_PURPUR, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.PURPUR_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, IMBUED_WOOL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.IMBUED_WOOL_HEAD.get()).parent(MANA_ARROWS)
                ...
                .build());
        register(context, SPELLCLOTH, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.SPELLCLOTH_HEAD.get())
                ...
                .build());
        register(context, HEXWEAVE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.HEXWEAVE_HEAD.get())
                ...
                .build());
        register(context, SAINTSWOOL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.SAINTSWOOL_HEAD.get())
                ...
                .build());
        register(context, ARTIFICIAL_MANA_FONTS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.ARTIFICIAL_FONT_EARTH.get())
                ...
                .build());
        register(context, FORBIDDEN_MANA_FONTS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.FORBIDDEN_FONT_EARTH.get())
                ...
                .build());
        register(context, HEAVENLY_MANA_FONTS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.HEAVENLY_FONT_EARTH.get())
                ...
                .build());
        register(context, MANA_ARROWS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.MANA_ARROW_EARTH.get()).parent(BASIC_MANAWEAVING)
                ...
                .build());
        register(context, ESSENCE_CASK_ENCHANTED, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.ESSENCE_CASK_ENCHANTED.get())
                ...
                .build());
        register(context, ESSENCE_CASK_FORBIDDEN, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.ESSENCE_CASK_FORBIDDEN.get())
                ...
                .build());
        register(context, ESSENCE_CASK_HEAVENLY, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.ESSENCE_CASK_HEAVENLY.get())
                ...
                .build());
        register(context, WAND_GLAMOUR_TABLE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.WAND_GLAMOUR_TABLE.get())
                .parent(EXPERT_MANAWEAVING).parent(WAND_CORE_HEARTWOOD)
                .stage().requiredTheories(1).end()
                .stage().attunement(Sources.MOON, 2).recipe(ItemsPM.WAND_GLAMOUR_TABLE.get()).end()
                .build());
        register(context, ATTUNEMENT_SHACKLES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.ATTUNEMENT_SHACKLES_EARTH.get())
    ...
    private static void bootstrapAlchemyEntries(BootstrapContext<ResearchEntry> context) {
        ...
        register(context, STONEMELDING, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(Items.STONE).parent(BASIC_ALCHEMY)
                ...
                .build());
        register(context, SKYGLASS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.SKYGLASS.get()).parent(STONEMELDING)
                ...
                .stage().attunement(Sources.SKY, 1)
                        ...
                        .end()
                .build());
        register(context, SHARD_SYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.ESSENCE_SHARD_EARTH.get()).parent(EXPERT_ALCHEMY)
                .stage().requiredTheories(1).end()
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                ...
                .build());
        register(context, SHARD_DESYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.ESSENCE_SHARD_EARTH.get()).parent(SHARD_SYNTHESIS)
                .stage().requiredObservations(1).end()
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                ...
                .build());
        register(context, PRIMALITE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMALITE_INGOT.get()).parent(EXPERT_ALCHEMY)
                .stage().requiredItem(ItemsPM.ESSENCE_DUST_EARTH.get()).requiredItem(ItemsPM.ESSENCE_DUST_SEA.get()).requiredItem(ItemsPM.ESSENCE_DUST_SKY.get())
                ...
                .build());
        register(context, CRYSTAL_SYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.ESSENCE_CRYSTAL_EARTH.get())
                ...
                .build());
        register(context, CRYSTAL_DESYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.ESSENCE_CRYSTAL_EARTH.get()).parent(CRYSTAL_SYNTHESIS)
                .stage().requiredObservations(1).end()
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                ...
                .build());
        register(context, HEXIUM, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.HEXIUM_INGOT.get())
                ...
                .build());
        register(context, CLUSTER_SYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.ESSENCE_CLUSTER_EARTH.get())
                ...
                .build());
        register(context, CLUSTER_DESYNTHESIS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.ESSENCE_CLUSTER_EARTH.get()).parent(CLUSTER_SYNTHESIS)
                .stage().requiredObservations(1).end()
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                ...
                .build());
        register(context, HALLOWSTEEL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.HALLOWSTEEL_INGOT.get())
                ...
                .build());
        register(context, CALCINATOR_BASIC, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.CALCINATOR_BASIC.get()).parent(BASIC_ALCHEMY)
                ...
                .build());
        register(context, CALCINATOR_ENCHANTED, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.CALCINATOR_ENCHANTED.get())
                ...
                .build());
        register(context, CALCINATOR_FORBIDDEN, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.CALCINATOR_FORBIDDEN.get())
                ...
                .build());
        register(context, CALCINATOR_HEAVENLY, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.CALCINATOR_HEAVENLY.get())
        ...
        register(context, CRYOTREATMENT, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(Items.ICE).parent(STONEMELDING)
                ...
                .build());
        register(context, SANGUINE_CRUCIBLE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SANGUINE_CRUCIBLE.get())
        ...
        register(context, SANGUINE_CORE_SAPIENTS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SANGUINE_CORE_BLANK.get()).parent(SANGUINE_CRUCIBLE)
                ...
                .build());
        register(context, SANGUINE_CORE_DEMONS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SANGUINE_CORE_BLANK.get()).parent(SANGUINE_CRUCIBLE)
                .stage().requiredTheories(1).end()
                ...
                .build());
        register(context, SANGUINE_CORE_ALIENS, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SANGUINE_CORE_BLANK.get()).parent(SANGUINE_CRUCIBLE)
                .stage().requiredTheories(1).end()
                ...
                .build());
        register(context, IGNYX, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.IGNYX.get())
    ...
    private static void bootstrapRitualEntries(BootstrapContext<ResearchEntry> context) {
        ...
        register(context, COMPLETE_RITUAL, key -> ResearchEntry.builder(key).discipline(discipline).flags(ResearchEntry.Flags.builder().hidden()).icon(ICON_RITUAL).finale(discipline)
                ...
                .stage().attunement(Sources.EARTH, 1).attunement(Sources.SEA, 1).attunement(Sources.SKY, 1).attunement(Sources.SUN, 1).attunement(Sources.MOON, 1)
                        .attunement(Sources.BLOOD, 1).attunement(Sources.INFERNAL, 1).attunement(Sources.VOID, 1).attunement(Sources.HALLOWED, 1).end()
                .build());
        register(context, MANAFRUIT, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.MANAFRUIT.get())
                .parent(BASIC_RITUAL).parent(MANA_SALTS).parent(RITUAL_CANDLES)
                .stage().requiredTheories(1).end()
                .stage().recipe(ItemsPM.MANAFRUIT.get()).end()
                .build());
        register(context, RITUAL_CANDLES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.RITUAL_CANDLE_WHITE.get()).parent(BASIC_RITUAL)
                .stage().requiredObservations(1).end()
                ...
                .build());
        register(context, INCENSE_BRAZIER, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.BASIC).icon(ItemsPM.INCENSE_BRAZIER.get()).parent(BASIC_RITUAL)
                .stage().requiredObservations(1).end()
                .stage().attunement(Sources.SKY, 1).recipe(ItemsPM.INCENSE_BRAZIER.get()).recipe(ItemsPM.INCENSE_STICK.get()).end()
                .build());
        register(context, RITUAL_LECTERN, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.RITUAL_LECTERN.get()).parent(EXPERT_RITUAL)
                .stage().requiredTheories(1).end()
                .stage().attunement(Sources.MOON, 1).recipe(ItemsPM.RITUAL_LECTERN.get()).end()
                .build());
        register(context, RITUAL_BELL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.RITUAL_BELL.get()).parent(EXPERT_RITUAL)
                .stage().requiredTheories(1).end()
                .stage().attunement(Sources.SEA, 1).recipe(ItemsPM.RITUAL_BELL.get()).end()
                .build());
        register(context, BLOODLETTER, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.BLOODLETTER.get()).parent(MASTER_RITUAL).parent(DISCOVER_BLOOD)
                .stage().requiredTheories(2).end()
                .stage().attunement(Sources.BLOOD, 1).recipe(ItemsPM.BLOODLETTER.get()).end()
                .build());
        register(context, SOUL_ANVIL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SOUL_ANVIL.get())
                ...
                .build());
        register(context, CELESTIAL_HARP, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.CELESTIAL_HARP.get())
                ...
                .build());
        register(context, WAND_CORE_PRIMAL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, WAND_CORE_DARK_PRIMAL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.DARK_PRIMAL_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, WAND_CORE_PURE_PRIMAL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.PURE_PRIMAL_WAND_CORE_ITEM.get())
                ...
                .build());
        register(context, PIXIES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.BASIC_EARTH_PIXIE.get())
                ...
                .build());
        register(context, GRAND_PIXIES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.GRAND_EARTH_PIXIE.get())
                ...
                .build());
        register(context, MAJESTIC_PIXIES, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.MAJESTIC_EARTH_PIXIE.get())
                ...
                .build());
        register(context, AMBROSIA, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.BASIC_EARTH_AMBROSIA.get())
                ...
                .build());
        register(context, GREATER_AMBROSIA, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.GREATER_EARTH_AMBROSIA.get())
                ...
                .build());
        register(context, SUPREME_AMBROSIA, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.SUPREME_EARTH_AMBROSIA.get())
        ...
        register(context, FLYING_CARPET, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.FLYING_CARPET.get())
                ...
                .build());
        register(context, CLEANSING_RITE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.SANGUINE_CORE_BLANK.get())
                ...
                .build());
        register(context, PRIMAL_SHOVEL, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_SHOVEL.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_PROJECT).requiredResearch(RUNE_AREA).requiredResearch(RUNE_EARTH)
                        .siblingEnchantment(EnchantmentsPM.REVERBERATION.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, PRIMAL_FISHING_ROD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_FISHING_ROD.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_SUMMON).requiredResearch(RUNE_AREA).requiredResearch(RUNE_SEA)
                        .siblingEnchantment(EnchantmentsPM.BOUNTY.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, PRIMAL_AXE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_AXE.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_PROJECT).requiredResearch(RUNE_AREA).requiredResearch(RUNE_SKY)
                        .siblingEnchantment(EnchantmentsPM.DISINTEGRATION.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, PRIMAL_HOE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_HOE.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_SUMMON).requiredResearch(RUNE_CREATURE).requiredResearch(RUNE_SUN)
                        .siblingEnchantment(EnchantmentsPM.VERDANT.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, PRIMAL_PICKAXE, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.PRIMAL_PICKAXE.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_SUMMON).requiredResearch(RUNE_ITEM).requiredResearch(RUNE_MOON)
                        .siblingEnchantment(EnchantmentsPM.LUCKY_STRIKE.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, FORBIDDEN_TRIDENT, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.FORBIDDEN_TRIDENT.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_PROJECT).requiredResearch(RUNE_CREATURE).requiredResearch(RUNE_BLOOD)
                        .siblingEnchantment(EnchantmentsPM.RENDING.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, FORBIDDEN_BOW, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.FORBIDDEN_BOW.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_ABSORB).requiredResearch(RUNE_CREATURE).requiredResearch(RUNE_INFERNAL)
                        .siblingEnchantment(EnchantmentsPM.SOULPIERCING.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, FORBIDDEN_SWORD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.MASTER).icon(ItemsPM.FORBIDDEN_SWORD.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_SUMMON).requiredResearch(RUNE_ITEM).requiredResearch(RUNE_VOID)
                        .siblingEnchantment(EnchantmentsPM.ESSENCE_THIEF.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, SACRED_SHIELD, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.SUPREME).icon(ItemsPM.SACRED_SHIELD.get())
                ...
                .addendum().requiredResearch(MASTER_RUNEWORKING).requiredResearch(RUNE_PROTECT).requiredResearch(RUNE_SELF).requiredResearch(RUNE_HALLOWED)
                        .siblingEnchantment(EnchantmentsPM.BULWARK.get()).siblingResearch(UNLOCK_RUNE_ENCHANTMENTS).end()
                .build());
        register(context, DREAM_VISION_TALISMAN, key -> ResearchEntry.builder(key).discipline(discipline).tier(ResearchTier.EXPERT).icon(ItemsPM.DREAM_VISION_TALISMAN.get())
