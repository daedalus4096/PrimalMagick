 ...
 * @author Daedalus4096
 */
public abstract class AbstractMoonPixieEntity extends AbstractPixieEntity implements RangedAttackMob {
    public AbstractMoonPixieEntity(EntityType<? extends AbstractPixieEntity> type, Level worldIn) {
        super(type, worldIn);
    }
