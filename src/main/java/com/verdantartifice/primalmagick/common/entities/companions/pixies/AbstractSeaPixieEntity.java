 ...
 * @author Daedalus4096
 */
public abstract class AbstractSeaPixieEntity extends AbstractPixieEntity implements RangedAttackMob {
    public AbstractSeaPixieEntity(EntityType<? extends AbstractPixieEntity> type, Level worldIn) {
        super(type, worldIn);
    }
