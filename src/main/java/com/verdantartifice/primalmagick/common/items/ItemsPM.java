...
public class ItemsPM {
    ...
    public static final RegistryObject<Item> DRAINED_BASIC_INFERNAL_PIXIE = ITEMS.register("drained_pixie_basic_infernal", () -> new Item(new Item.Properties().tab(PrimalMagick.ITEM_GROUP).stacksTo(16).rarity(Rarity.COMMON)));
    public static final RegistryObject<Item> DRAINED_GRAND_INFERNAL_PIXIE = ITEMS.register("drained_pixie_grand_infernal", () -> new Item(new Item.Properties().tab(PrimalMagick.ITEM_GROUP).stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<Item> DRAINED_MAJESTIC_INFERNAL_PIXIE = ITEMS.register("drained_pixie_majestic_infernal", () -> new Item(new Item.Properties().tab(PrimalMagick.ITEM_GROUP).stacksTo(16).rarity(Rarity.RARE)));
