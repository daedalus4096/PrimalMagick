...
public class ItemsPM {
    ...
    // TODO Convert these to use the attributes method of Item.Properties instead of passing values in the constructor
    ...
    public static final RegistryObject<RobeArmorItem> IMBUED_WOOL_HEAD = registerSupplier("imbued_wool_head", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.HELMET, 1, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.HELMET.getDurability(8))));
    public static final RegistryObject<RobeArmorItem> IMBUED_WOOL_CHEST = registerSupplier("imbued_wool_chest", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.CHESTPLATE, 2, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(8))));
    public static final RegistryObject<RobeArmorItem> IMBUED_WOOL_LEGS = registerSupplier("imbued_wool_legs", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.LEGGINGS, 1, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.LEGGINGS.getDurability(8))));
    public static final RegistryObject<RobeArmorItem> IMBUED_WOOL_FEET = registerSupplier("imbued_wool_feet", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.BOOTS, 1, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.BOOTS.getDurability(8))));
    public static final RegistryObject<RobeArmorItem> SPELLCLOTH_HEAD = registerSupplier("spellcloth_head", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.HELMET, 2, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.HELMET.getDurability(20))));
    public static final RegistryObject<RobeArmorItem> SPELLCLOTH_CHEST = registerSupplier("spellcloth_chest", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.CHESTPLATE, 3, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(20))));
    public static final RegistryObject<RobeArmorItem> SPELLCLOTH_LEGS = registerSupplier("spellcloth_legs", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.LEGGINGS, 3, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.LEGGINGS.getDurability(20))));
    public static final RegistryObject<RobeArmorItem> SPELLCLOTH_FEET = registerSupplier("spellcloth_feet", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.BOOTS, 2, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.BOOTS.getDurability(20))));
    public static final RegistryObject<RobeArmorItem> HEXWEAVE_HEAD = registerSupplier("hexweave_head", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.HELMET, 3, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.HELMET.getDurability(35))));
    public static final RegistryObject<RobeArmorItem> HEXWEAVE_CHEST = registerSupplier("hexweave_chest", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.CHESTPLATE, 5, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.CHESTPLATE.getDurability(35))));
    public static final RegistryObject<RobeArmorItem> HEXWEAVE_LEGS = registerSupplier("hexweave_legs", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.LEGGINGS, 4, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.LEGGINGS.getDurability(35))));
    public static final RegistryObject<RobeArmorItem> HEXWEAVE_FEET = registerSupplier("hexweave_feet", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.BOOTS, 3, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.BOOTS.getDurability(35))));
    public static final RegistryObject<RobeArmorItem> SAINTSWOOL_HEAD = registerSupplier("saintswool_head", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.HELMET, 4, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.HELMET.getDurability(50))));
    public static final RegistryObject<RobeArmorItem> SAINTSWOOL_CHEST = registerSupplier("saintswool_chest", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.CHESTPLATE, 6, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.CHESTPLATE.getDurability(50))));
    public static final RegistryObject<RobeArmorItem> SAINTSWOOL_LEGS = registerSupplier("saintswool_legs", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.LEGGINGS, 6, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.LEGGINGS.getDurability(50))));
    public static final RegistryObject<RobeArmorItem> SAINTSWOOL_FEET = registerSupplier("saintswool_feet", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.BOOTS, 4, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.BOOTS.getDurability(50))));
