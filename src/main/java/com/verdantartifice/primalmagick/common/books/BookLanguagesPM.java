...
public class BookLanguagesPM {
    ...
    public static final RegistryObject<BookLanguage> ILLAGER = register("illager", () -> new BookLanguage(PrimalMagick.resource("illager"), Style.EMPTY.withFont(new ResourceLocation("illageralt")), -1, BookDefinitionTagsPM.ILLAGER_BOOKS));
    public static final RegistryObject<BookLanguage> EARTH = register("earth", () -> new BookLanguage(PrimalMagick.resource("earth"), Style.EMPTY.withFont(PrimalMagick.resource("earth")), 60, BookDefinitionTagsPM.EARTH_BOOKS));
    public static final RegistryObject<BookLanguage> SEA = register("sea", () -> new BookLanguage(PrimalMagick.resource("sea"), Style.EMPTY.withFont(PrimalMagick.resource("sea")), 60, BookDefinitionTagsPM.SEA_BOOKS));
    public static final RegistryObject<BookLanguage> SKY = register("sky", () -> new BookLanguage(PrimalMagick.resource("sky"), Style.EMPTY.withFont(PrimalMagick.resource("sky")), 60, BookDefinitionTagsPM.SKY_BOOKS));
    ...
    public static final RegistryObject<BookLanguage> HALLOWED = register("hallowed", () -> new BookLanguage(PrimalMagick.resource("hallowed"), Style.EMPTY.withFont(PrimalMagick.resource("hallowed")), 60, BookDefinitionTagsPM.HALLOWED_BOOKS));
}
