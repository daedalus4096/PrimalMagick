...
public class EffectsPM {
    ...
    public static final RegistryObject<MobEffect> STOLEN_ESSENCE = EFFECTS.register("stolen_essence", () -> new EffectPM(MobEffectCategory.HARMFUL, Sources.VOID.getColor()));
}
