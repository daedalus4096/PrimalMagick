...
public class ClientUtils {
     ...
     */
    public static void openStaticBookScreen(ResourceKey<?> bookKey, ResourceLocation languageId, int translatedComprehension) {
        Minecraft mc = Minecraft.getInstance();
        mc.setScreen(new StaticBookViewScreen(bookKey, languageId, translatedComprehension));
    }
}
