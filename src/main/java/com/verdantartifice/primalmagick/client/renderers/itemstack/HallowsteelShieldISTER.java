...
public class HallowsteelShieldISTER extends AbstractTieredShieldISTER {
    public static final ResourceLocation TEXTURE_SHIELD_BASE = PrimalMagick.resource("entity/shield/hallowsteel_shield_base");
    public static final ResourceLocation TEXTURE_SHIELD_NO_PATTERN = PrimalMagick.resource("entity/shield/hallowsteel_shield_base_nopattern");
