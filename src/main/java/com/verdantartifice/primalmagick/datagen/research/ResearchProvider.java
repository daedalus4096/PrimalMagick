...
public class ResearchProvider implements DataProvider {
    ...
    protected void registerManaweavingEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("EARTHSHATTER_HAMMER", discipline).icon(ItemsPM.EARTHSHATTER_HAMMER.get()).parent("EXPERT_MANAWEAVING").parent("SHARD_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 2).recipe(ItemsPM.EARTHSHATTER_HAMMER.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "iron_grit_from_ore"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "gold_grit_from_raw_metal")).recipe(new ResourceLocation(PrimalMagick.MODID, "copper_grit_from_ore"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "copper_grit_from_raw_metal")).recipe(new ResourceLocation(PrimalMagick.MODID, "iron_ingot_from_grit_smelting"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "gold_ingot_from_grit_smelting")).recipe(new ResourceLocation(PrimalMagick.MODID, "copper_ingot_from_grit_smelting"))
    ...
    protected void registerAlchemyEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("PRIMALITE", discipline).icon(ItemsPM.PRIMALITE_INGOT.get()).parent("EXPERT_ALCHEMY")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 1).attunement(Source.SEA, 1).attunement(Source.SKY, 1)
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "primalite_ingot_from_nuggets")).recipe(ItemsPM.PRIMALITE_BLOCK.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "primalite_ingots_from_block")).recipe(ItemsPM.PRIMALITE_SWORD.get()).recipe(ItemsPM.PRIMALITE_TRIDENT.get())
        ...
        ResearchEntryBuilder.entry("HALLOWSTEEL", discipline).icon(ItemsPM.HALLOWSTEEL_INGOT.get()).parent("SUPREME_ALCHEMY").parent("HEXIUM").parent("CRYSTAL_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.HALLOWED, 3).recipe(ItemsPM.HALLOWSTEEL_INGOT.get()).recipe(ItemsPM.HALLOWSTEEL_NUGGET.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "hallowsteel_ingot_from_nuggets")).recipe(ItemsPM.HALLOWSTEEL_BLOCK.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "hallowsteel_ingots_from_block")).recipe(ItemsPM.HALLOWSTEEL_SWORD.get())
    ...
    protected void registerRitualEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("PIXIES", discipline).icon(ItemsPM.BASIC_EARTH_PIXIE.get()).parent("EXPERT_RITUAL").parent("MANA_SALTS").parent("SHARD_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 2).attunement(Source.SEA, 2).attunement(Source.SKY, 2).attunement(Source.SUN, 2).attunement(Source.MOON, 2)
                    .recipe(ItemsPM.BASIC_EARTH_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_earth_revive"))
                    .recipe(ItemsPM.BASIC_SEA_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_sea_revive"))
                    .recipe(ItemsPM.BASIC_SKY_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_sky_revive"))
                    .recipe(ItemsPM.BASIC_SUN_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_sun_revive"))
                    .recipe(ItemsPM.BASIC_MOON_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_moon_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.BLOOD.getDiscoverKey()).attunement(Source.BLOOD, 2).recipe(ItemsPM.BASIC_BLOOD_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_blood_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.INFERNAL.getDiscoverKey()).attunement(Source.INFERNAL, 2).recipe(ItemsPM.BASIC_INFERNAL_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_infernal_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.VOID.getDiscoverKey()).attunement(Source.VOID, 2).recipe(ItemsPM.BASIC_VOID_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_void_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.HALLOWED.getDiscoverKey()).attunement(Source.HALLOWED, 2).recipe(ItemsPM.BASIC_HALLOWED_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_basic_hallowed_revive")).build())
            .build(consumer);
        ResearchEntryBuilder.entry("GRAND_PIXIES", discipline).icon(ItemsPM.GRAND_EARTH_PIXIE.get()).parent("MASTER_RITUAL").parent("PIXIES").parent("CRYSTAL_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 3).attunement(Source.SEA, 3).attunement(Source.SKY, 3).attunement(Source.SUN, 3).attunement(Source.MOON, 3)
                    ...
                    .recipe(ItemsPM.GRAND_SKY_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_sky_revive"))
                    .recipe(ItemsPM.GRAND_SUN_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_sun_revive"))
                    .recipe(ItemsPM.GRAND_MOON_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_moon_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.BLOOD.getDiscoverKey()).attunement(Source.BLOOD, 3).recipe(ItemsPM.GRAND_BLOOD_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_blood_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.INFERNAL.getDiscoverKey()).attunement(Source.INFERNAL, 3).recipe(ItemsPM.GRAND_INFERNAL_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_infernal_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.VOID.getDiscoverKey()).attunement(Source.VOID, 3).recipe(ItemsPM.GRAND_VOID_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_void_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.HALLOWED.getDiscoverKey()).attunement(Source.HALLOWED, 3).recipe(ItemsPM.GRAND_HALLOWED_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_grand_hallowed_revive")).build())
            .build(consumer);
        ResearchEntryBuilder.entry("MAJESTIC_PIXIES", discipline).icon(ItemsPM.MAJESTIC_EARTH_PIXIE.get()).parent("SUPREME_RITUAL").parent("GRAND_PIXIES").parent("CLUSTER_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 4).attunement(Source.SEA, 4).attunement(Source.SKY, 4).attunement(Source.SUN, 4).attunement(Source.MOON, 4)
                    ...
                    .recipe(ItemsPM.MAJESTIC_SKY_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_sky_revive"))
                    .recipe(ItemsPM.MAJESTIC_SUN_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_sun_revive"))
                    .recipe(ItemsPM.MAJESTIC_MOON_PIXIE.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_moon_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.BLOOD.getDiscoverKey()).attunement(Source.BLOOD, 4).recipe(ItemsPM.MAJESTIC_BLOOD_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_blood_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.INFERNAL.getDiscoverKey()).attunement(Source.INFERNAL, 4).recipe(ItemsPM.MAJESTIC_INFERNAL_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_infernal_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.VOID.getDiscoverKey()).attunement(Source.VOID, 4).recipe(ItemsPM.MAJESTIC_VOID_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_void_revive")).build())
            .addendum(ResearchAddendumBuilder.addendum().requiredResearch(Source.HALLOWED.getDiscoverKey()).attunement(Source.HALLOWED, 4).recipe(ItemsPM.MAJESTIC_HALLOWED_PIXIE.get())
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "pixie_majestic_hallowed_revive")).build())
            .build(consumer);
    ...
    protected void registerMagitechEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("CONCOCTING_TINCTURES", discipline).icon(ItemsPM.CONCOCTER.get()).parent("EXPERT_MAGITECH").parent("SKYGLASS").parent(Source.INFERNAL.getDiscoverKey())
            ...
            .stage(ResearchStageBuilder.stage().recipe(ItemsPM.SKYGLASS_FLASK.get()).recipe(ItemsPM.CONCOCTER.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "night_vision_tincture"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "long_slow_falling_tincture")).recipe(new ResourceLocation(PrimalMagick.MODID, "luck_tincture")).build())
        ...
        ResearchEntryBuilder.entry("CONCOCTING_PHILTERS", discipline).icon(ItemsPM.CONCOCTER.get()).parent("MASTER_MAGITECH").parent("CONCOCTING_TINCTURES").parent("SHARD_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().recipe(new ResourceLocation(PrimalMagick.MODID, "night_vision_philter"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "long_slow_falling_philter")).recipe(new ResourceLocation(PrimalMagick.MODID, "luck_philter")).build())
        ...
        ResearchEntryBuilder.entry("CONCOCTING_ELIXIRS", discipline).icon(ItemsPM.CONCOCTER.get()).parent("SUPREME_MAGITECH").parent("CONCOCTING_PHILTERS").parent("CRYSTAL_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().recipe(new ResourceLocation(PrimalMagick.MODID, "night_vision_elixir"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "long_slow_falling_elixir")).recipe(new ResourceLocation(PrimalMagick.MODID, "luck_elixir")).build())
        ...
        ResearchEntryBuilder.entry("CONCOCTING_BOMBS", discipline).icon(ItemsPM.CONCOCTER.get()).parent("MASTER_MAGITECH").parent("CONCOCTING_TINCTURES").parent("SHARD_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().recipe(ItemsPM.BOMB_CASING.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "night_vision_bomb"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "long_slow_falling_bomb")).recipe(new ResourceLocation(PrimalMagick.MODID, "luck_bomb")).build())
        ...
        ResearchEntryBuilder.entry("DISSOLUTION_CHAMBER", discipline).icon(ItemsPM.DISSOLUTION_CHAMBER.get()).parent("MASTER_MAGITECH").parent("MASTER_MANAWEAVING")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 3).recipe(ItemsPM.DISSOLUTION_CHAMBER.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "iron_grit_from_dissolving_ore"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "iron_grit_from_dissolving_raw_metal")).recipe(new ResourceLocation(PrimalMagick.MODID, "gold_grit_from_dissolving_ore"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "gold_grit_from_dissolving_raw_metal")).recipe(new ResourceLocation(PrimalMagick.MODID, "copper_grit_from_dissolving_ore"))
                    ...
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "string_from_dissolving_wool")).recipe(new ResourceLocation(PrimalMagick.MODID, "quartz_from_dissolving_quartz_block"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "glowstone_dust_from_dissolving_glowstone_block")).build())
            .build(consumer);
    ...
    protected void registerScanEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("ROCK_SALT", discipline).hidden().icon(ItemsPM.REFINED_SALT.get()).parent("UNLOCK_SCANS")
            .stage(ResearchStageBuilder.stage().recipe(ItemsPM.REFINED_SALT.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "rock_salt_from_smelting"))
                    .recipe(ItemsPM.SALT_BLOCK.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "refined_salt_from_salt_block"))
        ...
        ResearchEntryBuilder.entry("QUARTZ", discipline).hidden().icon(Items.QUARTZ).parent("UNLOCK_SCANS")
            .stage(ResearchStageBuilder.stage().recipe(ItemsPM.QUARTZ_NUGGET.get()).recipe(new ResourceLocation(PrimalMagick.MODID, "quartz_from_nuggets"))
                    .recipe(new ResourceLocation(PrimalMagick.MODID, "quartz_from_smelting")).build())
            .build(consumer);
