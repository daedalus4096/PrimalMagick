    ...
    protected void registerManaweavingEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("EARTHSHATTER_HAMMER", discipline).icon(ItemsPM.EARTHSHATTER_HAMMER.get()).parent("EXPERT_MANAWEAVING").parent("SHARD_SYNTHESIS")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 2).recipe(ItemsPM.EARTHSHATTER_HAMMER.get()).recipe(PrimalMagick.resource("iron_grit_from_ore"))
                    ...
                    .recipe(PrimalMagick.resource("cobblestone_from_earthshatter_hammer")).recipe(PrimalMagick.resource("gravel_from_earthshatter_hammer"))
                    .recipe(PrimalMagick.resource("sand_from_earthshatter_hammer")).build())
            .build(consumer);
    ...
    protected void registerMagitechEntries(Consumer<IFinishedResearchEntry> consumer) {
        ...
        ResearchEntryBuilder.entry("DISSOLUTION_CHAMBER", discipline).icon(ItemsPM.DISSOLUTION_CHAMBER.get()).parent("MASTER_MAGITECH").parent("MASTER_MANAWEAVING")
            ...
            .stage(ResearchStageBuilder.stage().attunement(Source.EARTH, 3).recipe(ItemsPM.DISSOLUTION_CHAMBER.get()).recipe(PrimalMagick.resource("iron_grit_from_dissolving_ore"))
                    ...
                    .recipe(PrimalMagick.resource("copper_grit_from_dissolving_raw_metal")).recipe(PrimalMagick.resource("cobblestone_from_dissolving_stone"))
                    .recipe(PrimalMagick.resource("gravel_from_dissolving_cobblestone")).recipe(PrimalMagick.resource("sand_from_dissolving_gravel"))
                    .recipe(PrimalMagick.resource("bone_meal_from_dissolving_bone")).recipe(PrimalMagick.resource("blaze_powder_from_dissolving_blaze_rod"))
                    .recipe(PrimalMagick.resource("string_from_dissolving_wool")).recipe(PrimalMagick.resource("quartz_from_dissolving_quartz_block"))
                    .recipe(PrimalMagick.resource("glowstone_dust_from_dissolving_glowstone_block")).build())
            .build(consumer);
