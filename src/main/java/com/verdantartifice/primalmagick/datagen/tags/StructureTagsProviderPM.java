...
public class StructureTagsProviderPM extends TagsProvider<Structure> {
    ...
    protected void addTags(Provider pProvider) {
        ...
        this.tag(StructureTagsPM.LIBRARY).add(StructuresPM.EARTH_LIBRARY, StructuresPM.SEA_LIBRARY, StructuresPM.SKY_LIBRARY, StructuresPM.SUN_LIBRARY, StructuresPM.MOON_LIBRARY);
    }
}
