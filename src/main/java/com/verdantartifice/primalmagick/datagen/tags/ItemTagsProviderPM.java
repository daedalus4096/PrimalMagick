...
public class ItemTagsProviderPM extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        this.tag(Tags.Items.DUSTS).addTag(ItemTagsForgeExt.DUSTS_IRON).addTag(ItemTagsForgeExt.DUSTS_GOLD).addTag(ItemTagsForgeExt.DUSTS_COPPER).addOptionalTag(ItemTagsForgeExt.DUSTS_TIN);
        ...
        this.tag(Tags.Items.ORES).addTag(ItemTagsForgeExt.ORES_ROCK_SALT).addOptionalTag(ItemTagsForgeExt.ORES_TIN);
        ...
        this.tag(Tags.Items.RAW_MATERIALS).addOptionalTag(ItemTagsForgeExt.RAW_MATERIALS_TIN);
