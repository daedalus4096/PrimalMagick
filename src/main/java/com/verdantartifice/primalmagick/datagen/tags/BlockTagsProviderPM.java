...
public class BlockTagsProviderPM extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlocksPM.SUNWOOD_PILLAR.get(), BlocksPM.MOONWOOD_PILLAR.get(), BlocksPM.HALLOWOOD_PILLAR.get(), BlocksPM.ARCANE_WORKBENCH.get(), BlocksPM.WOOD_TABLE.get(), BlocksPM.ANALYSIS_TABLE.get(), BlocksPM.WAND_INSCRIPTION_TABLE.get(), BlocksPM.RESEARCH_TABLE.get(), BlocksPM.RITUAL_LECTERN.get(), BlocksPM.RUNECARVING_TABLE.get(), BlocksPM.CELESTIAL_HARP.get(), BlocksPM.HYDROMELON.get(), BlocksPM.ATTACHED_HYDROMELON_STEM.get(), BlocksPM.HYRDOMELON_STEM.get(), BlocksPM.SCRIBE_TABLE.get());
