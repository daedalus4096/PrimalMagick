...
public class BlockTagsProviderPM extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider lookupProvider) {
        ...
        this.tag(BlockTags.TALL_FLOWERS).add(BlocksPM.BLOOD_ROSE.get());
        ...
        this.tag(BlockTags.SWORD_EFFICIENT).add(BlocksPM.HYDROMELON.get(), BlocksPM.ATTACHED_HYDROMELON_STEM.get(), BlocksPM.BLOOD_ROSE.get());
