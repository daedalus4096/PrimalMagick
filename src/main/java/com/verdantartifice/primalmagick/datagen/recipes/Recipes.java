...
public class Recipes extends RecipeProvider {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.SPIRIT_LANTERN.get())
            ...
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("SUNLAMP"), SimpleResearchKey.find("HEXIUM")))
            ...
            for (EssenceType baseType : EssenceType.values()) {
                ...
                if (upgradeType != null) {
                    ...
                    if (!baseStack.isEmpty() && !upgradeStack.isEmpty() && quartzItem != null) {
                        ...
                        SimpleResearchKey baseResearch = SimpleResearchKey.find(upgradeType.getSerializedName().toUpperCase() + "_SYNTHESIS");
            ...
            for (EssenceType baseType : EssenceType.values()) {
                ...
                if (downgradeType != null) {
                    ...
                    if (!baseStack.isEmpty() && !downgradeStack.isEmpty()) {
                        CompoundResearchKey research;
                        SimpleResearchKey baseResearch = SimpleResearchKey.find(baseType.getSerializedName().toUpperCase() + "_DESYNTHESIS");
                        if (source.getDiscoverKey() == null) {
                            research = CompoundResearchKey.from(baseResearch);
                        } else {
                            research = CompoundResearchKey.from(true, baseResearch, source.getDiscoverKey());
    ...
    protected void registerWandComponentRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.HEARTWOOD_STAFF_CORE_ITEM.get())
            ...
            .patternLine("H  ")
            .key('H', ItemsPM.HEARTWOOD.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_HEARTWOOD")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.OBSIDIAN_STAFF_CORE_ITEM.get())
            ...
            .key('#', Tags.Items.OBSIDIAN)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_OBSIDIAN")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 15).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.CORAL_STAFF_CORE_ITEM.get())
            ...
            .key('#', ItemTagsPM.CORAL_BLOCKS)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_CORAL")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 15).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.BAMBOO_STAFF_CORE_ITEM.get())
            ...
            .key('#', Items.BAMBOO)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_BAMBOO")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 15).add(Source.SUN, 5).add(Source.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.SUNWOOD_STAFF_CORE_ITEM.get())
            ...
            .key('#', ItemsPM.SUNWOOD_LOG.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_SUNWOOD")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 15).add(Source.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.MOONWOOD_STAFF_CORE_ITEM.get())
            ...
            .key('#', ItemsPM.MOONWOOD_LOG.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_MOONWOOD")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 15))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.BONE_STAFF_CORE_ITEM.get())
            ...
            .key('#', Items.BONE)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_BONE")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5).add(Source.BLOOD, 15))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.BLAZE_ROD_STAFF_CORE_ITEM.get())
            ...
            .key('#', Tags.Items.RODS_BLAZE)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_BLAZE_ROD")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5).add(Source.INFERNAL, 15))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.PURPUR_STAFF_CORE_ITEM.get())
            ...
            .key('#', Items.PURPUR_BLOCK)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_PURPUR")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 5).add(Source.SEA, 5).add(Source.SKY, 5).add(Source.SUN, 5).add(Source.MOON, 5).add(Source.VOID, 15))
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.PRIMAL_STAFF_CORE_ITEM.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES)
            .instability(4)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_PRIMAL")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 15).add(Source.SEA, 15).add(Source.SKY, 15).add(Source.SUN, 15).add(Source.MOON, 15))
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.DARK_PRIMAL_STAFF_CORE_ITEM.get())
            ...
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .instability(6)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_DARK_PRIMAL")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 50).add(Source.SEA, 50).add(Source.SKY, 50).add(Source.SUN, 50).add(Source.MOON, 50).add(Source.BLOOD, 50).add(Source.INFERNAL, 50).add(Source.VOID, 50))
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.PURE_PRIMAL_STAFF_CORE_ITEM.get())
            ...
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .instability(8)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("STAVES"), SimpleResearchKey.find("WAND_CORE_PURE_PRIMAL")))
            .manaCost(SourceList.EMPTY.add(Source.EARTH, 100).add(Source.SEA, 100).add(Source.SKY, 100).add(Source.SUN, 100).add(Source.MOON, 100).add(Source.BLOOD, 100).add(Source.INFERNAL, 100).add(Source.VOID, 100).add(Source.HALLOWED, 100))
            .build(consumer);
    }
    ...
    protected void registerPixieRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_BLOOD_PIXIE.get())
            ...
            .addProp(BlocksPM.INCENSE_BRAZIER.get())
            .addProp(BlocksPM.RITUAL_BELL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("PIXIES"), Source.BLOOD.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_INFERNAL_PIXIE.get())
            ...
            .addProp(BlocksPM.INCENSE_BRAZIER.get())
            .addProp(BlocksPM.RITUAL_BELL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("PIXIES"), Source.INFERNAL.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_VOID_PIXIE.get())
            ...
            .addProp(BlocksPM.INCENSE_BRAZIER.get())
            .addProp(BlocksPM.RITUAL_BELL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("PIXIES"), Source.VOID.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.VOID, 40))
            .instability(3)
            .build(consumer);
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_HALLOWED_PIXIE.get())
            ...
            .addProp(BlocksPM.INCENSE_BRAZIER.get())
            .addProp(BlocksPM.RITUAL_BELL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("PIXIES"), Source.HALLOWED.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GRAND_BLOOD_PIXIE.get())
            ...
            .addProp(BlocksPM.RITUAL_BELL.get())
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GRAND_PIXIES"), Source.BLOOD.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GRAND_INFERNAL_PIXIE.get())
            ...
            .addProp(BlocksPM.RITUAL_BELL.get())
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GRAND_PIXIES"), Source.INFERNAL.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GRAND_VOID_PIXIE.get())
            ...
            .addProp(BlocksPM.RITUAL_BELL.get())
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GRAND_PIXIES"), Source.VOID.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GRAND_HALLOWED_PIXIE.get())
            ...
            .addProp(BlocksPM.RITUAL_BELL.get())
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GRAND_PIXIES"), Source.HALLOWED.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.HALLOWED, 100))
            .instability(5)
            .build(consumer);
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.MAJESTIC_BLOOD_PIXIE.get())
            ...
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("MAJESTIC_PIXIES"), Source.BLOOD.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.MAJESTIC_INFERNAL_PIXIE.get())
            ...
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("MAJESTIC_PIXIES"), Source.INFERNAL.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.MAJESTIC_VOID_PIXIE.get())
            ...
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("MAJESTIC_PIXIES"), Source.VOID.getDiscoverKey()))
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.MAJESTIC_HALLOWED_PIXIE.get())
            ...
            .addProp(BlocksPM.SOUL_ANVIL.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("MAJESTIC_PIXIES"), Source.HALLOWED.getDiscoverKey()))
    ...
    protected void registerAmbrosiaRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_BLOOD_AMBROSIA.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES, 2)
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("AMBROSIA"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.BLOOD, 40))
            .instability(4)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_INFERNAL_AMBROSIA.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES, 2)
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("AMBROSIA"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 40))
            .instability(4)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_VOID_AMBROSIA.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES, 2)
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("AMBROSIA"), Source.VOID.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.VOID, 40))
            .instability(4)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.BASIC_HALLOWED_AMBROSIA.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES, 2)
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("AMBROSIA"), Source.HALLOWED.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.HALLOWED, 40))
            .instability(4)
            .build(consumer);
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GREATER_BLOOD_AMBROSIA.get())
            ...
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .addProp(BlocksPM.BLOODLETTER.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GREATER_AMBROSIA"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.BLOOD, 100))
            .instability(6)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GREATER_INFERNAL_AMBROSIA.get())
            ...
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .addProp(BlocksPM.BLOODLETTER.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GREATER_AMBROSIA"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 100))
            .instability(6)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GREATER_VOID_AMBROSIA.get())
            ...
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .addProp(BlocksPM.BLOODLETTER.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GREATER_AMBROSIA"), Source.VOID.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.VOID, 100))
            .instability(6)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.GREATER_HALLOWED_AMBROSIA.get())
            ...
            .addProp(BlocksPM.RITUAL_LECTERN.get())
            .addProp(BlocksPM.BLOODLETTER.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("GREATER_AMBROSIA"), Source.HALLOWED.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.HALLOWED, 100))
            .instability(6)
            .build(consumer);
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.SUPREME_BLOOD_AMBROSIA.get())
            ...
            .addProp(BlocksPM.BLOODLETTER.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("SUPREME_AMBROSIA"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.BLOOD, 200))
            .instability(8)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.SUPREME_INFERNAL_AMBROSIA.get())
            ...
            .addProp(BlocksPM.BLOODLETTER.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("SUPREME_AMBROSIA"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 200))
            .instability(8)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.SUPREME_VOID_AMBROSIA.get())
            ...
            .addProp(BlocksPM.BLOODLETTER.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("SUPREME_AMBROSIA"), Source.VOID.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.VOID, 200))
            .instability(8)
            .build(consumer);
        RitualRecipeBuilder.ritualRecipe(ItemsPM.SUPREME_HALLOWED_AMBROSIA.get())
            ...
            .addProp(BlocksPM.BLOODLETTER.get())
            .addProp(BlocksPM.CELESTIAL_HARP.get())
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("SUPREME_AMBROSIA"), Source.HALLOWED.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.HALLOWED, 200))
            .instability(8)
            .build(consumer);
    }
    ...
    protected void registerTinctureRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.FIRE_RESISTANCE, ConcoctionType.TINCTURE))
            ...
            .addIngredient(Items.MAGMA_CREAM)
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_TINCTURES"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 1))
            .build(consumer);
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.HEALING, ConcoctionType.TINCTURE))
            ...
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_TINCTURES"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 1))
            .build(consumer);
    ...
    protected void registerPhilterRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.FIRE_RESISTANCE, ConcoctionType.PHILTER))
            ...
            .addIngredient(Items.MAGMA_CREAM)
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_PHILTERS"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 3))
            .build(consumer);
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.HEALING, ConcoctionType.PHILTER))
            ...
            .addIngredient(Items.GLISTERING_MELON_SLICE)
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_PHILTERS"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 3))
            .build(consumer);
    ...
    protected void registerElixirRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.FIRE_RESISTANCE, ConcoctionType.ELIXIR))
            ...
            .addIngredient(Items.MAGMA_CREAM)
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_ELIXIRS"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 9))
            .build(consumer);
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newConcoction(Potions.HEALING, ConcoctionType.ELIXIR))
            ...
            .addIngredient(Items.GLISTERING_MELON_SLICE)
            .useDefaultGroup()
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_ELIXIRS"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 9))
            .build(consumer);
    ...
    protected void registerAlchemicalBombRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newBomb(Potions.FIRE_RESISTANCE, FuseType.MEDIUM))
            ...
            .addIngredient(Tags.Items.CROPS_NETHER_WART)
            .addIngredient(Items.MAGMA_CREAM)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_BOMBS"), Source.INFERNAL.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 3))
            .build(consumer);
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newBomb(Potions.HEALING, FuseType.MEDIUM))
            ...
            .addIngredient(Tags.Items.CROPS_NETHER_WART)
            .addIngredient(Items.GLISTERING_MELON_SLICE)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_BOMBS"), Source.BLOOD.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 3))
            .build(consumer);
        ...
        ConcoctingRecipeBuilder.concoctingRecipe(ConcoctionUtils.newBomb(Potions.SLOWNESS, FuseType.MEDIUM))
            ...
            .addIngredient(Items.SUGAR)
            .addIngredient(Items.FERMENTED_SPIDER_EYE)
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("CONCOCTING_BOMBS"), Source.VOID.getDiscoverKey()))
            .manaCost(SourceList.EMPTY.add(Source.INFERNAL, 3))
            .build(consumer);
    ...
    protected void registerManaFontRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.ARTIFICIAL_FONT_BLOOD.get())
            ...
            .setGroup("artificial_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("ARTIFICIAL_MANA_FONTS"), Source.BLOOD.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.ARTIFICIAL_FONT_INFERNAL.get())
            ...
            .setGroup("artificial_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("ARTIFICIAL_MANA_FONTS"), Source.INFERNAL.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.ARTIFICIAL_FONT_VOID.get())
            ...
            .setGroup("artificial_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("ARTIFICIAL_MANA_FONTS"), Source.VOID.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.ARTIFICIAL_FONT_HALLOWED.get())
            ...
            .setGroup("artificial_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("ARTIFICIAL_MANA_FONTS"), Source.HALLOWED.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.FORBIDDEN_FONT_BLOOD.get())
            ...
            .setGroup("forbidden_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("FORBIDDEN_MANA_FONTS"), Source.BLOOD.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.FORBIDDEN_FONT_INFERNAL.get())
            ...
            .setGroup("forbidden_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("FORBIDDEN_MANA_FONTS"), Source.INFERNAL.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.FORBIDDEN_FONT_VOID.get())
            ...
            .setGroup("forbidden_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("FORBIDDEN_MANA_FONTS"), Source.VOID.getDiscoverKey()))
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.FORBIDDEN_FONT_HALLOWED.get())
            ...
            .setGroup("forbidden_mana_fonts")
            .research(CompoundResearchKey.from(true, SimpleResearchKey.find("FORBIDDEN_MANA_FONTS"), Source.HALLOWED.getDiscoverKey()))
