...
public class LanguageProviderEnUs extends AbstractLanguageProviderPM {
    ...
    protected void addLocalizations() {
        ...
        this.researchRequirement("t_mana_spent_earth_expert").name("Spend 100 Earth mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_sea_expert").name("Spend 100 Sea mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_sky_expert").name("Spend 100 Sky mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_sun_expert").name("Spend 100 Sun mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_moon_expert").name("Spend 100 Moon mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_blood_expert").name("Spend 100 Blood mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_infernal_expert").name("Spend 100 Infernal mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_void_expert").name("Spend 100 Void mana (before modifiers)").build();
        this.researchRequirement("t_mana_spent_hallowed_expert").name("Spend 100 Hallowed mana (before modifiers)").build();
        ...
        this.researchEntry("HUMMING_ARTIFACT").name("Humming Artifact")
            .stages()
                ...
                .end()
            .addenda()
                .add("The artifact also responsds to Blood essence.")
                .add("The artifact also responsds to Infernal essence.")
                .add("The artifact also responsds to Void essence.")
                .add("The artifact also responsds to Hallowed essence.")
                .end()
            .build();
