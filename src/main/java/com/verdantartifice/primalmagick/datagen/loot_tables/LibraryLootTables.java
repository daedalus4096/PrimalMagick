...
public class LibraryLootTables extends AbstractGameplayLootTableSubProvider {
    ...
    protected void addTables(BiConsumer<ResourceKey<LootTable>, Builder> writer) {
        ...
        LootPool.Builder commonPool = LootPool.lootPool()
                ...
                .add(book(this.registries, BooksPM.MAGICKAL_TOME_LIGHTNING_IN_MY_GRASP, Rarity.COMMON, 1))
                ...
                .add(book(this.registries, BooksPM.MAGICKAL_TOME_NEAR_DEATH_EXPERIENCE, Rarity.COMMON, 1))
                ...
                .add(book(this.registries, BooksPM.MAGICKAL_TOME_IN_DREAMS, Rarity.COMMON, 1))
                .add(book(this.registries, BooksPM.A_CURIOUS_EXCHANGE, Rarity.COMMON, 1))
