...
public class TheorycraftingRewardLootTables extends AbstractGameplayLootTableSubProvider {
    ...
    protected void addTables(BiConsumer<ResourceLocation, Builder> writer) {
        ...
        this.registerLootTable(writer, LootTablesPM.THEORYCRAFTING_PROSPEROUS_TRADE, LootTable.lootTable().withPool(LootPool.lootPool()
                ...
                .add(LootItem.lootTableItem(Items.MAP).setWeight(30000).apply(ExplorationMapFunction.makeExplorationMap().setDestination(StructureTags.ON_TREASURE_MAPS).setMapDecoration(MapDecoration.Type.RED_X).setZoom((byte)1).setSkipKnownStructures(true)).apply(SetNameFunction.setName(Component.translatable("filled_map.buried_treasure"))))
                .add(LootItem.lootTableItem(Items.MAP).setWeight(30000).apply(ExplorationMapFunction.makeExplorationMap().setDestination(StructureTags.ON_OCEAN_EXPLORER_MAPS).setMapDecoration(MapDecoration.Type.RED_X).setZoom((byte)1).setSkipKnownStructures(true)).apply(SetNameFunction.setName(Component.translatable("filled_map.monument"))))
                .add(LootItem.lootTableItem(Items.MAP).setWeight(30000).apply(ExplorationMapFunction.makeExplorationMap().setDestination(StructureTags.ON_WOODLAND_EXPLORER_MAPS).setMapDecoration(MapDecoration.Type.RED_X).setZoom((byte)1).setSkipKnownStructures(true)).apply(SetNameFunction.setName(Component.translatable("filled_map.mansion"))))
