...
public class ProjectProvider implements DataProvider {
    ...
    protected void registerProjects(Consumer<IFinishedProject> consumer) {
        ...
        ProjectBuilder.project("enchanting_studies").requiredResearch("BASIC_MANAWEAVING")
            ...
            .build(consumer);
        ProjectBuilder.project("end_expedition").requiredResearch(ResearchEntries.DISCOVER_VOID).rewardMultiplier(1.0D)
        ...
        ProjectBuilder.project("essence_analysis").requiredResearch("BASIC_ALCHEMY")
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_BLOOD.get(), true).requiredResearch(ResearchEntries.DISCOVER_BLOOD).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_INFERNAL.get(), true).requiredResearch(ResearchEntries.DISCOVER_INFERNAL).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_VOID.get(), true).requiredResearch(ResearchEntries.DISCOVER_VOID).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_HALLOWED.get(), true).requiredResearch(ResearchEntries.DISCOVER_HALLOWED).afterCrafting(5).weight(3).build())
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_BLOOD.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, ResearchEntries.DISCOVER_BLOOD)).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_INFERNAL.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, ResearchEntries.DISCOVER_INFERNAL)).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_VOID.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, ResearchEntries.DISCOVER_VOID)).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_HALLOWED.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, ResearchEntries.DISCOVER_HALLOWED)).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .build(consumer);
        ...
        ProjectBuilder.project("master_essence_analysis").requiredResearch("CLUSTER_SYNTHESIS").rewardMultiplier(1.0D)
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_BLOOD.get(), true).requiredResearch(ResearchEntries.DISCOVER_BLOOD).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_INFERNAL.get(), true).requiredResearch(ResearchEntries.DISCOVER_INFERNAL).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_VOID.get(), true).requiredResearch(ResearchEntries.DISCOVER_VOID).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_HALLOWED.get(), true).requiredResearch(ResearchEntries.DISCOVER_HALLOWED).afterCrafting(5).weight(3).build())
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_BLOOD.get(), true).requiredResearch(ResearchEntries.DISCOVER_BLOOD).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_INFERNAL.get(), true).requiredResearch(ResearchEntries.DISCOVER_INFERNAL).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_VOID.get(), true).requiredResearch(ResearchEntries.DISCOVER_VOID).afterCrafting(5).weight(1).bonusReward(0.5D).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_HALLOWED.get(), true).requiredResearch(ResearchEntries.DISCOVER_HALLOWED).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .build(consumer);
        ...
        ProjectBuilder.project("master_spellwork").rewardMultiplier(1D).requiredResearch(CompoundResearchKey.from(true, "MASTER_SORCERY", "CRYSTAL_SYNTHESIS"))
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_BLOOD.get(), true).requiredResearch(ResearchEntries.DISCOVER_BLOOD).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_INFERNAL.get(), true).requiredResearch(ResearchEntries.DISCOVER_INFERNAL).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_VOID.get(), true).requiredResearch(ResearchEntries.DISCOVER_VOID).weight(1).build())
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
