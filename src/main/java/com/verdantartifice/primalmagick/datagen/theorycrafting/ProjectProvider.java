...
public class ProjectProvider implements DataProvider {
    ...
    protected void registerProjects(Consumer<IFinishedProject> consumer) {
        ...
        ProjectBuilder.project("advanced_essence_analysis").requiredResearch("CRYSTAL_SYNTHESIS").rewardMultiplier(0.5D)
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_HALLOWED.get(), true).requiredResearch(Sources.HALLOWED.getDiscoverKey()).afterCrafting(5).weight(3).build())
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).afterCrafting(5).bonusReward(0.25D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).afterCrafting(5).bonusReward(0.25D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).afterCrafting(5).bonusReward(0.25D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_HALLOWED.get(), true).requiredResearch(Sources.HALLOWED.getDiscoverKey()).afterCrafting(5).bonusReward(0.25D).weight(1).build())
            .build(consumer);
        ...
        ProjectBuilder.project("advanced_spellwork").rewardMultiplier(0.5D).requiredResearch(CompoundResearchKey.from(true, "EXPERT_SORCERY", "SHARD_SYNTHESIS"))
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).weight(1).build())
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
        ProjectBuilder.project("advanced_wand_tinkering").rewardMultiplier(0.5D).requiredResearch("MASTER_MANAWEAVING")
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).weight(1).build())
            .build(consumer);
        ...
        ProjectBuilder.project("beacon_emanations").aid(Blocks.BEACON).materialCountOverride(1).baseSuccessChanceOverride(0.5D).rewardMultiplier(0.5D)
            ...
            .build(consumer);
        ProjectBuilder.project("brewing_experiments").rewardMultiplier(0.5D).requiredResearch(Sources.INFERNAL.getDiscoverKey())
            .weightFunction(ConstantWeightFunctionBuilder.weight(5).build())
        ...
        ProjectBuilder.project("enchanting_studies").requiredResearch("BASIC_MANAWEAVING")
            ...
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
        ProjectBuilder.project("end_expedition").requiredResearch(Sources.VOID.getDiscoverKey()).rewardMultiplier(1.0D)
            .weightFunction(ConstantWeightFunctionBuilder.weight(5).build())
        ...
        ProjectBuilder.project("essence_analysis").requiredResearch("BASIC_ALCHEMY")
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_DUST_HALLOWED.get(), true).requiredResearch(Sources.HALLOWED.getDiscoverKey()).afterCrafting(5).weight(3).build())
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_BLOOD.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, Sources.BLOOD.getDiscoverKey())).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_INFERNAL.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, Sources.INFERNAL.getDiscoverKey())).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_VOID.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, Sources.VOID.getDiscoverKey())).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_SHARD_HALLOWED.get(), true).requiredResearch(CompoundResearchKey.from(true, shardSynthesis, Sources.HALLOWED.getDiscoverKey())).afterCrafting(5).bonusReward(0.125D).weight(1).build())
            .build(consumer);
        ProjectBuilder.project("expedition")
            .weightFunction(ProgressiveWeightFunctionBuilder.start(5).modifier(Sources.INFERNAL.getDiscoverKey(), -2).modifier(Sources.VOID.getDiscoverKey(), -2).build())
        ...
        ProjectBuilder.project("master_essence_analysis").requiredResearch("CLUSTER_SYNTHESIS").rewardMultiplier(1.0D)
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).afterCrafting(5).weight(3).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_HALLOWED.get(), true).requiredResearch(Sources.HALLOWED.getDiscoverKey()).afterCrafting(5).weight(3).build())
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).afterCrafting(5).weight(1).bonusReward(0.5D).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CLUSTER_HALLOWED.get(), true).requiredResearch(Sources.HALLOWED.getDiscoverKey()).afterCrafting(5).bonusReward(0.5D).weight(1).build())
            .build(consumer);
        ...
        ProjectBuilder.project("master_spellwork").rewardMultiplier(1D).requiredResearch(CompoundResearchKey.from(true, "MASTER_SORCERY", "CRYSTAL_SYNTHESIS"))
            ...
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_BLOOD.get(), true).requiredResearch(Sources.BLOOD.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_INFERNAL.get(), true).requiredResearch(Sources.INFERNAL.getDiscoverKey()).weight(1).build())
            .material(ItemMaterialBuilder.item(ItemsPM.ESSENCE_CRYSTAL_VOID.get(), true).requiredResearch(Sources.VOID.getDiscoverKey()).weight(1).build())
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
        ProjectBuilder.project("mundane_tinkering")
            ...
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
        ProjectBuilder.project("nether_expedition").requiredResearch(Sources.INFERNAL.getDiscoverKey()).rewardMultiplier(0.5D)
            .weightFunction(ProgressiveWeightFunctionBuilder.start(5).modifier(Sources.VOID.getDiscoverKey(), -2).build())
            .material(ItemMaterialBuilder.item(Items.DIAMOND_SWORD, false).weight(1).build())
            .material(ItemMaterialBuilder.item(Items.CROSSBOW, false).weight(1).build())
        ...
        ProjectBuilder.project("observation_analysis").aid(BlocksPM.ANALYSIS_TABLE.get()).materialCountOverride(1).baseSuccessChanceOverride(0.5D).rewardMultiplier(0.5D)
            ...
            .build(consumer);
        ProjectBuilder.project("piglin_barter").requiredResearch(Sources.INFERNAL.getDiscoverKey()).rewardMultiplier(1D)
            .weightFunction(ConstantWeightFunctionBuilder.weight(5).build())
        ...
        ProjectBuilder.project("portal_detritus").aid(Blocks.NETHER_PORTAL).materialCountOverride(1).baseSuccessChanceOverride(0.5D).rewardMultiplier(0.5D)
            ...
            .build(consumer);
        ProjectBuilder.project("prosperous_trade").rewardMultiplier(0.5D).requiredResearch(Sources.INFERNAL.getDiscoverKey())
            .weightFunction(ProgressiveWeightFunctionBuilder.start(5).modifier(Sources.VOID.getDiscoverKey(), -2).build())
        ...
        ProjectBuilder.project("redstone_tinkering").requiredResearch("BASIC_MAGITECH")
            ...
            .material(ObservationMaterialBuilder.observation(1, true).weight(5).build())
            .build(consumer);
        ProjectBuilder.project("rich_trade").rewardMultiplier(1D).requiredResearch(Sources.VOID.getDiscoverKey())
            .weightFunction(ConstantWeightFunctionBuilder.weight(5).build())
