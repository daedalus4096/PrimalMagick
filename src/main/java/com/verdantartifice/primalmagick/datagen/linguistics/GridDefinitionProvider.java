...
public class GridDefinitionProvider implements DataProvider {
    ...
    protected void registerGrids(Consumer<IFinishedGrid> consumer) {
        ...
        GridDefinitionBuilder.grid("trade").language(BookLanguagesPM.TRADE.get()).startPos(0, 0)
                ...
                .node(GridNodeDefinitionBuilder.node(4, 0).cost(1).reward(EmptyRewardBuilder.reward().build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(6, 0).cost(1).reward(EmptyRewardBuilder.reward().build()).build())
