...
public class GridDefinitionProvider implements DataProvider {
    ...
    protected void registerGrids(Consumer<IFinishedGrid> consumer) {
        ...
        GridDefinitionBuilder.grid("trade").language(BookLanguagesPM.TRADE.get()).startPos(4, 3)
                ...
                .build(consumer);
        GridDefinitionBuilder.grid("forbidden").language(BookLanguagesPM.FORBIDDEN.get()).startPos(1, 0)
                .node(GridNodeDefinitionBuilder.node(1, 0).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(1).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(5, 0).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 0).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(5).build()).build())
                .node(GridNodeDefinitionBuilder.node(0, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(1, 1).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.OBSERVATION).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(2, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(0, 2).cost(1).reward(AttunementRewardBuilder.reward(Source.BLOOD).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(1, 2).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 2).cost(1).reward(AttunementRewardBuilder.reward(Source.INFERNAL).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 2).cost(1).reward(AttunementRewardBuilder.reward(Source.INFERNAL).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 2).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 2).cost(1).reward(AttunementRewardBuilder.reward(Source.BLOOD).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(1, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(2, 3).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(5).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 3).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 4).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 4).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 5).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 5).cost(1).reward(AttunementRewardBuilder.reward(Source.VOID).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 5).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(5).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 6).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 6).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 7).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 7).cost(1).reward(AttunementRewardBuilder.reward(Source.VOID).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 7).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.FORBIDDEN.get()).points(5).build()).build())
                .build(consumer);
    }
