...
public class GridDefinitionProvider implements DataProvider {
    ...
    protected void registerGrids(Consumer<IFinishedGrid> consumer) {
        ...
        GridDefinitionBuilder.grid("forbidden").language(BookLanguagesPM.FORBIDDEN.get()).startPos(1, 0)
                ...
                .build(consumer);
        GridDefinitionBuilder.grid("hallowed").language(BookLanguagesPM.HALLOWED.get()).startPos(3, 1)
                .node(GridNodeDefinitionBuilder.node(0, 0).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(5).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 0).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(5).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(3, 1).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(1).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(1, 2).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(2, 2).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 2).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 2).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(2).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(0, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(1, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 3).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 3).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(0, 4).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(1, 4).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 4).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(2).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 4).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(4).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(1, 5).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(2, 5).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(5, 5).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(3).build()).build())
                .node(GridNodeDefinitionBuilder.node(6, 5).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(0, 6).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(2, 6).cost(1).reward(KnowledgeRewardBuilder.reward(KnowledgeType.THEORY).levels(1).build()).build())
                .node(GridNodeDefinitionBuilder.node(3, 6).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(4).build()).build())
                .node(GridNodeDefinitionBuilder.node(4, 6).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(4).build()).build())
                ...
                .node(GridNodeDefinitionBuilder.node(0, 7).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(5).build()).build())
                .node(GridNodeDefinitionBuilder.node(7, 7).cost(1).reward(ComprehensionRewardBuilder.reward(BookLanguagesPM.HALLOWED.get()).points(5).build()).build())
                .build(consumer);
    }
