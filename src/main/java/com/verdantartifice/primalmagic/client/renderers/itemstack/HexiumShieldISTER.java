...
public class HexiumShieldISTER extends AbstractTieredShieldISTER {
    public static final ResourceLocation TEXTURE_SHIELD_BASE = new ResourceLocation("primalmagic:entity/shield/hexium_shield_base");
    public static final ResourceLocation TEXTURE_SHIELD_NO_PATTERN = new ResourceLocation("primalmagic:entity/shield/hexium_shield_base_nopattern");
