...
public class BlockTagsProvider extends TagsProvider<Block> {
    ...
    public BlockTagsProvider(DataGenerator generator, ExistingFileHelper helper) {
        super(generator, Registry.BLOCK, PrimalMagic.MODID, helper);
    }
    ...
    protected void addTags() {
        ...
        this.tag(BlockTags.LOGS).addTag(BlockTagsPM.MOONWOOD_LOGS).addTag(BlockTagsPM.SUNWOOD_LOGS).addTag(BlockTagsPM.HALLOWOOD_LOGS);
        ...
        this.tag(BlockTags.MINEABLE_WITH_AXE).add(BlocksPM.CELESTIAL_HARP.get(), BlocksPM.RITUAL_LECTERN.get(), BlocksPM.SUNWOOD_PILLAR.get(), BlocksPM.MOONWOOD_PILLAR.get(), BlocksPM.HALLOWOOD_PILLAR.get());
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(BlocksPM.ROCK_SALT_ORE.get(), BlocksPM.QUARTZ_ORE.get(), BlocksPM.PRIMALITE_BLOCK.get(), BlocksPM.HEXIUM_BLOCK.get(), BlocksPM.HALLOWSTEEL_BLOCK.get(), BlocksPM.CONCOCTER.get(), BlocksPM.RITUAL_BELL.get(), BlocksPM.RUNESCRIBING_ALTAR_BASIC.get(), BlocksPM.RUNESCRIBING_ALTAR_ENCHANTED.get(), BlocksPM.RUNESCRIBING_ALTAR_FORBIDDEN.get(), BlocksPM.RUNESCRIBING_ALTAR_HEAVENLY.get(), BlocksPM.RUNIC_GRINDSTONE.get(), BlocksPM.SANGUINE_CRUCIBLE.get(), BlocksPM.SOUL_ANVIL.get(), BlocksPM.MARBLE_RAW.get(), BlocksPM.MARBLE_SLAB.get(), BlocksPM.MARBLE_STAIRS.get(), BlocksPM.MARBLE_WALL.get(), BlocksPM.MARBLE_BRICKS.get(), BlocksPM.MARBLE_BRICK_SLAB.get(), BlocksPM.MARBLE_BRICK_STAIRS.get(), BlocksPM.MARBLE_BRICK_WALL.get(), BlocksPM.MARBLE_PILLAR.get(), BlocksPM.MARBLE_CHISELED.get(), BlocksPM.MARBLE_RUNED.get(), BlocksPM.MARBLE_ENCHANTED.get(), BlocksPM.MARBLE_ENCHANTED_SLAB.get(), BlocksPM.MARBLE_ENCHANTED_STAIRS.get(), BlocksPM.MARBLE_ENCHANTED_WALL.get(), BlocksPM.MARBLE_ENCHANTED_BRICKS.get(), BlocksPM.MARBLE_ENCHANTED_BRICK_SLAB.get(), BlocksPM.MARBLE_ENCHANTED_BRICK_STAIRS.get(), BlocksPM.MARBLE_ENCHANTED_BRICK_WALL.get(), BlocksPM.MARBLE_ENCHANTED_PILLAR.get(), BlocksPM.MARBLE_ENCHANTED_CHISELED.get(), BlocksPM.MARBLE_ENCHANTED_RUNED.get(), BlocksPM.MARBLE_SMOKED.get(), BlocksPM.MARBLE_SMOKED_SLAB.get(), BlocksPM.MARBLE_SMOKED_STAIRS.get(), BlocksPM.MARBLE_SMOKED_WALL.get(), BlocksPM.MARBLE_SMOKED_BRICKS.get(), BlocksPM.MARBLE_SMOKED_BRICK_SLAB.get(), BlocksPM.MARBLE_SMOKED_BRICK_STAIRS.get(), BlocksPM.MARBLE_SMOKED_BRICK_WALL.get(), BlocksPM.MARBLE_SMOKED_PILLAR.get(), BlocksPM.MARBLE_SMOKED_CHISELED.get(), BlocksPM.MARBLE_SMOKED_RUNED.get(), BlocksPM.MARBLE_HALLOWED.get(), BlocksPM.MARBLE_HALLOWED_SLAB.get(), BlocksPM.MARBLE_HALLOWED_STAIRS.get(), BlocksPM.MARBLE_HALLOWED_WALL.get(), BlocksPM.MARBLE_HALLOWED_BRICKS.get(), BlocksPM.MARBLE_HALLOWED_BRICK_SLAB.get(), BlocksPM.MARBLE_HALLOWED_BRICK_STAIRS.get(), BlocksPM.MARBLE_HALLOWED_BRICK_WALL.get(), BlocksPM.MARBLE_HALLOWED_PILLAR.get(), BlocksPM.MARBLE_HALLOWED_CHISELED.get(), BlocksPM.MARBLE_HALLOWED_RUNED.get());
        ...
        this.tag(Tags.Blocks.STORAGE_BLOCKS).addTag(BlockTagsPM.STORAGE_BLOCKS_PRIMALITE).addTag( BlockTagsPM.STORAGE_BLOCKS_HEXIUM).addTag(BlockTagsPM.STORAGE_BLOCKS_HALLOWSTEEL);
