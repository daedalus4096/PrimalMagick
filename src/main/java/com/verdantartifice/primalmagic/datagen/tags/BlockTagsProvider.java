...
public class BlockTagsProvider extends TagsProvider<Block> {
    ...
    protected void addTags() {
        ...
        this.tag(Tags.Blocks.STORAGE_BLOCKS).add(BlocksPM.IGNYX_BLOCK.get()).addTag(BlockTagsPM.STORAGE_BLOCKS_PRIMALITE).addTag(BlockTagsPM.STORAGE_BLOCKS_HEXIUM).addTag(BlockTagsPM.STORAGE_BLOCKS_HALLOWSTEEL);
