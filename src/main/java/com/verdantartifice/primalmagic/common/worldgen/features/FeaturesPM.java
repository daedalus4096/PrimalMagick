...
public class FeaturesPM {
    ...
    public static void setupFeatures() {
        ...
        TREE_SUNWOOD_FULL = registerFeature("tree_sunwood_full", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.SUNWOOD_LOG_FULL, 19).add(FeaturesPM.States.PULSING_SUNWOOD_LOG_FULL, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_LEAVES_FULL), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_SUNWOOD_WAXING = registerFeature("tree_sunwood_waxing", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.SUNWOOD_LOG_WAXING, 19).add(FeaturesPM.States.PULSING_SUNWOOD_LOG_WAXING, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_LEAVES_WAXING), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_SUNWOOD_WANING = registerFeature("tree_sunwood_waning", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.SUNWOOD_LOG_WANING, 19).add(FeaturesPM.States.PULSING_SUNWOOD_LOG_WANING, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_LEAVES_WANING), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_SUNWOOD_FADED = registerFeature("tree_sunwood_faded", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.SUNWOOD_LOG_FADED, 19).add(FeaturesPM.States.PULSING_SUNWOOD_LOG_FADED, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_LEAVES_FADED), new SimpleStateProvider(FeaturesPM.States.SUNWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        
        TREE_MOONWOOD_FULL = registerFeature("tree_moonwood_full", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.MOONWOOD_LOG_FULL, 19).add(FeaturesPM.States.PULSING_MOONWOOD_LOG_FULL, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_LEAVES_FULL), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_MOONWOOD_WAXING = registerFeature("tree_moonwood_waxing", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.MOONWOOD_LOG_WAXING, 19).add(FeaturesPM.States.PULSING_MOONWOOD_LOG_WAXING, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_LEAVES_WAXING), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_MOONWOOD_WANING = registerFeature("tree_moonwood_waning", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.MOONWOOD_LOG_WANING, 19).add(FeaturesPM.States.PULSING_MOONWOOD_LOG_WANING, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_LEAVES_WANING), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
        TREE_MOONWOOD_FADED = registerFeature("tree_moonwood_faded", Feature.TREE.configured((new TreeConfiguration.TreeConfigurationBuilder(new WeightedStateProvider(SimpleWeightedRandomList.<BlockState>builder().add(FeaturesPM.States.MOONWOOD_LOG_FADED, 19).add(FeaturesPM.States.PULSING_MOONWOOD_LOG_FADED, 1)), new StraightTrunkPlacer(5, 2, 0), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_LEAVES_FADED), new SimpleStateProvider(FeaturesPM.States.MOONWOOD_SAPLING), new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build()));
