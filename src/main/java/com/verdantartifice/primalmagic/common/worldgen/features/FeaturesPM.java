...
public class FeaturesPM {
    ...
    public static void setupFeatures() {
        ...
        ORE_ROCK_SALT = registerFeature("ore_rock_salt", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlocksPM.ROCK_SALT_ORE.get().getDefaultState(), 10)).range(128).square().func_242731_b(20));
        ORE_QUARTZ = registerFeature("ore_quartz", Feature.ORE.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.BASE_STONE_OVERWORLD, BlocksPM.QUARTZ_ORE.get().getDefaultState(), 3)).range(128).square().func_242731_b(20));
