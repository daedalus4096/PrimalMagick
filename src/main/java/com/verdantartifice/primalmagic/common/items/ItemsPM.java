...
public class ItemsPM {
    ...
    public static final RegistryObject<PixieItem> BASIC_EARTH_PIXIE = ITEMS.register("pixie_basic_earth", () -> new PixieItem(() -> EntityTypesPM.BASIC_EARTH_PIXIE.get(), Source.EARTH, new Item.Properties().group(PrimalMagic.ITEM_GROUP).maxStackSize(16)));
}
