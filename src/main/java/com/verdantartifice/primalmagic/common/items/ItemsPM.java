...
import com.verdantartifice.primalmagic.client.renderers.itemstack.TridentISTER;
...
public class ItemsPM {
    ...
    public static final RegistryObject<TridentItemPM> PRIMALITE_TRIDENT = ITEMS.register("primalite_trident", () -> new TridentItemPM(ItemTierPM.PRIMALITE, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.UNCOMMON).setISTER(() -> TridentISTER::new)));
    ...
    public static final RegistryObject<TridentItemPM> HEXIUM_TRIDENT = ITEMS.register("hexium_trident", () -> new TridentItemPM(ItemTierPM.HEXIUM, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.RARE).setISTER(() -> TridentISTER::new)));
    ...
    public static final RegistryObject<TridentItemPM> HALLOWSTEEL_TRIDENT = ITEMS.register("hallowsteel_trident", () -> new TridentItemPM(ItemTierPM.HALLOWSTEEL, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.EPIC).setISTER(() -> TridentISTER::new)));
