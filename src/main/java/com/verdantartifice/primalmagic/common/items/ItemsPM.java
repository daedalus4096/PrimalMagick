...
public class ItemsPM {
    ...
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR = ITEMS.register("runescribing_altar", () -> new BlockItem(BlocksPM.RUNESCRIBING_ALTAR.get(), new Item.Properties().group(PrimalMagic.ITEM_GROUP)));
