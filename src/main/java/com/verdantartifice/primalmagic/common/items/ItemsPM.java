...
public class ItemsPM {
    ...
    public static final RegistryObject<TieredShieldItem> PRIMALITE_SHIELD = ITEMS.register("primalite_shield", () -> new TieredShieldItem(ItemTierPM.PRIMALITE, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.UNCOMMON).setISTER(() -> PrimaliteShieldISTER::new)));
    ...
    public static final RegistryObject<TieredShieldItem> HEXIUM_SHIELD = ITEMS.register("hexium_shield", () -> new TieredShieldItem(ItemTierPM.HEXIUM, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.RARE).setISTER(() -> HexiumShieldISTER::new)));
    ...
    public static final RegistryObject<TieredShieldItem> HALLOWSTEEL_SHIELD = ITEMS.register("hallowsteel_shield", () -> new TieredShieldItem(ItemTierPM.HALLOWSTEEL, new Item.Properties().group(PrimalMagic.ITEM_GROUP).rarity(Rarity.EPIC).setISTER(() -> HallowsteelShieldISTER::new)));
