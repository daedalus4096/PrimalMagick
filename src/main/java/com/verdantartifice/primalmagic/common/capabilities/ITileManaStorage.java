...
/**
 * Capability interface for storing mana.  Methods take and return values in centimana.  Attached
 * to tile entities.
 * 
 * @author Daedalus4096
 */
public interface ITileManaStorage extends INBTSerializable<CompoundNBT> {
    ...
    /**
     * Removes mana of the given source from the storage.  Returns quantity of mana that was removed.
     * 
    ...
    /**
     * Returns the amount of mana of the given source currently stored.
     * 
    ...
    /**
     * Returns the maxiumum amount of mana of the given source that can be stored.
     * 
     * @param source source of mana to be queried
     * @return the maximum amount of mana currently stored
     */
