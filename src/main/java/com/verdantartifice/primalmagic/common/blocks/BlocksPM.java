...
public class BlocksPM {
    ...
    public static final Block MARBLE_ENCHANTED_WALL = null;
    ...
    public static final Block MARBLE_SMOKED_WALL = null;
    ...
    public static final Block STRIPPED_SUNWOOD_WOOD = null;
