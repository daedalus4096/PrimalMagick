...
/**
 * Base definition for a sun pixie.  In addition to following the player as a companion, attacks with
 * solar damage spells.
 * 
 * @author Daedalus4096
 */
public abstract class AbstractSunPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    ...
    protected SpellPackage createSpellPackage() {
        ...
        SolarDamageSpellPayload payload = new SolarDamageSpellPayload();
