 ...
 * @author Daedalus4096
 */
public abstract class AbstractVoidPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    public AbstractVoidPixieEntity(EntityType<? extends AbstractPixieEntity> type, World worldIn) {
        super(type, worldIn);
    }
