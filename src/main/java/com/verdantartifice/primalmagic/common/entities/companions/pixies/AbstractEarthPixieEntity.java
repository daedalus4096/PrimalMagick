...
/**
 * Base definition for an earth pixie.  In addition to following the player as a companion, attacks with
 * earth damage spells.
 * 
 * @author Daedalus4096
 */
public abstract class AbstractEarthPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    public AbstractEarthPixieEntity(EntityType<? extends AbstractPixieEntity> type, World worldIn) {
        super(type, worldIn);
    }
