...
/**
 * Base definition for a moon pixie.  In addition to following the player as a companion, attacks with
 * lunar damage spells.
 * 
 * @author Daedalus4096
 */
public abstract class AbstractMoonPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    public AbstractMoonPixieEntity(EntityType<? extends AbstractPixieEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected SpellPackage createSpellPackage() {
        ...
        LunarDamageSpellPayload payload = new LunarDamageSpellPayload();
