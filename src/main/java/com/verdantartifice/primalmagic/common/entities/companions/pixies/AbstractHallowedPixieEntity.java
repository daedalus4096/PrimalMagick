 ...
 * @author Daedalus4096
 */
public abstract class AbstractHallowedPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    public AbstractHallowedPixieEntity(EntityType<? extends AbstractPixieEntity> type, World worldIn) {
        super(type, worldIn);
    }
