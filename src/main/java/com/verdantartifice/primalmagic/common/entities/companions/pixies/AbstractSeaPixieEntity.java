...
/**
 * Base definition for a sea pixie.  In addition to following the player as a companion, attacks with
 * frost damage spells.
 * 
 * @author Daedalus4096
 */
public abstract class AbstractSeaPixieEntity extends AbstractPixieEntity implements IRangedAttackMob {
    public AbstractSeaPixieEntity(EntityType<? extends AbstractPixieEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    protected SpellPackage createSpellPackage() {
        ...
        FrostDamageSpellPayload payload = new FrostDamageSpellPayload();
