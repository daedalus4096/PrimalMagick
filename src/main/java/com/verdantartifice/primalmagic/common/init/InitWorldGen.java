...
public class InitWorldGen {
    ...
    public static void initWorldGen() {
        ...
        BiomeDictionary.getBiomes(BiomeDictionary.Type.FOREST).stream().filter(InitWorldGen::shouldSpawnSunwood).forEach((biome) -> {
    ...
    private static boolean shouldSpawnSunwood(@Nonnull Biome biome) {
        return !biome.equals(Biomes.FLOWER_FOREST);
    }
}
