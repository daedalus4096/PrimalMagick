...
public class InitTileEntities {
    public static void initTileEntityTypes(IForgeRegistry<TileEntityType<?>> registry) {
        ...
        registry.register(TileEntityType.Builder.create(AnalysisTableTileEntity::new, BlocksPM.ANALYSIS_TABLE).build(null).setRegistryName(PrimalMagic.MODID, "analysis_table"));
    }
}
