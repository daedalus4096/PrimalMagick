...
public class InitRecipes {
    ...
    public static void initWandTransforms() {
        ...
        WandTransforms.register(new WandTransformBlock(Blocks.CRAFTING_TABLE, new ItemStack(BlocksPM.ARCANE_WORKBENCH.get()), CompoundResearchKey.from(SimpleResearchKey.parse("t_got_dream"))));
