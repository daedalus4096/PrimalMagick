...
public class Recipes extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.TOOLS, ItemsPM.MUNDANE_WAND.get())
            ...
            .save(consumer);
        ArcaneShapelessRecipeBuilder.arcaneShapelessRecipe(BlockRegistration.ANALYSIS_TABLE.get())
            .addIngredient(BlockRegistration.WOOD_TABLE.get())
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.MAGNIFYING_GLASS.get())
            ...
            .requiredResearch(ResearchEntries.FIRST_STEPS, 2)
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.WOOD_TABLE.get())
            .patternLine("SSS")
            .patternLine(" P ")
            .patternLine("SPS")
        ...
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(ItemsPM.SPELL_SCROLL_BLANK.get())
            ...
            .build(consumer);
        ArcaneShapelessRecipeBuilder.arcaneShapelessRecipe(BlockRegistration.RESEARCH_TABLE.get())
            .addIngredient(BlockRegistration.WOOD_TABLE.get())
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.FLYING_CARPET.get())
            ...
            .addProp(BlockRegistration.INCENSE_BRAZIER.get(), 2)
            .addProp(BlockRegistration.RITUAL_BELL.get())
            .addProp(BlockRegistration.RITUAL_LECTERN.get())
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.DREAM_VISION_TALISMAN.get())
            ...
            .addProp(BlockTagsPM.RITUAL_CANDLES)
            .addProp(BlockRegistration.INCENSE_BRAZIER.get())
            .addProp(BlockRegistration.RITUAL_LECTERN.get())
    ...
    protected void registerMarbleRecipes(RecipeOutput consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_SLAB.get(), 6)
            .pattern("MMM")
            .define('M', BlockRegistration.MARBLE_BRICKS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_brick_slab_from_marble_raw_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_STAIRS.get(), 4)
            ...
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_STAIRS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_brick_stairs_from_marble_raw_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_STAIRS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_brick_stairs_from_marble_bricks_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_WALL.get(), 6)
            .pattern("MMM")
            .pattern("MMM")
            .define('M', BlockRegistration.MARBLE_BRICKS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_WALL.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_brick_wall_from_marble_raw_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICK_WALL.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICKS.get(), 4)
            .pattern("MM")
            .pattern("MM")
            .define('M', BlockRegistration.MARBLE_RAW.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BRICKS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_bricks_from_marble_raw_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_CHISELED.get())
            .pattern("M")
            .pattern("M")
            .define('M', BlockRegistration.MARBLE_SLAB.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_CHISELED.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_chiseled_from_marble_raw_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_PILLAR.get(), 2)
            .pattern("M")
            .pattern("M")
            .define('M', BlockRegistration.MARBLE_RAW.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_PILLAR.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_pillar_from_marble_raw_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_RUNED.get(), 5)
            .pattern(" M ")
            .pattern("MCM")
            .pattern(" M ")
            .define('M', BlockRegistration.MARBLE_RAW.get())
            .define('C', BlockRegistration.MARBLE_CHISELED.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_RUNED.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SLAB.get(), 6)
            ...
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SLAB.get(), 2)
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_STAIRS.get(), 4)
            ...
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_STAIRS.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_stairs_from_marble_raw_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_WALL.get(), 6)
            .pattern("MMM")
            .pattern("MMM")
            .define('M', BlockRegistration.MARBLE_RAW.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_WALL.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_wall_from_marble_raw_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_TILES.get(), 4)
            .pattern("MM")
            .pattern("MM")
            .define('M', BlockRegistration.MARBLE_BRICKS.get())
            .unlockedBy("has_marble_bricks", has(BlockRegistration.MARBLE_BRICKS.get()))
            .save(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_RAW.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_TILES.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer, ResourceUtils.loc("marble_tiles_from_marble_raw_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_TILES.get())
            .unlockedBy("has_marble_bricks", has(BlockRegistration.MARBLE_BRICKS.get()))
            .save(consumer, ResourceUtils.loc("marble_tiles_from_marble_bricks_stonecutting"));
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_BOOKSHELF.get())
            .pattern("MMM")
            .pattern("SSS")
            .pattern("MMM")
            .define('M', BlockRegistration.MARBLE_RAW.get())
            .define('S', BlockRegistration.MARBLE_SLAB.get())
            .unlockedBy("has_marble_raw", has(BlockRegistration.MARBLE_RAW.get()))
            .save(consumer);
    }

    protected void registerEnchantedMarbleRecipes(RecipeOutput consumer) {
        ArcaneShapelessRecipeBuilder.arcaneShapelessRecipe(BlockRegistration.MARBLE_ENCHANTED.get(), 9)
            .addIngredient(BlockRegistration.MARBLE_RAW.get(), 9)
            ...
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_BRICK_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED_BRICKS.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_slab_from_marble_enchanted_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_slab_from_marble_enchanted_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_BRICK_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED_BRICKS.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_stairs_from_marble_enchanted_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_stairs_from_marble_enchanted_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_BRICK_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED_BRICKS.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_WALL.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_wall_from_marble_enchanted_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICK_WALL.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_brick_wall_from_marble_enchanted_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_BRICKS.get(), 4)
            .patternLine("MM")
            .patternLine("MM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_BRICKS.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_bricks_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_CHISELED.get())
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_ENCHANTED_SLAB.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_CHISELED.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_chiseled_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_PILLAR.get(), 2)
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_PILLAR.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_pillar_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_RUNED.get(), 5)
            .patternLine(" M ")
            .patternLine("MCM")
            .patternLine(" M ")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .key('C', BlockRegistration.MARBLE_ENCHANTED_CHISELED.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_RUNED.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_runed_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_SLAB.get(), 2)
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_slab_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_STAIRS.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_stairs_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_ENCHANTED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_ENCHANTED_WALL.get())
            .unlockedBy("has_marble_enchanted", has(BlockRegistration.MARBLE_ENCHANTED.get()))
            .save(consumer, ResourceUtils.loc("marble_enchanted_wall_from_marble_enchanted_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_ENCHANTED_BOOKSHELF.get())
            .patternLine("MMM")
            .patternLine("SSS")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_ENCHANTED.get())
            .key('S', BlockRegistration.MARBLE_ENCHANTED_SLAB.get())
            .requiredResearch(ResearchEntries.EXPERT_MANAWEAVING)
            .noExpertise()
            .build(consumer);
    }
    ...
    protected void registerSmokedMarbleRecipes(RecipeOutput consumer) {
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED.get(), 8)
            .patternLine("MMM")
            .patternLine("MCM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_RAW.get())
            .key('C', ItemTags.COALS)
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .manaCost(SourceList.EMPTY.add(Sources.MOON, 5))
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_BRICK_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED_BRICKS.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_slab_from_marble_smoked_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_slab_from_marble_smoked_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_BRICK_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED_BRICKS.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_stairs_from_marble_smoked_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_stairs_from_marble_smoked_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_BRICK_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED_BRICKS.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_WALL.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_wall_from_marble_smoked_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICK_WALL.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_brick_wall_from_marble_smoked_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_BRICKS.get(), 4)
            .patternLine("MM")
            .patternLine("MM")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_BRICKS.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_bricks_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_CHISELED.get())
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_SMOKED_SLAB.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_CHISELED.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_chiseled_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_PILLAR.get(), 2)
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_PILLAR.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_pillar_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_RUNED.get(), 5)
            .patternLine(" M ")
            .patternLine("MCM")
            .patternLine(" M ")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .key('C', BlockRegistration.MARBLE_SMOKED_CHISELED.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_RUNED.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_runed_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_SLAB.get(), 2)
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_slab_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_STAIRS.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_stairs_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_SMOKED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_SMOKED_WALL.get())
            .unlockedBy("has_marble_smoked", has(BlockRegistration.MARBLE_SMOKED.get()))
            .save(consumer, ResourceUtils.loc("marble_smoked_wall_from_marble_smoked_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_SMOKED_BOOKSHELF.get())
            .patternLine("MMM")
            .patternLine("SSS")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_SMOKED.get())
            .key('S', BlockRegistration.MARBLE_SMOKED_SLAB.get())
            .requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
            .noExpertise()
            .build(consumer);
    }
    ...
    protected void registerHallowedMarbleRecipes(RecipeOutput consumer) {
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED.get(), 8)
            .patternLine("MMM")
            .patternLine("MDM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_RAW.get())
            ...
            .build(consumer);
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_BRICK_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED_BRICKS.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_slab_from_marble_hallowed_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_SLAB.get(), 2)
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_slab_from_marble_hallowed_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_BRICK_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED_BRICKS.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_stairs_from_marble_hallowed_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_STAIRS.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_stairs_from_marble_hallowed_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_BRICK_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED_BRICKS.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_WALL.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_wall_from_marble_hallowed_stonecutting"));
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED_BRICKS.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICK_WALL.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_brick_wall_from_marble_hallowed_bricks_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_BRICKS.get(), 4)
            .patternLine("MM")
            .patternLine("MM")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_BRICKS.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_bricks_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_CHISELED.get())
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_HALLOWED_SLAB.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_CHISELED.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_chiseled_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_PILLAR.get(), 2)
            .patternLine("M")
            .patternLine("M")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_PILLAR.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_pillar_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_RUNED.get(), 5)
            .patternLine(" M ")
            .patternLine("MCM")
            .patternLine(" M ")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .key('C', BlockRegistration.MARBLE_HALLOWED_CHISELED.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_RUNED.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_runed_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_SLAB.get(), 6)
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_SLAB.get(), 2)
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_slab_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_STAIRS.get(), 4)
            .patternLine("M  ")
            .patternLine("MM ")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            ...
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_STAIRS.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_stairs_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_WALL.get(), 6)
            .patternLine("MMM")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
        SingleItemRecipeBuilder.stonecutting(Ingredient.of(BlockRegistration.MARBLE_HALLOWED.get()), RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MARBLE_HALLOWED_WALL.get())
            .unlockedBy("has_marble_hallowed", has(BlockRegistration.MARBLE_HALLOWED.get()))
            .save(consumer, ResourceUtils.loc("marble_hallowed_wall_from_marble_hallowed_stonecutting"));
        ArcaneShapedRecipeBuilder.arcaneShapedRecipe(BlockRegistration.MARBLE_HALLOWED_BOOKSHELF.get())
            .patternLine("MMM")
            .patternLine("SSS")
            .patternLine("MMM")
            .key('M', BlockRegistration.MARBLE_HALLOWED.get())
            .key('S', BlockRegistration.MARBLE_HALLOWED_SLAB.get())
            .requiredResearch(ResearchEntries.SUPREME_MANAWEAVING)
            .noExpertise()
            .build(consumer);
    }
    ...
    protected void registerSunwoodRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ItemsPM.STRIPPED_SUNWOOD_WOOD.get(), 3)
            ...
            .save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.SUNWOOD_PLANKS.get(), 4)
            .requires(ItemTagsPM.SUNWOOD_LOGS)
            .group("planks")
            .unlockedBy("has_sunwood_log", has(ItemTagsPM.SUNWOOD_LOGS))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.SUNWOOD_SLAB.get(), 6)
            .pattern("###")
            .define('#', BlockRegistration.SUNWOOD_PLANKS.get())
            .group("wooden_slab")
            .unlockedBy("has_planks", has(BlockRegistration.SUNWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.SUNWOOD_STAIRS.get(), 4)
            .pattern("#  ")
            .pattern("## ")
            .pattern("###")
            .define('#', BlockRegistration.SUNWOOD_PLANKS.get())
            ...
            .unlockedBy("has_planks", has(BlockRegistration.SUNWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.SUNWOOD_PILLAR.get(), 2)
            .pattern("#")
            .pattern("#")
    ...
    protected void registerMoonwoodRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ItemsPM.STRIPPED_MOONWOOD_WOOD.get(), 3)
            ...
            .save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MOONWOOD_PLANKS.get(), 4)
            .requires(ItemTagsPM.MOONWOOD_LOGS)
            .group("planks")
            .unlockedBy("has_moonwood_log", has(ItemTagsPM.MOONWOOD_LOGS))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MOONWOOD_SLAB.get(), 6)
            .pattern("###")
            .define('#', BlockRegistration.MOONWOOD_PLANKS.get())
            .group("wooden_slab")
            .unlockedBy("has_planks", has(BlockRegistration.MOONWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MOONWOOD_STAIRS.get(), 4)
            .pattern("#  ")
            .pattern("## ")
            .pattern("###")
            .define('#', BlockRegistration.MOONWOOD_PLANKS.get())
            ...
            .unlockedBy("has_planks", has(BlockRegistration.MOONWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.MOONWOOD_PILLAR.get(), 2)
            .pattern("#")
            .pattern("#")
    ...
    protected void registerHallowoodRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ItemsPM.STRIPPED_HALLOWOOD_WOOD.get(), 3)
            ...
            .save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.HALLOWOOD_PLANKS.get(), 4)
            .requires(ItemTagsPM.HALLOWOOD_LOGS)
            .group("planks")
            .unlockedBy("has_hallowood_log", has(ItemTagsPM.HALLOWOOD_LOGS))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.HALLOWOOD_SLAB.get(), 6)
            .pattern("###")
            .define('#', BlockRegistration.HALLOWOOD_PLANKS.get())
            .group("wooden_slab")
            .unlockedBy("has_planks", has(BlockRegistration.HALLOWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.HALLOWOOD_STAIRS.get(), 4)
            .pattern("#  ")
            .pattern("## ")
            .pattern("###")
            .define('#', BlockRegistration.HALLOWOOD_PLANKS.get())
            ...
            .unlockedBy("has_planks", has(BlockRegistration.HALLOWOOD_PLANKS.get()))
            .save(consumer);
        ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, BlockRegistration.HALLOWOOD_PILLAR.get(), 2)
            .pattern("#")
            .pattern("#")
    ...
    protected void registerSaltRecipes(RecipeOutput consumer) {
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(BlockRegistration.ROCK_SALT_ORE.get()), RecipeCategory.MISC, ItemsPM.ROCK_SALT.get(), 0, 200)
            .unlockedBy("has_rock_salt_ore", has(BlockRegistration.ROCK_SALT_ORE.get()))
    ...
    protected void registerMineralRecipes(RecipeOutput consumer) {
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(BlockRegistration.QUARTZ_ORE.get()), RecipeCategory.MISC, Items.QUARTZ, 0.2F, 200)
            .unlockedBy("has_quartz_ore", has(BlockRegistration.QUARTZ_ORE.get()))
            .save(consumer, ResourceUtils.loc("quartz_from_smelting"));
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(BlockRegistration.QUARTZ_ORE.get()), RecipeCategory.MISC, Items.QUARTZ, 0.2F, 200)
            .unlockedBy("has_quartz_ore", has(BlockRegistration.QUARTZ_ORE.get()))
    ...
    protected void registerWandComponentRecipes(RecipeOutput consumer) {
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.DARK_PRIMAL_WAND_CORE_ITEM.get())
            ...
            .addProp(BlockRegistration.RITUAL_LECTERN.get())
            .addProp(BlockTagsPM.RITUAL_CANDLES)
            .addProp(BlockRegistration.BLOODLETTER.get())
            .addProp(BlockRegistration.SOUL_ANVIL.get())
            .instability(5)
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.PURE_PRIMAL_WAND_CORE_ITEM.get())
            ...
            .addProp(BlockRegistration.BLOODLETTER.get())
            .addProp(BlockRegistration.SOUL_ANVIL.get())
            .addProp(BlockRegistration.CELESTIAL_HARP.get())
            .instability(7)
    ...
    protected void registerPrimalToolRecipes(RecipeOutput consumer) {
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.FORBIDDEN_TRIDENT.get().getDefaultEnchantedInstance(consumer.registry()))
            ...
            .addIngredient(ItemsPM.MANA_PRISM.get())
            .addIngredient(ItemsPM.MANA_SALTS.get())
            .addProp(BlockRegistration.BLOODLETTER.get(), 2)
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.FORBIDDEN_BOW.get().getDefaultEnchantedInstance(consumer.registry()))
            ...
            .addIngredient(ItemsPM.MANA_PRISM.get())
            .addIngredient(ItemsPM.MANA_SALTS.get())
            .addProp(BlockRegistration.SOUL_ANVIL.get(), 2)
        ...
        RitualRecipeBuilder.ritualRecipe(ItemsPM.SACRED_SHIELD.get().getDefaultEnchantedInstance(consumer.registry()))
            ...
            .addIngredient(ItemsPM.MANA_PRISM.get())
            .addIngredient(ItemsPM.MANA_SALTS.get())
            .addProp(BlockRegistration.CELESTIAL_HARP.get(), 2)
