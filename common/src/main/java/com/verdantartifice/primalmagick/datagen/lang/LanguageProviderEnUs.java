...
public class LanguageProviderEnUs extends AbstractLanguageProviderPM {
    ...
    protected void addLocalizations(HolderLookup.Provider lookupProvider) {
        ...
        this.block(BlockRegistration.MARBLE_RAW).name("Marble").build();
        this.block(BlockRegistration.MARBLE_SLAB).name("Marble Slab").build();
        this.block(BlockRegistration.MARBLE_STAIRS).name("Marble Stairs").build();
        this.block(BlockRegistration.MARBLE_WALL).name("Marble Wall").build();
        this.block(BlockRegistration.MARBLE_BRICKS).name("Marble Bricks").build();
        this.block(BlockRegistration.MARBLE_BRICK_SLAB).name("Marble Brick Slab").build();
        this.block(BlockRegistration.MARBLE_BRICK_STAIRS).name("Marble Brick Stairs").build();
        this.block(BlockRegistration.MARBLE_BRICK_WALL).name("Marble Brick Wall").build();
        this.block(BlockRegistration.MARBLE_PILLAR).name("Marble Pillar").build();
        this.block(BlockRegistration.MARBLE_CHISELED).name("Chiseled Marble").build();
        this.block(BlockRegistration.MARBLE_RUNED).name("Runed Marble").build();
        this.block(BlockRegistration.MARBLE_TILES).name("Marble Tiles").build();
        this.block(BlockRegistration.MARBLE_BOOKSHELF).name("Marble Bookshelf").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED).name("Enchanted Marble").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_SLAB).name("Enchanted Marble Slab").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_STAIRS).name("Enchanted Marble Stairs").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_WALL).name("Enchanted Marble Wall").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_BRICKS).name("Enchanted Marble Bricks").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_BRICK_SLAB).name("Enchanted Marble Brick Slab").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_BRICK_STAIRS).name("Enchanted Marble Brick Stairs").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_BRICK_WALL).name("Enchanted Marble Brick Wall").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_PILLAR).name("Enchanted Marble Pillar").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_CHISELED).name("Enchanted Chiseled Marble").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_RUNED).name("Enchanted Runed Marble").build();
        this.block(BlockRegistration.MARBLE_ENCHANTED_BOOKSHELF).name("Enchanted Marble Bookshelf").build();
        this.block(BlockRegistration.MARBLE_SMOKED).name("Smoked Marble").build();
        this.block(BlockRegistration.MARBLE_SMOKED_SLAB).name("Smoked Marble Slab").build();
        this.block(BlockRegistration.MARBLE_SMOKED_STAIRS).name("Smoked Marble Stairs").build();
        this.block(BlockRegistration.MARBLE_SMOKED_WALL).name("Smoked Marble Wall").build();
        this.block(BlockRegistration.MARBLE_SMOKED_BRICKS).name("Smoked Marble Bricks").build();
        this.block(BlockRegistration.MARBLE_SMOKED_BRICK_SLAB).name("Smoked Marble Brick Slab").build();
        this.block(BlockRegistration.MARBLE_SMOKED_BRICK_STAIRS).name("Smoked Marble Brick Stairs").build();
        this.block(BlockRegistration.MARBLE_SMOKED_BRICK_WALL).name("Smoked Marble Brick Wall").build();
        this.block(BlockRegistration.MARBLE_SMOKED_PILLAR).name("Smoked Marble Pillar").build();
        this.block(BlockRegistration.MARBLE_SMOKED_CHISELED).name("Smoked Chiseled Marble").build();
        this.block(BlockRegistration.MARBLE_SMOKED_RUNED).name("Smoked Runed Marble").build();
        this.block(BlockRegistration.MARBLE_SMOKED_BOOKSHELF).name("Smoked Marble Bookshelf").build();
        this.block(BlockRegistration.MARBLE_HALLOWED).name("Hallowed Marble").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_SLAB).name("Hallowed Marble Slab").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_STAIRS).name("Hallowed Marble Stairs").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_WALL).name("Hallowed Marble Wall").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_BRICKS).name("Hallowed Marble Bricks").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_BRICK_SLAB).name("Hallowed Marble Brick Slab").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_BRICK_STAIRS).name("Hallowed Marble Brick Stairs").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_BRICK_WALL).name("Hallowed Marble Brick Wall").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_PILLAR).name("Hallowed Marble Pillar").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_CHISELED).name("Hallowed Chiseled Marble").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_RUNED).name("Hallowed Runed Marble").build();
        this.block(BlockRegistration.MARBLE_HALLOWED_BOOKSHELF).name("Hallowed Marble Bookshelf").build();
        this.block(BlockRegistration.SUNWOOD_LOG).name("Sunwood Log").build();
        this.block(BlockRegistration.STRIPPED_SUNWOOD_LOG).name("Stripped Sunwood Log").build();
        this.block(BlockRegistration.SUNWOOD_WOOD).name("Sunwood Wood").build();
        this.block(BlockRegistration.STRIPPED_SUNWOOD_WOOD).name("Stripped Sunwood Wood").build();
        this.block(BlockRegistration.SUNWOOD_LEAVES).name("Sunwood Leaves").build();
        this.block(BlockRegistration.SUNWOOD_SAPLING).name("Sunwood Sapling").build();
        this.block(BlockRegistration.SUNWOOD_PLANKS).name("Sunwood Planks").build();
        this.block(BlockRegistration.SUNWOOD_SLAB).name("Sunwood Slab").build();
        this.block(BlockRegistration.SUNWOOD_STAIRS).name("Sunwood Stairs").build();
        this.block(BlockRegistration.SUNWOOD_PILLAR).name("Sunwood Pillar").build();
        this.block(BlockRegistration.MOONWOOD_LOG).name("Moonwood Log").build();
        this.block(BlockRegistration.STRIPPED_MOONWOOD_LOG).name("Stripped Moonwood Log").build();
        this.block(BlockRegistration.MOONWOOD_WOOD).name("Moonwood Wood").build();
        this.block(BlockRegistration.STRIPPED_MOONWOOD_WOOD).name("Stripped Moonwood Wood").build();
        this.block(BlockRegistration.MOONWOOD_LEAVES).name("Moonwood Leaves").build();
        this.block(BlockRegistration.MOONWOOD_SAPLING).name("Moonwood Sapling").build();
        this.block(BlockRegistration.MOONWOOD_PLANKS).name("Moonwood Planks").build();
        this.block(BlockRegistration.MOONWOOD_SLAB).name("Moonwood Slab").build();
        this.block(BlockRegistration.MOONWOOD_STAIRS).name("Moonwood Stairs").build();
        this.block(BlockRegistration.MOONWOOD_PILLAR).name("Moonwood Pillar").build();
        this.block(BlockRegistration.HALLOWOOD_LOG).name("Hallowood Log").build();
        this.block(BlockRegistration.STRIPPED_HALLOWOOD_LOG).name("Stripped Hallowood Log").build();
        this.block(BlockRegistration.HALLOWOOD_WOOD).name("Hallowood Wood").build();
        this.block(BlockRegistration.STRIPPED_HALLOWOOD_WOOD).name("Stripped Hallowood Wood").build();
        this.block(BlockRegistration.HALLOWOOD_LEAVES).name("Hallowood Leaves").build();
        this.block(BlockRegistration.HALLOWOOD_SAPLING).name("Hallowood Sapling").build();
        this.block(BlockRegistration.HALLOWOOD_PLANKS).name("Hallowood Planks").build();
        this.block(BlockRegistration.HALLOWOOD_SLAB).name("Hallowood Slab").build();
        this.block(BlockRegistration.HALLOWOOD_STAIRS).name("Hallowood Stairs").build();
        this.block(BlockRegistration.HALLOWOOD_PILLAR).name("Hallowood Pillar").build();
        this.block(BlockRegistration.ARCANE_WORKBENCH).name("Arcane Workbench").build();
        this.block(BlockRegistration.ANCIENT_FONT_EARTH).name("Ancient Earth Font").build();
        this.block(BlockRegistration.ANCIENT_FONT_SEA).name("Ancient Sea Font").build();
        this.block(BlockRegistration.ANCIENT_FONT_SKY).name("Ancient Sky Font").build();
        this.block(BlockRegistration.ANCIENT_FONT_SUN).name("Ancient Sun Font").build();
        this.block(BlockRegistration.ANCIENT_FONT_MOON).name("Ancient Moon Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_EARTH).name("Artificial Earth Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_SEA).name("Artificial Sea Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_SKY).name("Artificial Sky Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_SUN).name("Artificial Sun Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_MOON).name("Artificial Moon Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_BLOOD).name("Artificial Blood Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_INFERNAL).name("Artificial Infernal Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_VOID).name("Artificial Void Font").build();
        this.block(BlockRegistration.ARTIFICIAL_FONT_HALLOWED).name("Artificial Hallowed Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_EARTH).name("Forbidden Earth Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_SEA).name("Forbidden Sea Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_SKY).name("Forbidden Sky Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_SUN).name("Forbidden Sun Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_MOON).name("Forbidden Moon Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_BLOOD).name("Forbidden Blood Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_INFERNAL).name("Forbidden Infernal Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_VOID).name("Forbidden Void Font").build();
        this.block(BlockRegistration.FORBIDDEN_FONT_HALLOWED).name("Forbidden Hallowed Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_EARTH).name("Heavenly Earth Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_SEA).name("Heavenly Sea Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_SKY).name("Heavenly Sky Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_SUN).name("Heavenly Sun Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_MOON).name("Heavenly Moon Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_BLOOD).name("Heavenly Blood Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_INFERNAL).name("Heavenly Infernal Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_VOID).name("Heavenly Void Font").build();
        this.block(BlockRegistration.HEAVENLY_FONT_HALLOWED).name("Heavenly Hallowed Font").build();
        this.block(BlockRegistration.WAND_ASSEMBLY_TABLE).name("Wand Assembly Table").build();
        this.block(BlockRegistration.WOOD_TABLE).name("Wood Table").build();
        this.block(BlockRegistration.ANALYSIS_TABLE).name("Analysis Table").build();
        this.block(BlockRegistration.ESSENCE_FURNACE).name("Essence Furnace").build();
        this.block(BlockRegistration.CALCINATOR_BASIC).name("Basic Calcinator").build();
        this.block(BlockRegistration.CALCINATOR_ENCHANTED).name("Enchanted Calcinator").build();
        this.block(BlockRegistration.CALCINATOR_FORBIDDEN).name("Forbidden Calcinator").build();
        this.block(BlockRegistration.CALCINATOR_HEAVENLY).name("Heavenly Calcinator").build();
        this.block(BlockRegistration.WAND_INSCRIPTION_TABLE).name("Wand Inscription Table").build();
        this.block(BlockRegistration.SPELLCRAFTING_ALTAR).name("Spellcrafting Altar").build();
        this.block(BlockRegistration.WAND_CHARGER).name("Mana Charger").build();
        this.block(BlockRegistration.CONSECRATION_FIELD).name("Consecration Field").build();
        this.block(BlockRegistration.INFUSED_STONE_EARTH).name("Earth-Infused Stone").build();
        this.block(BlockRegistration.INFUSED_STONE_SEA).name("Sea-Infused Stone").build();
        this.block(BlockRegistration.INFUSED_STONE_SKY).name("Sky-Infused Stone").build();
        this.block(BlockRegistration.INFUSED_STONE_SUN).name("Sun-Infused Stone").build();
        this.block(BlockRegistration.INFUSED_STONE_MOON).name("Moon-Infused Stone").build();
        this.block(BlockRegistration.GLOW_FIELD).name("Glow Field").build();
        this.block(BlockRegistration.RESEARCH_TABLE).name("Research Table").build();
        this.block(BlockRegistration.SALT_TRAIL).name("Salt Trail").build();
        this.block(BlockRegistration.RITUAL_ALTAR).name("Ritual Altar").build();
        this.block(BlockRegistration.ROCK_SALT_ORE).name("Rock Salt Ore").build();
        this.block(BlockRegistration.SKYGLASS).name("Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_BLACK).name("Black Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_BLUE).name("Blue Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_BROWN).name("Brown Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_CYAN).name("Cyan Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_GRAY).name("Gray Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_GREEN).name("Green Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_LIGHT_BLUE).name("Light Blue Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_LIGHT_GRAY).name("Light Gray Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_LIME).name("Lime Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_MAGENTA).name("Magenta Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_ORANGE).name("Orange Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PINK).name("Pink Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PURPLE).name("Purple Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_RED).name("Red Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_WHITE).name("White Stained Skyglass").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_YELLOW).name("Yellow Stained Skyglass").build();
        this.block(BlockRegistration.SKYGLASS_PANE).name("Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_BLACK).name("Black Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_BLUE).name("Blue Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_BROWN).name("Brown Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_CYAN).name("Cyan Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_GRAY).name("Gray Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_GREEN).name("Green Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_LIGHT_BLUE).name("Light Blue Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_LIGHT_GRAY).name("Light Gray Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_LIME).name("Lime Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_MAGENTA).name("Magenta Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_ORANGE).name("Orange Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_PINK).name("Pink Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_PURPLE).name("Purple Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_RED).name("Red Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_WHITE).name("White Stained Skyglass Pane").build();
        this.block(BlockRegistration.STAINED_SKYGLASS_PANE_YELLOW).name("Yellow Stained Skyglass Pane").build();
        this.block(BlockRegistration.PRIMALITE_BLOCK).name("Primalite Block").build();
        this.block(BlockRegistration.HEXIUM_BLOCK).name("Hexium Block").build();
        this.block(BlockRegistration.HALLOWSTEEL_BLOCK).name("Hallowsteel Block").build();
        this.block(BlockRegistration.QUARTZ_ORE).name("Quartz Ore").build();
        this.block(BlockRegistration.SUNLAMP).name("Sunlamp").build();
        this.block(BlockRegistration.SPIRIT_LANTERN).name("Spirit Lantern").build();
        this.block(BlockRegistration.RITUAL_CANDLE_BLACK).name("Black Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_BLUE).name("Blue Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_BROWN).name("Brown Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_CYAN).name("Cyan Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_GRAY).name("Gray Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_GREEN).name("Green Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_LIGHT_BLUE).name("Light Blue Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_LIGHT_GRAY).name("Light Gray Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_LIME).name("Lime Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_MAGENTA).name("Magenta Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_ORANGE).name("Orange Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_PINK).name("Pink Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_PURPLE).name("Purple Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_RED).name("Red Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_WHITE).name("White Ritual Candle").build();
        this.block(BlockRegistration.RITUAL_CANDLE_YELLOW).name("Yellow Ritual Candle").build();
        this.block(BlockRegistration.OFFERING_PEDESTAL).name("Offering Pedestal").build();
        this.block(BlockRegistration.INCENSE_BRAZIER).name("Incense Brazier").build();
        this.block(BlockRegistration.RITUAL_LECTERN).name("Ritual Lectern").build();
        this.block(BlockRegistration.RITUAL_BELL).name("Ritual Bell").build();
        this.block(BlockRegistration.BLOODLETTER).name("Bloodletter").build();
        this.block(BlockRegistration.SOUL_ANVIL).name("Soul Anvil").build();
        this.block(BlockRegistration.CELESTIAL_HARP).name("Celestial Harp").build();
        this.block(BlockRegistration.ENTROPY_SINK).name("Entropy Sink").build();
        this.block(BlockRegistration.RUNESCRIBING_ALTAR_BASIC).name("Basic Runescribing Altar").build();
        this.block(BlockRegistration.RUNESCRIBING_ALTAR_ENCHANTED).name("Enchanted Runescribing Altar").build();
        this.block(BlockRegistration.RUNESCRIBING_ALTAR_FORBIDDEN).name("Forbidden Runescribing Altar").build();
        this.block(BlockRegistration.RUNESCRIBING_ALTAR_HEAVENLY).name("Heavenly Runescribing Altar").build();
        this.block(BlockRegistration.RUNECARVING_TABLE).name("Runecarving Table").build();
        this.block(BlockRegistration.RUNIC_GRINDSTONE).name("Runic Grindstone").build();
        this.block(BlockRegistration.HONEY_EXTRACTOR).name("Honey Extractor").build();
        this.block(BlockRegistration.PRIMALITE_GOLEM_CONTROLLER).name("Primalite Golem Controller").build();
        this.block(BlockRegistration.HEXIUM_GOLEM_CONTROLLER).name("Hexium Golem Controller").build();
        this.block(BlockRegistration.HALLOWSTEEL_GOLEM_CONTROLLER).name("Hallowsteel Golem Controller").build();
        this.block(BlockRegistration.SANGUINE_CRUCIBLE).name("Sanguine Crucible").build();
        this.block(BlockRegistration.CONCOCTER).name("Concocter").build();
        this.block(BlockRegistration.AUTO_CHARGER).name("Auto-Charger").build();
        this.block(BlockRegistration.IGNYX_BLOCK).name("Block of Ignyx").build();
        this.block(BlockRegistration.SALT_BLOCK).name("Block of Refined Salt").build();
        this.block(BlockRegistration.ESSENCE_TRANSMUTER).name("Essence Transmuter").build();
        this.block(BlockRegistration.DISSOLUTION_CHAMBER).name("Dissolution Chamber").build();
        this.block(BlockRegistration.ZEPHYR_ENGINE).name("Zephyr Engine").build();
        this.block(BlockRegistration.VOID_TURBINE).name("Void Turbine").build();
        this.block(BlockRegistration.ESSENCE_CASK_ENCHANTED).name("Enchanted Essence Cask").build();
        this.block(BlockRegistration.ESSENCE_CASK_FORBIDDEN).name("Forbidden Essence Cask").build();
        this.block(BlockRegistration.ESSENCE_CASK_HEAVENLY).name("Heavenly Essence Cask").build();
        this.block(BlockRegistration.WAND_GLAMOUR_TABLE).name("Wand Glamour Table").build();
        this.block(BlockRegistration.TREEFOLK_SPROUT).name("Treefolk Sprout").build();
        this.block(BlockRegistration.INFERNAL_FURNACE).name("Infernal Furnace").build();
        this.block(BlockRegistration.MANA_NEXUS).name("Mana Nexus").build();
        ...
        this.block(BlockRegistration.MEDIUM_SYNTHETIC_AMETHYST_BUD).name("Medium Synthetic Amethyst Bud").build();
        this.block(BlockRegistration.SMALL_SYNTHETIC_AMETHYST_BUD).name("Small Synthetic Amethyst Bud").build();
        this.block(BlockRegistration.DAMAGED_BUDDING_AMETHYST_BLOCK).name("Damaged Budding Amethyst Block").build();
        this.block(BlockRegistration.CHIPPED_BUDDING_AMETHYST_BLOCK).name("Chipped Budding Amethyst Block").build();
        this.block(BlockRegistration.FLAWED_BUDDING_AMETHYST_BLOCK).name("Flawed Budding Amethyst Block").build();
        this.block(BlockRegistration.SYNTHETIC_DIAMOND_CLUSTER).name("Synthetic Diamond Cluster").build();
        this.block(BlockRegistration.LARGE_SYNTHETIC_DIAMOND_BUD).name("Large Synthetic Diamond Bud").build();
        this.block(BlockRegistration.MEDIUM_SYNTHETIC_DIAMOND_BUD).name("Medium Synthetic Diamond Bud").build();
        this.block(BlockRegistration.SMALL_SYNTHETIC_DIAMOND_BUD).name("Small Synthetic Diamond Bud").build();
        this.block(BlockRegistration.DAMAGED_BUDDING_DIAMOND_BLOCK).name("Damaged Budding Diamond Block").build();
        this.block(BlockRegistration.CHIPPED_BUDDING_DIAMOND_BLOCK).name("Chipped Budding Diamond Block").build();
        this.block(BlockRegistration.FLAWED_BUDDING_DIAMOND_BLOCK).name("Flawed Budding Diamond Block").build();
        this.block(BlockRegistration.SYNTHETIC_EMERALD_CLUSTER).name("Synthetic Emerald Cluster").build();
        this.block(BlockRegistration.LARGE_SYNTHETIC_EMERALD_BUD).name("Large Synthetic Emerald Bud").build();
        this.block(BlockRegistration.MEDIUM_SYNTHETIC_EMERALD_BUD).name("Medium Synthetic Emerald Bud").build();
        this.block(BlockRegistration.SMALL_SYNTHETIC_EMERALD_BUD).name("Small Synthetic Emerald Bud").build();
        this.block(BlockRegistration.DAMAGED_BUDDING_EMERALD_BLOCK).name("Damaged Budding Emerald Block").build();
        this.block(BlockRegistration.CHIPPED_BUDDING_EMERALD_BLOCK).name("Chipped Budding Emerald Block").build();
        this.block(BlockRegistration.FLAWED_BUDDING_EMERALD_BLOCK).name("Flawed Budding Emerald Block").build();
        this.block(BlockRegistration.SYNTHETIC_QUARTZ_CLUSTER).name("Synthetic Quartz Cluster").build();
        this.block(BlockRegistration.LARGE_SYNTHETIC_QUARTZ_BUD).name("Large Synthetic Quartz Bud").build();
        this.block(BlockRegistration.MEDIUM_SYNTHETIC_QUARTZ_BUD).name("Medium Synthetic Quartz Bud").build();
        this.block(BlockRegistration.SMALL_SYNTHETIC_QUARTZ_BUD).name("Small Synthetic Quartz Bud").build();
        this.block(BlockRegistration.DAMAGED_BUDDING_QUARTZ_BLOCK).name("Damaged Budding Quartz Block").build();
        this.block(BlockRegistration.CHIPPED_BUDDING_QUARTZ_BLOCK).name("Chipped Budding Quartz Block").build();
        this.block(BlockRegistration.FLAWED_BUDDING_QUARTZ_BLOCK).name("Flawed Budding Quartz Block").build();
        this.block(BlockRegistration.ENDERWARD).name("Enderward").build();
        this.block(BlockRegistration.SCRIBE_TABLE).name("Scribe's Table").build();
        
        // Generate item localizations
        this.item(ItemRegistration.GRIMOIRE).name("Grimoire").build();
        this.item(ItemRegistration.CREATIVE_GRIMOIRE).name("Creative Grimoire").tooltip("Contains all the secrets of the arcane").build();
        this.item(ItemRegistration.ARCANOMETER).name("Arcanometer").build();
        this.item(ItemRegistration.MAGNIFYING_GLASS).name("Magnifying Glass").build();
        this.item(ItemRegistration.ESSENCE_DUST_EARTH).name("Earth Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_SEA).name("Sea Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_SKY).name("Sky Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_SUN).name("Sun Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_MOON).name("Moon Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_BLOOD).name("Blood Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_INFERNAL).name("Infernal Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_VOID).name("Void Dust").build();
        this.item(ItemRegistration.ESSENCE_DUST_HALLOWED).name("Hallowed Dust").build();
        this.item(ItemRegistration.ESSENCE_SHARD_EARTH).name("Earth Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_SEA).name("Sea Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_SKY).name("Sky Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_SUN).name("Sun Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_MOON).name("Moon Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_BLOOD).name("Blood Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_INFERNAL).name("Infernal Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_VOID).name("Void Shard").build();
        this.item(ItemRegistration.ESSENCE_SHARD_HALLOWED).name("Hallowed Shard").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_EARTH).name("Earth Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_SEA).name("Sea Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_SKY).name("Sky Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_SUN).name("Sun Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_MOON).name("Moon Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_BLOOD).name("Blood Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_INFERNAL).name("Infernal Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_VOID).name("Void Crystal").build();
        this.item(ItemRegistration.ESSENCE_CRYSTAL_HALLOWED).name("Hallowed Crystal").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_EARTH).name("Earth Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_SEA).name("Sea Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_SKY).name("Sky Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_SUN).name("Sun Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_MOON).name("Moon Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_BLOOD).name("Blood Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_INFERNAL).name("Infernal Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_VOID).name("Void Cluster").build();
        this.item(ItemRegistration.ESSENCE_CLUSTER_HALLOWED).name("Hallowed Cluster").build();
        this.item(ItemRegistration.ALCHEMICAL_WASTE).name("Alchemical Waste").build();
        this.item(ItemRegistration.BLOODY_FLESH).name("Bloody Flesh").tooltip("A dark hunger comes over you", "as you look at this...").build();
        this.item(ItemRegistration.HALLOWED_ORB).name("Hallowed Orb").tooltip("A sense of peace washes over", "you as you hold this").build();
        this.item(ItemRegistration.HEARTWOOD).name("Heartwood").build();
        this.item(ItemRegistration.ENCHANTED_INK).name("Enchanted Ink").build();
        this.item(ItemRegistration.ENCHANTED_INK_AND_QUILL).name("Enchanted Ink and Quill").build();
        this.item(ItemRegistration.ROCK_SALT).name("Rock Salt").build();
        this.item(ItemRegistration.REFINED_SALT).name("Refined Salt").build();
        this.item(ItemRegistration.SALTED_BAKED_POTATO).name("Salted Baked Potato").build();
        this.item(ItemRegistration.SALTED_COOKED_BEEF).name("Salted Steak").build();
        this.item(ItemRegistration.SALTED_COOKED_CHICKEN).name("Salted Cooked Chicken").build();
        this.item(ItemRegistration.SALTED_COOKED_COD).name("Salted Cooked Cod").build();
        this.item(ItemRegistration.SALTED_COOKED_MUTTON).name("Salted Cooked Mutton").build();
        this.item(ItemRegistration.SALTED_COOKED_PORKCHOP).name("Salted Cooked Porkchop").build();
        this.item(ItemRegistration.SALTED_COOKED_RABBIT).name("Salted Cooked Rabbit").build();
        this.item(ItemRegistration.SALTED_COOKED_SALMON).name("Salted Cooked Salmon").build();
        this.item(ItemRegistration.SALTED_BEETROOT_SOUP).name("Salted Beetroot Soup").build();
        this.item(ItemRegistration.SALTED_MUSHROOM_STEW).name("Salted Mushroom Stew").build();
        this.item(ItemRegistration.SALTED_RABBIT_STEW).name("Salted Rabbit Stew").build();
        this.item(ItemRegistration.EARTHSHATTER_HAMMER).name("Earthshatter Hammer").build();
        this.item(ItemRegistration.IRON_GRIT).name("Iron Grit").build();
        this.item(ItemRegistration.GOLD_GRIT).name("Gold Grit").build();
        this.item(ItemRegistration.COPPER_GRIT).name("Copper Grit").build();
        this.item(ItemRegistration.PRIMALITE_INGOT).name("Primalite Ingot").build();
        this.item(ItemRegistration.HEXIUM_INGOT).name("Hexium Ingot").build();
        this.item(ItemRegistration.HALLOWSTEEL_INGOT).name("Hallowsteel Ingot").build();
        this.item(ItemRegistration.PRIMALITE_NUGGET).name("Primalite Nugget").build();
        this.item(ItemRegistration.HEXIUM_NUGGET).name("Hexium Nugget").build();
        this.item(ItemRegistration.HALLOWSTEEL_NUGGET).name("Hallowsteel Nugget").build();
        this.item(ItemRegistration.QUARTZ_NUGGET).name("Quartz Sliver").build();
        this.item(ItemRegistration.MANA_PRISM).name("Mana Prism").build();
        this.item(ItemRegistration.TALLOW).name("Alchemical Tallow").build();
        this.item(ItemRegistration.BEESWAX).name("Beeswax").build();
        this.item(ItemRegistration.MANA_SALTS).name("Mana Salts").build();
        this.item(ItemRegistration.MANAFRUIT).name("Manafruit").build();
        this.item(ItemRegistration.INCENSE_STICK).name("Incense Stick").build();
        this.item(ItemRegistration.SOUL_GEM).name("Soul Gem").build();
        this.item(ItemRegistration.SOUL_GEM_SLIVER).name("Soul Gem Sliver").build();
        this.item(ItemRegistration.SPELLCLOTH).name("Spellcloth").build();
        this.item(ItemRegistration.HEXWEAVE).name("Hexweave").build();
        this.item(ItemRegistration.SAINTSWOOL).name("Saintswool").build();
        this.item(ItemRegistration.RUNE_UNATTUNED).name("Unattuned Source Rune").build();
        this.item(ItemRegistration.RUNE_EARTH).name("Earth Rune").tooltip("\"Teq\"").build();
        this.item(ItemRegistration.RUNE_SEA).name("Sea Rune").tooltip("\"Ald\"").build();
        this.item(ItemRegistration.RUNE_SKY).name("Sky Rune").tooltip("\"Der\"").build();
        this.item(ItemRegistration.RUNE_SUN).name("Sun Rune").tooltip("\"Sid\"").build();
        this.item(ItemRegistration.RUNE_MOON).name("Moon Rune").tooltip("\"Lun\"").build();
        this.item(ItemRegistration.RUNE_BLOOD).name("Blood Rune").tooltip("\"Hem\"").build();
        this.item(ItemRegistration.RUNE_INFERNAL).name("Infernal Rune").tooltip("\"Cey\"").build();
        this.item(ItemRegistration.RUNE_VOID).name("Void Rune").tooltip("\"Zir\"").build();
        this.item(ItemRegistration.RUNE_HALLOWED).name("Hallowed Rune").tooltip("\"Phal\"").build();
        this.item(ItemRegistration.RUNE_ABSORB).name("Absorb Rune").tooltip("\"Kath\"").build();
        this.item(ItemRegistration.RUNE_DISPEL).name("Dispel Rune").tooltip("\"Neth\"").build();
        this.item(ItemRegistration.RUNE_PROJECT).name("Project Rune").tooltip("\"Bok\"").build();
        this.item(ItemRegistration.RUNE_PROTECT).name("Protect Rune").tooltip("\"Kor\"").build();
        this.item(ItemRegistration.RUNE_SUMMON).name("Summon Rune").tooltip("\"Tir\"").build();
        this.item(ItemRegistration.RUNE_AREA).name("Area Rune").tooltip("\"Rem\"").build();
        this.item(ItemRegistration.RUNE_CREATURE).name("Creature Rune").tooltip("\"Tak\"").build();
        this.item(ItemRegistration.RUNE_ITEM).name("Item Rune").tooltip("\"Mag\"").build();
        this.item(ItemRegistration.RUNE_SELF).name("Self Rune").tooltip("\"San\"").build();
        this.item(ItemRegistration.RUNE_INSIGHT).name("Insight Rune").tooltip("\"Nif\"").build();
        this.item(ItemRegistration.RUNE_POWER).name("Power Rune").tooltip("\"Par\"").build();
        this.item(ItemRegistration.RUNE_GRACE).name("Grace Rune").tooltip("\"Fyr\"").build();
        this.item(ItemRegistration.IMBUED_WOOL_HEAD).name("Apprentice's Hood").build();
        this.item(ItemRegistration.IMBUED_WOOL_CHEST).name("Apprentice's Robes").build();
        this.item(ItemRegistration.IMBUED_WOOL_LEGS).name("Apprentice's Leggings").build();
        this.item(ItemRegistration.IMBUED_WOOL_FEET).name("Apprentice's Slippers").build();
        this.item(ItemRegistration.SPELLCLOTH_HEAD).name("Adept's Hood").build();
        this.item(ItemRegistration.SPELLCLOTH_CHEST).name("Adept's Robes").build();
        this.item(ItemRegistration.SPELLCLOTH_LEGS).name("Adept's Leggings").build();
        this.item(ItemRegistration.SPELLCLOTH_FEET).name("Adept's Slippers").build();
        this.item(ItemRegistration.HEXWEAVE_HEAD).name("Wizard's Hood").build();
        this.item(ItemRegistration.HEXWEAVE_CHEST).name("Wizard's Robes").build();
        this.item(ItemRegistration.HEXWEAVE_LEGS).name("Wizard's Leggings").build();
        this.item(ItemRegistration.HEXWEAVE_FEET).name("Wizard's Slippers").build();
        this.item(ItemRegistration.SAINTSWOOL_HEAD).name("Archmage's Hood").build();
        this.item(ItemRegistration.SAINTSWOOL_CHEST).name("Archmage's Robes").build();
        this.item(ItemRegistration.SAINTSWOOL_LEGS).name("Archmage's Leggings").build();
        this.item(ItemRegistration.SAINTSWOOL_FEET).name("Archmage's Slippers").build();
        this.item(ItemRegistration.PRIMALITE_SWORD).name("Primalite Sword").build();
        this.item(ItemRegistration.PRIMALITE_TRIDENT).name("Primalite Trident").build();
        this.item(ItemRegistration.PRIMALITE_BOW).name("Primalite Bow").build();
        this.item(ItemRegistration.PRIMALITE_SHOVEL).name("Primalite Shovel").build();
        this.item(ItemRegistration.PRIMALITE_PICKAXE).name("Primalite Pickaxe").build();
        this.item(ItemRegistration.PRIMALITE_AXE).name("Primalite Axe").build();
        this.item(ItemRegistration.PRIMALITE_HOE).name("Primalite Hoe").build();
        this.item(ItemRegistration.PRIMALITE_FISHING_ROD).name("Primalite Fishing Rod").build();
        this.item(ItemRegistration.PRIMALITE_HEAD).name("Primalite Helmet").build();
        this.item(ItemRegistration.PRIMALITE_CHEST).name("Primalite Chestplate").build();
        this.item(ItemRegistration.PRIMALITE_LEGS).name("Primalite Greaves").build();
        this.item(ItemRegistration.PRIMALITE_FEET).name("Primalite Boots").build();
        this.item(ItemRegistration.PRIMALITE_SHIELD).name("Primalite Shield")
            ...
            .build();
        this.item(ItemRegistration.HEXIUM_SWORD).name("Hexium Sword").build();
        this.item(ItemRegistration.HEXIUM_TRIDENT).name("Hexium Trident").build();
        this.item(ItemRegistration.HEXIUM_BOW).name("Hexium Bow").build();
        this.item(ItemRegistration.HEXIUM_SHOVEL).name("Hexium Shovel").build();
        this.item(ItemRegistration.HEXIUM_PICKAXE).name("Hexium Pickaxe").build();
        this.item(ItemRegistration.HEXIUM_AXE).name("Hexium Axe").build();
        this.item(ItemRegistration.HEXIUM_HOE).name("Hexium Hoe").build();
        this.item(ItemRegistration.HEXIUM_FISHING_ROD).name("Hexium Fishing Rod").build();
        this.item(ItemRegistration.HEXIUM_HEAD).name("Hexium Helmet").build();
        this.item(ItemRegistration.HEXIUM_CHEST).name("Hexium Chestplate").build();
        this.item(ItemRegistration.HEXIUM_LEGS).name("Hexium Greaves").build();
        this.item(ItemRegistration.HEXIUM_FEET).name("Hexium Boots").build();
        this.item(ItemRegistration.HEXIUM_SHIELD).name("Hexium Shield")
            ...
            .build();
        this.item(ItemRegistration.HALLOWSTEEL_SWORD).name("Hallowsteel Sword").build();
        this.item(ItemRegistration.HALLOWSTEEL_TRIDENT).name("Hallowsteel Trident").build();
        this.item(ItemRegistration.HALLOWSTEEL_BOW).name("Hallowsteel Bow").build();
        this.item(ItemRegistration.HALLOWSTEEL_SHOVEL).name("Hallowsteel Shovel").build();
        this.item(ItemRegistration.HALLOWSTEEL_PICKAXE).name("Hallowsteel Pickaxe").build();
        this.item(ItemRegistration.HALLOWSTEEL_AXE).name("Hallowsteel Axe").build();
        this.item(ItemRegistration.HALLOWSTEEL_HOE).name("Hallowsteel Hoe").build();
        this.item(ItemRegistration.HALLOWSTEEL_FISHING_ROD).name("Hallowsteel Fishing Rod").build();
        this.item(ItemRegistration.HALLOWSTEEL_HEAD).name("Hallowsteel Helmet").build();
        this.item(ItemRegistration.HALLOWSTEEL_CHEST).name("Hallowsteel Chestplate").build();
        this.item(ItemRegistration.HALLOWSTEEL_LEGS).name("Hallowsteel Greaves").build();
        this.item(ItemRegistration.HALLOWSTEEL_FEET).name("Hallowsteel Boots").build();
        this.item(ItemRegistration.HALLOWSTEEL_SHIELD).name("Hallowsteel Shield")
            ...
            .build();
        this.item(ItemRegistration.MAGITECH_PARTS_BASIC).name("Basic Magitech Parts").build();
        this.item(ItemRegistration.MAGITECH_PARTS_ENCHANTED).name("Enchanted Magitech Parts").build();
        this.item(ItemRegistration.MAGITECH_PARTS_FORBIDDEN).name("Forbidden Magitech Parts").build();
        this.item(ItemRegistration.MAGITECH_PARTS_HEAVENLY).name("Heavenly Magitech Parts").build();
        this.item(ItemRegistration.SEASCRIBE_PEN).name("Seascribe Pen").build();
        this.item(ItemRegistration.BASIC_EARTH_AMBROSIA).name("Earth Ambrosia").build();
        this.item(ItemRegistration.BASIC_SEA_AMBROSIA).name("Sea Ambrosia").build();
        this.item(ItemRegistration.BASIC_SKY_AMBROSIA).name("Sky Ambrosia").build();
        this.item(ItemRegistration.BASIC_SUN_AMBROSIA).name("Sun Ambrosia").build();
        this.item(ItemRegistration.BASIC_MOON_AMBROSIA).name("Moon Ambrosia").build();
        this.item(ItemRegistration.BASIC_BLOOD_AMBROSIA).name("Blood Ambrosia").build();
        this.item(ItemRegistration.BASIC_INFERNAL_AMBROSIA).name("Infernal Ambrosia").build();
        this.item(ItemRegistration.BASIC_VOID_AMBROSIA).name("Void Ambrosia").build();
        this.item(ItemRegistration.BASIC_HALLOWED_AMBROSIA).name("Hallowed Ambrosia").build();
        this.item(ItemRegistration.GREATER_EARTH_AMBROSIA).name("Greater Earth Ambrosia").build();
        this.item(ItemRegistration.GREATER_SEA_AMBROSIA).name("Greater Sea Ambrosia").build();
        this.item(ItemRegistration.GREATER_SKY_AMBROSIA).name("Greater Sky Ambrosia").build();
        this.item(ItemRegistration.GREATER_SUN_AMBROSIA).name("Greater Sun Ambrosia").build();
        this.item(ItemRegistration.GREATER_MOON_AMBROSIA).name("Greater Moon Ambrosia").build();
        this.item(ItemRegistration.GREATER_BLOOD_AMBROSIA).name("Greater Blood Ambrosia").build();
        this.item(ItemRegistration.GREATER_INFERNAL_AMBROSIA).name("Greater Infernal Ambrosia").build();
        this.item(ItemRegistration.GREATER_VOID_AMBROSIA).name("Greater Void Ambrosia").build();
        this.item(ItemRegistration.GREATER_HALLOWED_AMBROSIA).name("Greater Hallowed Ambrosia").build();
        this.item(ItemRegistration.SUPREME_EARTH_AMBROSIA).name("Supreme Earth Ambrosia").build();
        this.item(ItemRegistration.SUPREME_SEA_AMBROSIA).name("Supreme Sea Ambrosia").build();
        this.item(ItemRegistration.SUPREME_SKY_AMBROSIA).name("Supreme Sky Ambrosia").build();
        this.item(ItemRegistration.SUPREME_SUN_AMBROSIA).name("Supreme Sun Ambrosia").build();
        this.item(ItemRegistration.SUPREME_MOON_AMBROSIA).name("Supreme Moon Ambrosia").build();
        this.item(ItemRegistration.SUPREME_BLOOD_AMBROSIA).name("Supreme Blood Ambrosia").build();
        this.item(ItemRegistration.SUPREME_INFERNAL_AMBROSIA).name("Supreme Infernal Ambrosia").build();
        this.item(ItemRegistration.SUPREME_VOID_AMBROSIA).name("Supreme Void Ambrosia").build();
        this.item(ItemRegistration.SUPREME_HALLOWED_AMBROSIA).name("Supreme Hallowed Ambrosia").build();
        this.item(ItemRegistration.FLYING_CARPET).name("Flying Carpet").build();
        this.item(ItemRegistration.SPELL_SCROLL_BLANK).name("Blank Spell Scroll").build();
        this.item(ItemRegistration.SPELL_SCROLL_FILLED).name("Scroll of %1$s").build();
        this.item(ItemRegistration.MUNDANE_WAND).name("Mundane Wand").build();
        this.item(ItemRegistration.MODULAR_WAND).name("%1$s %2$s %3$s Wand").build();
        this.item(ItemRegistration.MODULAR_STAFF).name("%1$s %2$s %3$s Staff").build();
        this.item(ItemRegistration.HEARTWOOD_WAND_CORE_ITEM).name("Heartwood Wand Core").build();
        this.item(ItemRegistration.OBSIDIAN_WAND_CORE_ITEM).name("Obsidian Wand Core").build();
        this.item(ItemRegistration.CORAL_WAND_CORE_ITEM).name("Coral Wand Core").build();
        this.item(ItemRegistration.BAMBOO_WAND_CORE_ITEM).name("Bamboo Wand Core").build();
        this.item(ItemRegistration.SUNWOOD_WAND_CORE_ITEM).name("Sunwood Wand Core").build();
        this.item(ItemRegistration.MOONWOOD_WAND_CORE_ITEM).name("Moonwood Wand Core").build();
        this.item(ItemRegistration.BONE_WAND_CORE_ITEM).name("Bone Wand Core").build();
        this.item(ItemRegistration.BLAZE_ROD_WAND_CORE_ITEM).name("Blaze Rod Wand Core").build();
        this.item(ItemRegistration.PURPUR_WAND_CORE_ITEM).name("Purpur Wand Core").build();
        this.item(ItemRegistration.PRIMAL_WAND_CORE_ITEM).name("Primal Wand Core").build();
        this.item(ItemRegistration.DARK_PRIMAL_WAND_CORE_ITEM).name("Dark Primal Wand Core").build();
        this.item(ItemRegistration.PURE_PRIMAL_WAND_CORE_ITEM).name("Pure Primal Wand Core").build();
        this.item(ItemRegistration.IRON_WAND_CAP_ITEM).name("Iron Wand Cap").build();
        this.item(ItemRegistration.GOLD_WAND_CAP_ITEM).name("Gold Wand Cap").build();
        this.item(ItemRegistration.PRIMALITE_WAND_CAP_ITEM).name("Primalite Wand Cap").build();
        this.item(ItemRegistration.HEXIUM_WAND_CAP_ITEM).name("Hexium Wand Cap").build();
        this.item(ItemRegistration.HALLOWSTEEL_WAND_CAP_ITEM).name("Hallowsteel Wand Cap").build();
        this.item(ItemRegistration.APPRENTICE_WAND_GEM_ITEM).name("Apprentice's Wand Gem").build();
        this.item(ItemRegistration.ADEPT_WAND_GEM_ITEM).name("Adept's Wand Gem").build();
        this.item(ItemRegistration.WIZARD_WAND_GEM_ITEM).name("Wizard's Wand Gem").build();
        this.item(ItemRegistration.ARCHMAGE_WAND_GEM_ITEM).name("Archmage's Wand Gem").build();
        this.item(ItemRegistration.CREATIVE_WAND_GEM_ITEM).name("Creative Wand Gem").build();
        this.item(ItemRegistration.HEARTWOOD_STAFF_CORE_ITEM).name("Heartwood Staff Core").build();
        this.item(ItemRegistration.OBSIDIAN_STAFF_CORE_ITEM).name("Obsidian Staff Core").build();
        this.item(ItemRegistration.CORAL_STAFF_CORE_ITEM).name("Coral Staff Core").build();
        this.item(ItemRegistration.BAMBOO_STAFF_CORE_ITEM).name("Bamboo Staff Core").build();
        this.item(ItemRegistration.SUNWOOD_STAFF_CORE_ITEM).name("Sunwood Staff Core").build();
        this.item(ItemRegistration.MOONWOOD_STAFF_CORE_ITEM).name("Moonwood Staff Core").build();
        this.item(ItemRegistration.BONE_STAFF_CORE_ITEM).name("Bone Staff Core").build();
        this.item(ItemRegistration.BLAZE_ROD_STAFF_CORE_ITEM).name("Blaze Rod Staff Core").build();
        this.item(ItemRegistration.PURPUR_STAFF_CORE_ITEM).name("Purpur Staff Core").build();
        this.item(ItemRegistration.PRIMAL_STAFF_CORE_ITEM).name("Primal Staff Core").build();
        this.item(ItemRegistration.DARK_PRIMAL_STAFF_CORE_ITEM).name("Dark Primal Staff Core").build();
        this.item(ItemRegistration.PURE_PRIMAL_STAFF_CORE_ITEM).name("Pure Primal Staff Core").build();
        this.item(ItemRegistration.TREEFOLK_SPAWN_EGG).name("Treefolk Spawn Egg").build();
        this.item(ItemRegistration.PRIMALITE_GOLEM_SPAWN_EGG).name("Primalite Golem Spawn Egg").build();
        this.item(ItemRegistration.HEXIUM_GOLEM_SPAWN_EGG).name("Hexium Golem Spawn Egg").build();
        this.item(ItemRegistration.HALLOWSTEEL_GOLEM_SPAWN_EGG).name("Hallowsteel Golem Spawn Egg").build();
        this.item(ItemRegistration.BASIC_EARTH_PIXIE).name("Earth Pixie").build();
        this.item(ItemRegistration.GRAND_EARTH_PIXIE).name("Grand Earth Pixie").build();
        this.item(ItemRegistration.MAJESTIC_EARTH_PIXIE).name("Majestic Earth Pixie").build();
        this.item(ItemRegistration.BASIC_SEA_PIXIE).name("Sea Pixie").build();
        this.item(ItemRegistration.GRAND_SEA_PIXIE).name("Grand Sea Pixie").build();
        this.item(ItemRegistration.MAJESTIC_SEA_PIXIE).name("Majestic Sea Pixie").build();
        this.item(ItemRegistration.BASIC_SKY_PIXIE).name("Sky Pixie").build();
        this.item(ItemRegistration.GRAND_SKY_PIXIE).name("Grand Sky Pixie").build();
        this.item(ItemRegistration.MAJESTIC_SKY_PIXIE).name("Majestic Sky Pixie").build();
        this.item(ItemRegistration.BASIC_SUN_PIXIE).name("Sun Pixie").build();
        this.item(ItemRegistration.GRAND_SUN_PIXIE).name("Grand Sun Pixie").build();
        this.item(ItemRegistration.MAJESTIC_SUN_PIXIE).name("Majestic Sun Pixie").build();
        this.item(ItemRegistration.BASIC_MOON_PIXIE).name("Moon Pixie").build();
        this.item(ItemRegistration.GRAND_MOON_PIXIE).name("Grand Moon Pixie").build();
        this.item(ItemRegistration.MAJESTIC_MOON_PIXIE).name("Majestic Moon Pixie").build();
        this.item(ItemRegistration.BASIC_BLOOD_PIXIE).name("Blood Pixie").build();
        this.item(ItemRegistration.GRAND_BLOOD_PIXIE).name("Grand Blood Pixie").build();
        this.item(ItemRegistration.MAJESTIC_BLOOD_PIXIE).name("Majestic Blood Pixie").build();
        this.item(ItemRegistration.BASIC_INFERNAL_PIXIE).name("Infernal Pixie").build();
        this.item(ItemRegistration.GRAND_INFERNAL_PIXIE).name("Grand Infernal Pixie").build();
        this.item(ItemRegistration.MAJESTIC_INFERNAL_PIXIE).name("Majestic Infernal Pixie").build();
        this.item(ItemRegistration.BASIC_VOID_PIXIE).name("Void Pixie").build();
        this.item(ItemRegistration.GRAND_VOID_PIXIE).name("Grand Void Pixie").build();
        this.item(ItemRegistration.MAJESTIC_VOID_PIXIE).name("Majestic Void Pixie").build();
        this.item(ItemRegistration.BASIC_HALLOWED_PIXIE).name("Hallowed Pixie").build();
        this.item(ItemRegistration.GRAND_HALLOWED_PIXIE).name("Grand Hallowed Pixie").build();
        this.item(ItemRegistration.MAJESTIC_HALLOWED_PIXIE).name("Majestic Hallowed Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_EARTH_PIXIE).name("Drained Earth Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_EARTH_PIXIE).name("Drained Grand Earth Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_EARTH_PIXIE).name("Drained Majestic Earth Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_SEA_PIXIE).name("Drained Sea Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_SEA_PIXIE).name("Drained Grand Sea Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_SEA_PIXIE).name("Drained Majestic Sea Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_SKY_PIXIE).name("Drained Sky Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_SKY_PIXIE).name("Drained Grand Sky Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_SKY_PIXIE).name("Drained Majestic Sky Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_SUN_PIXIE).name("Drained Sun Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_SUN_PIXIE).name("Drained Grand Sun Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_SUN_PIXIE).name("Drained Majestic Sun Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_MOON_PIXIE).name("Drained Moon Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_MOON_PIXIE).name("Drained Grand Moon Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_MOON_PIXIE).name("Drained Majestic Moon Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_BLOOD_PIXIE).name("Drained Blood Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_BLOOD_PIXIE).name("Drained Grand Blood Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_BLOOD_PIXIE).name("Drained Majestic Blood Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_INFERNAL_PIXIE).name("Drained Infernal Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_INFERNAL_PIXIE).name("Drained Grand Infernal Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_INFERNAL_PIXIE).name("Drained Majestic Infernal Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_VOID_PIXIE).name("Drained Void Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_VOID_PIXIE).name("Drained Grand Void Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_VOID_PIXIE).name("Drained Majestic Void Pixie").build();
        this.item(ItemRegistration.DRAINED_BASIC_HALLOWED_PIXIE).name("Drained Hallowed Pixie").build();
        this.item(ItemRegistration.DRAINED_GRAND_HALLOWED_PIXIE).name("Drained Grand Hallowed Pixie").build();
        this.item(ItemRegistration.DRAINED_MAJESTIC_HALLOWED_PIXIE).name("Drained Majestic Hallowed Pixie").build();
        this.item(ItemRegistration.SANGUINE_CORE_BLANK).name("Blank Sanguine Core").build();
        this.item(ItemRegistration.SANGUINE_CORE_ALLAY).name("Sanguine Core: Allay").build();
        this.item(ItemRegistration.SANGUINE_CORE_ARMADILLO).name("Sanguine Core: Armadillo").build();
        this.item(ItemRegistration.SANGUINE_CORE_AXOLOTL).name("Sanguine Core: Axolotl").build();
        this.item(ItemRegistration.SANGUINE_CORE_BAT).name("Sanguine Core: Bat").build();
        this.item(ItemRegistration.SANGUINE_CORE_BEE).name("Sanguine Core: Bee").build();
        this.item(ItemRegistration.SANGUINE_CORE_BLAZE).name("Sanguine Core: Blaze").build();
        this.item(ItemRegistration.SANGUINE_CORE_BOGGED).name("Sanguine Core: Bogged").build();
        this.item(ItemRegistration.SANGUINE_CORE_BREEZE).name("Sanguine Core: Breeze").build();
        this.item(ItemRegistration.SANGUINE_CORE_CAMEL).name("Sanguine Core: Camel").build();
        this.item(ItemRegistration.SANGUINE_CORE_CAT).name("Sanguine Core: Cat").build();
        this.item(ItemRegistration.SANGUINE_CORE_CAVE_SPIDER).name("Sanguine Core: Cave Spider").build();
        this.item(ItemRegistration.SANGUINE_CORE_CHICKEN).name("Sanguine Core: Chicken").build();
        this.item(ItemRegistration.SANGUINE_CORE_COD).name("Sanguine Core: Cod").build();
        this.item(ItemRegistration.SANGUINE_CORE_COW).name("Sanguine Core: Cow").build();
        this.item(ItemRegistration.SANGUINE_CORE_CREEPER).name("Sanguine Core: Creeper").build();
        this.item(ItemRegistration.SANGUINE_CORE_DOLPHIN).name("Sanguine Core: Dolphin").build();
        this.item(ItemRegistration.SANGUINE_CORE_DONKEY).name("Sanguine Core: Donkey").build();
        this.item(ItemRegistration.SANGUINE_CORE_DROWNED).name("Sanguine Core: Drowned").build();
        this.item(ItemRegistration.SANGUINE_CORE_ELDER_GUARDIAN).name("Sanguine Core: Elder Guardian").build();
        this.item(ItemRegistration.SANGUINE_CORE_ENDERMAN).name("Sanguine Core: Enderman").build();
        this.item(ItemRegistration.SANGUINE_CORE_ENDERMITE).name("Sanguine Core: Endermite").build();
        this.item(ItemRegistration.SANGUINE_CORE_EVOKER).name("Sanguine Core: Evoker").build();
        this.item(ItemRegistration.SANGUINE_CORE_FOX).name("Sanguine Core: Fox").build();
        this.item(ItemRegistration.SANGUINE_CORE_FROG).name("Sanguine Core: Frog").build();
        this.item(ItemRegistration.SANGUINE_CORE_GHAST).name("Sanguine Core: Ghast").build();
        this.item(ItemRegistration.SANGUINE_CORE_GLOW_SQUID).name("Sanguine Core: Glow Squid").build();
        this.item(ItemRegistration.SANGUINE_CORE_GOAT).name("Sanguine Core: Goat").build();
        this.item(ItemRegistration.SANGUINE_CORE_GUARDIAN).name("Sanguine Core: Guardian").build();
        this.item(ItemRegistration.SANGUINE_CORE_HOGLIN).name("Sanguine Core: Hoglin").build();
        this.item(ItemRegistration.SANGUINE_CORE_HORSE).name("Sanguine Core: Horse").build();
        this.item(ItemRegistration.SANGUINE_CORE_HUSK).name("Sanguine Core: Husk").build();
        this.item(ItemRegistration.SANGUINE_CORE_LLAMA).name("Sanguine Core: Llama").build();
        this.item(ItemRegistration.SANGUINE_CORE_MAGMA_CUBE).name("Sanguine Core: Magma Cube").build();
        this.item(ItemRegistration.SANGUINE_CORE_MOOSHROOM).name("Sanguine Core: Mooshroom").build();
        this.item(ItemRegistration.SANGUINE_CORE_OCELOT).name("Sanguine Core: Ocelot").build();
        this.item(ItemRegistration.SANGUINE_CORE_PANDA).name("Sanguine Core: Panda").build();
        this.item(ItemRegistration.SANGUINE_CORE_PARROT).name("Sanguine Core: Parrot").build();
        this.item(ItemRegistration.SANGUINE_CORE_PHANTOM).name("Sanguine Core: Phantom").build();
        this.item(ItemRegistration.SANGUINE_CORE_PIG).name("Sanguine Core: Pig").build();
        this.item(ItemRegistration.SANGUINE_CORE_PIGLIN).name("Sanguine Core: Piglin").build();
        this.item(ItemRegistration.SANGUINE_CORE_PIGLIN_BRUTE).name("Sanguine Core: Piglin Brute").build();
        this.item(ItemRegistration.SANGUINE_CORE_PILLAGER).name("Sanguine Core: Pillager").build();
        this.item(ItemRegistration.SANGUINE_CORE_POLAR_BEAR).name("Sanguine Core: Polar Bear").build();
        this.item(ItemRegistration.SANGUINE_CORE_PUFFERFISH).name("Sanguine Core: Pufferfish").build();
        this.item(ItemRegistration.SANGUINE_CORE_RABBIT).name("Sanguine Core: Rabbit").build();
        this.item(ItemRegistration.SANGUINE_CORE_RAVAGER).name("Sanguine Core: Ravager").build();
        this.item(ItemRegistration.SANGUINE_CORE_SALMON).name("Sanguine Core: Salmon").build();
        this.item(ItemRegistration.SANGUINE_CORE_SHEEP).name("Sanguine Core: Sheep").build();
        this.item(ItemRegistration.SANGUINE_CORE_SHULKER).name("Sanguine Core: Shulker").build();
        this.item(ItemRegistration.SANGUINE_CORE_SILVERFISH).name("Sanguine Core: Silverfish").build();
        this.item(ItemRegistration.SANGUINE_CORE_SKELETON).name("Sanguine Core: Skeleton").build();
        this.item(ItemRegistration.SANGUINE_CORE_SKELETON_HORSE).name("Sanguine Core: Skeleton Horse").build();
        this.item(ItemRegistration.SANGUINE_CORE_SLIME).name("Sanguine Core: Slime").build();
        this.item(ItemRegistration.SANGUINE_CORE_SNIFFER).name("Sanguine Core: Sniffer").build();
        this.item(ItemRegistration.SANGUINE_CORE_SPIDER).name("Sanguine Core: Spider").build();
        this.item(ItemRegistration.SANGUINE_CORE_SQUID).name("Sanguine Core: Squid").build();
        this.item(ItemRegistration.SANGUINE_CORE_STRAY).name("Sanguine Core: Stray").build();
        this.item(ItemRegistration.SANGUINE_CORE_STRIDER).name("Sanguine Core: Strider").build();
        this.item(ItemRegistration.SANGUINE_CORE_TROPICAL_FISH).name("Sanguine Core: Tropical Fish").build();
        this.item(ItemRegistration.SANGUINE_CORE_TURTLE).name("Sanguine Core: Turtle").build();
        this.item(ItemRegistration.SANGUINE_CORE_VEX).name("Sanguine Core: Vex").build();
        this.item(ItemRegistration.SANGUINE_CORE_VILLAGER).name("Sanguine Core: Villager").build();
        this.item(ItemRegistration.SANGUINE_CORE_VINDICATOR).name("Sanguine Core: Vindicator").build();
        this.item(ItemRegistration.SANGUINE_CORE_WITCH).name("Sanguine Core: Witch").build();
        this.item(ItemRegistration.SANGUINE_CORE_WITHER_SKELETON).name("Sanguine Core: Wither Skeleton").build();
        this.item(ItemRegistration.SANGUINE_CORE_WOLF).name("Sanguine Core: Wolf").build();
        this.item(ItemRegistration.SANGUINE_CORE_ZOGLIN).name("Sanguine Core: Zoglin").build();
        this.item(ItemRegistration.SANGUINE_CORE_ZOMBIE).name("Sanguine Core: Zombie").build();
        this.item(ItemRegistration.SANGUINE_CORE_ZOMBIE_HORSE).name("Sanguine Core: Zombie Horse").build();
        this.item(ItemRegistration.SANGUINE_CORE_ZOMBIE_VILLAGER).name("Sanguine Core: Zombie Villager").build();
        this.item(ItemRegistration.SANGUINE_CORE_ZOMBIFIED_PIGLIN).name("Sanguine Core: Zombified Piglin").build();
        this.item(ItemRegistration.SANGUINE_CORE_TREEFOLK).name("Sanguine Core: Treefolk").build();
        this.item(ItemRegistration.SANGUINE_CORE_INNER_DEMON).name("Sanguine Core: Inner Demon").build();
        this.item(ItemRegistration.SKYGLASS_FLASK).name("Skyglass Flask").build();
        this.item(ItemRegistration.CONCOCTION)
            ...
            .build();
        this.item(ItemRegistration.BOMB_CASING).name("Bomb Casing").build();
        this.item(ItemRegistration.ALCHEMICAL_BOMB)
            ...
            .build();
        this.item(ItemRegistration.PRIMAL_SHOVEL).name("Shovel of the Quaking Earth").build();
        this.item(ItemRegistration.PRIMAL_FISHING_ROD).name("Fishing Rod of the Bountiful Sea").build();
        this.item(ItemRegistration.PRIMAL_AXE).name("Axe of the Lightning Crash").build();
        this.item(ItemRegistration.PRIMAL_HOE).name("Hoe of the Nurturing Sun").build();
        this.item(ItemRegistration.PRIMAL_PICKAXE).name("Pickaxe of the Crescent Moon").build();
        this.item(ItemRegistration.FORBIDDEN_TRIDENT).name("Trident of Gaping Wounds").build();
        this.item(ItemRegistration.FORBIDDEN_BOW).name("Bow of Screaming Souls").build();
        this.item(ItemRegistration.FORBIDDEN_SWORD).name("Sword of the Hungering Void").build();
        this.item(ItemRegistration.SACRED_SHIELD).name("Shield of the Sacred Oath").build();
        this.item(ItemRegistration.MANA_ARROW_EARTH).name("Earth-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_SEA).name("Sea-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_SKY).name("Sky-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_SUN).name("Sun-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_MOON).name("Moon-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_BLOOD).name("Blood-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_INFERNAL).name("Infernal-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_VOID).name("Void-Tinged Arrow").build();
        this.item(ItemRegistration.MANA_ARROW_HALLOWED).name("Hallowed-Tinged Arrow").build();
        this.item(ItemRegistration.DREAM_VISION_TALISMAN).name("Dream Vision Talisman").build();
        this.item(ItemRegistration.OBSERVATION_NOTES).name("Field Research Report").tooltip("Use to gain an arcane observation").build();
        this.item(ItemRegistration.THEORY_NOTES).name("Arcane Thesis").tooltip("Use to gain an arcane theory").build();
        this.item(ItemRegistration.MYSTICAL_RELIC).name("Mystical Relic").tooltip("Use to gain an arcane theory, or keep to trade").build();
        this.item(ItemRegistration.MYSTICAL_RELIC_FRAGMENT).name("Mystical Relic Fragment").build();
        this.item(ItemRegistration.BLOOD_NOTES).name("Blood-Scrawled Ravings").tooltip("Dare you decipher it?").build();
        this.item(ItemRegistration.IGNYX).name("Ignyx").build();
        this.item(ItemRegistration.DOWSING_ROD).name("Dowsing Rod").build();
        this.item(ItemRegistration.FOUR_LEAF_CLOVER).name("Four-Leaf Clover").build();
        this.item(ItemRegistration.SHEEP_TOME).name("Tome of Polymorph: Sheep").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_UNATTUNED).name("Humming Artifact").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_EARTH).name("Earth-Attuned Artifact").tooltip("Use to gain a point of permanent Earth attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_SEA).name("Sea-Attuned Artifact").tooltip("Use to gain a point of permanent Sea attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_SKY).name("Sky-Attuned Artifact").tooltip("Use to gain a point of permanent Sky attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_SUN).name("Sun-Attuned Artifact").tooltip("Use to gain a point of permanent Sun attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_MOON).name("Moon-Attuned Artifact").tooltip("Use to gain a point of permanent Moon attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_BLOOD).name("Blood-Attuned Artifact").tooltip("Use to gain a point of permanent Blood attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_INFERNAL).name("Infernal-Attuned Artifact").tooltip("Use to gain a point of permanent Infernal attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_VOID).name("Void-Attuned Artifact").tooltip("Use to gain a point of permanent Void attunement").build();
        this.item(ItemRegistration.HUMMING_ARTIFACT_HALLOWED).name("Hallowed-Attuned Artifact").tooltip("Use to gain a point of permanent Hallowed attunement").build();
        this.item(ItemRegistration.RECALL_STONE).name("Recall Stone").build();
        this.item(ItemRegistration.TREEFOLK_SEED).name("Treefolk Seed").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_EARTH).name("Earth Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_SEA).name("Sea Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_SKY).name("Sky Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_SUN).name("Sun Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_MOON).name("Moon Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_BLOOD).name("Blood Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_INFERNAL).name("Infernal Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_VOID).name("Void Attunement Shackles").build();
        this.item(ItemRegistration.ATTUNEMENT_SHACKLES_HALLOWED).name("Hallowed Attunement Shackles").build();
        this.item(ItemRegistration.BASIC_WARDING_MODULE).name("Warding Module").build();
        this.item(ItemRegistration.GREATER_WARDING_MODULE).name("Greater Warding Module").build();
        this.item(ItemRegistration.SUPREME_WARDING_MODULE).name("Supreme Warding Module").build();
        this.item(ItemRegistration.STATIC_BOOK).name("Any Book").build();
        this.item(ItemRegistration.STATIC_TABLET).name("Any Tablet").build();
        this.item(ItemRegistration.LORE_TABLET_FRAGMENT).name("Ancient Tablet Fragment").build();
        this.item(ItemRegistration.LORE_TABLET_DIRTY).name("Dirt-Caked Ancient Tablet").tooltip("Use to clean off the dirt and reveal the writing beneath").build();
        this.item(ItemRegistration.HYDROMELON_SEEDS).name("Hydromelon Seeds").build();
        this.item(ItemRegistration.HYDROMELON_SLICE).name("Hydromelon Slice").build();
        this.item(ItemRegistration.BLOOD_ROSE).name("Blood Rose Bush").build();
        this.item(ItemRegistration.EMBERFLOWER).name("Emberflower").build();
        this.item(ItemRegistration.TICK_STICK).name("Tick Stick").build();
        this.item(ItemRegistration.ENERGIZED_AMETHYST).name("Energized Amethyst Shard").build();
        this.item(ItemRegistration.ENERGIZED_DIAMOND).name("Energized Diamond").build();
        this.item(ItemRegistration.ENERGIZED_EMERALD).name("Energized Emerald").build();
        this.item(ItemRegistration.ENERGIZED_QUARTZ).name("Energized Quartz").build();
        this.item(ItemRegistration.RUNIC_ARMOR_TRIM_SMITHING_TEMPLATE).name("Smithing Template").build();
