 ...
 * @author Daedalus4096
 */
public class ArcaneWorkbenchScreenOld extends AbstractContainerScreenPM<ArcaneWorkbenchMenu> implements ArcaneRecipeUpdateListener {
    ...
    public ArcaneWorkbenchScreenOld(ArcaneWorkbenchMenu screenMenu, Inventory inv, Component titleIn) {
