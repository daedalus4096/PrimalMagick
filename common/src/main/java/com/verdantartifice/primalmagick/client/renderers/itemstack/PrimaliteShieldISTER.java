...
public class PrimaliteShieldISTER extends AbstractTieredShieldISTER {
    public static final Identifier TEXTURE_SHIELD_BASE = ResourceUtils.loc("entity/shield/primalite_shield_base");
    public static final Identifier TEXTURE_SHIELD_NO_PATTERN = ResourceUtils.loc("entity/shield/primalite_shield_base_nopattern");
