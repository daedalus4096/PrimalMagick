...
/**
 * Definition of a 3D model of the core of an apprentice-grade mana orb.
 *
 * @author Daedalus4096
 */
public class ManaOrbApprenticeModel extends Model<Unit> {
	// Made with Blockbench 4.12.4
	// Exported for Minecraft version 1.17 or later with Mojang mappings

	public ManaOrbApprenticeModel(ModelPart root) {
