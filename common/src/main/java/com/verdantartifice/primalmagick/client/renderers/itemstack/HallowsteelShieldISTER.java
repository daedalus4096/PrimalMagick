...
public class HallowsteelShieldISTER extends AbstractTieredShieldISTER {
    public static final ResourceLocation TEXTURE_SHIELD_BASE = ResourceUtils.loc("entity/shield/hallowsteel_shield_base");
    public static final ResourceLocation TEXTURE_SHIELD_NO_PATTERN = ResourceUtils.loc("entity/shield/hallowsteel_shield_base_nopattern");
