...
/**
 * Block definition for moonwood logs.  They are decorative blocks that fade out of existence during the day.
 * 
 * @author Daedalus4096
 */
public class MoonwoodLogBlock extends AbstractPhasingLogBlock implements IMoonwoodBlock {
