...
public class WandAssemblyTableMenu extends AbstractContainerMenu {
    public static final Identifier CAP_SLOT_TEXTURE = ResourceUtils.loc("item/empty_wand_cap_slot");
    public static final Identifier CORE_SLOT_TEXTURE = ResourceUtils.loc("item/empty_wand_core_slot");
    public static final Identifier GEM_SLOT_TEXTURE = ResourceUtils.loc("item/empty_wand_gem_slot");
    ...
    public WandAssemblyTableMenu(int windowId, Inventory inv, ContainerLevelAccess callable) {
        ...
        // Slot 1: Wand core
        this.coreSlot = this.addSlot(Services.MENU.makeFilteredSlot(componentInvWrapper, 0, 48, 35,
        ...
        // Slot 2: Wand gem
        this.gemSlot = this.addSlot(Services.MENU.makeFilteredSlot(componentInvWrapper, 1, 48, 17,
    ...
    protected static Slot makeCapSlot(IItemHandlerPM inventoryIn, int index, int xPosition, int yPosition) {
        return Services.MENU.makeFilteredSlot(inventoryIn, index, xPosition, yPosition, 
