...
public class ProjectTemplates {
    ...
    public static void bootstrap(BootstrapContext<ProjectTemplate> context) {
        ...
        context.register(ADVANCED_ENCHANTING_STUDIES, ProjectTemplate.builder().rewardMultiplier(0.5D)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).quantity(2).consumed().weight(5).build())
        ...
        context.register(ADVANCED_RUNEWORK, ProjectTemplate.builder().rewardMultiplier(0.5D)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).quantity(2).consumed().weight(3).build())
        ...
        context.register(ADVANCED_WAND_TINKERING, ProjectTemplate.builder().rewardMultiplier(0.5D).requiredResearch(ResearchEntries.MASTER_MANAWEAVING)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.BONES).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.RODS_BLAZE).consumed().weight(1).build())
        ...
        context.register(BREWING_EXPERIMENTS, ProjectTemplate.builder().rewardMultiplier(0.5D).requiredResearch(ResearchEntries.DISCOVER_INFERNAL)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_NETHER_WART).consumed().weight(3).build())
                .material(ItemProjectMaterial.builder(Items.FERMENTED_SPIDER_EYE).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.DUSTS_GLOWSTONE).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.DUSTS_REDSTONE).consumed().weight(1).build())
        ...
        context.register(CONDUIT_FORCES, ProjectTemplate.builder().aid(Blocks.CONDUIT).materialCountOverride(1).baseSuccessChanceOverride(0.5D).rewardMultiplier(0.5D)
                .weightFunction(new ConstantWeight(5))
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_PRISMARINE).consumed().weight(1).build())
                .build());
        context.register(DRACONIC_ENERGIES, ProjectTemplate.builder().aid(Blocks.DRAGON_EGG).materialCountOverride(1).baseSuccessChanceOverride(0.5D).rewardMultiplier(1.0D)
                .weightFunction(new ConstantWeight(5))
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.ENDER_PEARLS).consumed().weight(1).build())
                .build());
        ...
        context.register(ENCHANTING_STUDIES, ProjectTemplate.builder().requiredResearch(ResearchEntries.BASIC_MANAWEAVING)
                ...
                .material(ItemTagProjectMaterial.builder(ItemTagsPM.ENCHANTING_TABLES).weight(5).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).consumed().weight(5).build())
        ...
        context.register(MASTER_ENCHANTING_STUDIES, ProjectTemplate.builder().rewardMultiplier(1D)
                ...
                .weightFunction(new ConstantWeight(5))
                .material(ItemTagProjectMaterial.builder(ItemTagsPM.ENCHANTING_TABLES).weight(5).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).quantity(3).consumed().weight(5).build())
        ...
        context.register(MASTER_RUNEWORK, ProjectTemplate.builder().rewardMultiplier(1D).requiredResearch(ResearchEntries.RUNE_HALLOWED)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).quantity(4).consumed().weight(3).build())
                .material(ItemProjectMaterial.builder(Items.DIAMOND_SWORD).weight(1).build())
        ...
        context.register(PIGLIN_BARTER, ProjectTemplate.builder().requiredResearch(ResearchEntries.DISCOVER_INFERNAL).rewardMultiplier(1D)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.STORAGE_BLOCKS_GOLD).consumed().bonusReward(0.5D).weight(0.5D).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.INGOTS_GOLD).consumed().weight(5).build())
        ...
        context.register(PROSPEROUS_TRADE, ProjectTemplate.builder().rewardMultiplier(0.5D).requiredResearch(ResearchEntries.DISCOVER_INFERNAL)
                .weightFunction(ProgressiveWeight.builder(5).modifier(ResearchEntries.DISCOVER_VOID, -2).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_EMERALD).quantity(2).consumed().bonusReward(0.5D).weight(2).build())
                .material(ItemProjectMaterial.builder(Items.LAVA_BUCKET).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_DIAMOND).consumed().bonusReward(0.25D).weight(3).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.INGOTS_GOLD).consumed().weight(1).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.FEATHERS).quantity(3).consumed().weight(1).build())
        ...
        context.register(RAIDING_THE_RAIDERS, ProjectTemplate.builder().rewardMultiplier(0.5D)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_EMERALD).consumed().bonusReward(0.25D).weight(1).build())
                .build());
        ...
        context.register(REDSTONE_TINKERING, ProjectTemplate.builder().requiredResearch(ResearchEntries.BASIC_MAGITECH)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.DUSTS_REDSTONE).quantity(4).consumed().weight(3).build())
                .material(ObservationProjectMaterial.builder(1).consumed().weight(5).build())
                .build());
        context.register(RICH_TRADE, ProjectTemplate.builder().rewardMultiplier(1D).requiredResearch(ResearchEntries.DISCOVER_VOID)
                .weightFunction(new ConstantWeight(5))
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_EMERALD).quantity(4).consumed().bonusReward(1D).weight(2).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_NETHER_WART).quantity(4).consumed().weight(1).build())
                .material(ItemProjectMaterial.builder(Items.GOLDEN_CARROT).consumed().weight(1).build())
                .material(ItemProjectMaterial.builder(Items.GLISTERING_MELON_SLICE).consumed().weight(1).build())
                .material(ItemProjectMaterial.builder(Items.PUFFERFISH).consumed().weight(1).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_QUARTZ).quantity(2).consumed().weight(1).build())
        ...
        context.register(RUNEWORK, ProjectTemplate.builder()
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_LAPIS).consumed().weight(3).build())
                .material(ItemProjectMaterial.builder(Items.DIAMOND_SWORD).weight(1).build())
        ...
        context.register(TRADE, ProjectTemplate.builder()
                .weightFunction(ProgressiveWeight.builder(5).modifier(ResearchEntries.DISCOVER_INFERNAL, -2).modifier(ResearchEntries.DISCOVER_VOID, -2).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_EMERALD).consumed().bonusReward(0.25D).weight(2).build())
                .material(ItemProjectMaterial.builder(Items.COAL, 2).consumed().weight(3).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.INGOTS_IRON).consumed().weight(3).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GLASS_PANES).quantity(2).consumed().weight(1).build())
                .material(ItemProjectMaterial.builder(Items.ROTTEN_FLESH, 4).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_WHEAT).quantity(3).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_POTATO).quantity(3).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_CARROT).quantity(3).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.CROPS_BEETROOT).quantity(3).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.STRINGS).quantity(3).consumed().weight(2).build())
                .material(ItemProjectMaterial.builder(Items.COD, 2).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.RODS_WOODEN).quantity(4).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.LEATHERS).consumed().weight(1).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.DYES).quantity(2).consumed().weight(1).build())
        ...
        context.register(WAND_TINKERING, ProjectTemplate.builder().requiredResearch(ResearchEntries.BASIC_MANAWEAVING)
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.OBSIDIANS).consumed().weight(1).build())
                ...
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.INGOTS_IRON).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.INGOTS_GOLD).consumed().weight(1).build())
                .material(ItemTagProjectMaterial.builder(CommonTags.Items.GEMS_DIAMOND).consumed().weight(1).build())
