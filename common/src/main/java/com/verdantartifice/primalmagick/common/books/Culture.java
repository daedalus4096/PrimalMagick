 ...
 * @author Daedalus4096
 */
public record Culture(Identifier cultureId, ResourceKey<LootTable> shelfLootTable, ResourceKey<LootTable> welcomeLootTable, ResourceKey<LootTable> hiddenLootTable, BlockState accentBlockState) {
    public static final Codec<Culture> DIRECT_CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Identifier.CODEC.fieldOf("languageId").forGetter(Culture::cultureId),
