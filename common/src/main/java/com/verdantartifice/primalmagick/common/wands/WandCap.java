...
public class WandCap implements IWandComponent {
    ...
    public static final WandCap IRON = new WandCap("iron", Rarity.COMMON, 0.1D, 100);
    public static final WandCap GOLD = new WandCap("gold", Rarity.COMMON, 0.2D, 200);
    public static final WandCap PRIMALITE = new WandCap("primalite", Rarity.UNCOMMON, 0.25D, 400);
    public static final WandCap HEXIUM = new WandCap("hexium", Rarity.RARE, 0.3D, 800);
    public static final WandCap HALLOWSTEEL = new WandCap("hallowsteel", Rarity.EPIC, 0.35D, 1600);
