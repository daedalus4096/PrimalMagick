...
public class BasicGuardianPixieEntity extends AbstractGuardianPixieEntity implements IBasicPixie {
    ...
    public static BasicGuardianPixieEntity spawn(Source source, PixieHouseEntity home, ServerLevel level, BlockPos pos) {
        return AbstractGuardianPixieEntity.spawn(EntityTypesPM.BASIC_GUARDIAN_PIXIE.get(), source, home, level, pos);
    }
}
