...
public class ItemsPM {
    ...
    public static final RegistryObject<BlockItem> MARBLE_RAW = registerSupplier("marble_raw", () -> new BlockItem(BlockRegistration.MARBLE_RAW.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SLAB = registerSupplier("marble_slab", () -> new BlockItem(BlockRegistration.MARBLE_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_STAIRS = registerSupplier("marble_stairs", () -> new BlockItem(BlockRegistration.MARBLE_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_WALL = registerSupplier("marble_wall", () -> new BlockItem(BlockRegistration.MARBLE_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICKS = registerSupplier("marble_bricks", () -> new BlockItem(BlockRegistration.MARBLE_BRICKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_SLAB = registerSupplier("marble_brick_slab", () -> new BlockItem(BlockRegistration.MARBLE_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_STAIRS = registerSupplier("marble_brick_stairs", () -> new BlockItem(BlockRegistration.MARBLE_BRICK_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BRICK_WALL = registerSupplier("marble_brick_wall", () -> new BlockItem(BlockRegistration.MARBLE_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_PILLAR = registerSupplier("marble_pillar", () -> new BlockItem(BlockRegistration.MARBLE_PILLAR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_CHISELED = registerSupplier("marble_chiseled", () -> new BlockItem(BlockRegistration.MARBLE_CHISELED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_RUNED = registerSupplier("marble_runed", () -> new BlockItem(BlockRegistration.MARBLE_RUNED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_TILES = registerSupplier("marble_tiles", () -> new BlockItem(BlockRegistration.MARBLE_TILES.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_BOOKSHELF = registerSupplier("marble_bookshelf", () -> new BlockItem(BlockRegistration.MARBLE_BOOKSHELF.get(), new Item.Properties()));

    // Register enchanted marble block items
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED = registerSupplier("marble_enchanted", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_SLAB = registerSupplier("marble_enchanted_slab", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_STAIRS = registerSupplier("marble_enchanted_stairs", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_WALL = registerSupplier("marble_enchanted_wall", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICKS = registerSupplier("marble_enchanted_bricks", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_BRICKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_SLAB = registerSupplier("marble_enchanted_brick_slab", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_STAIRS = registerSupplier("marble_enchanted_brick_stairs", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_BRICK_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BRICK_WALL = registerSupplier("marble_enchanted_brick_wall", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_PILLAR = registerSupplier("marble_enchanted_pillar", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_PILLAR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_CHISELED = registerSupplier("marble_enchanted_chiseled", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_CHISELED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_RUNED = registerSupplier("marble_enchanted_runed", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_RUNED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_ENCHANTED_BOOKSHELF = registerSupplier("marble_enchanted_bookshelf", () -> new BlockItem(BlockRegistration.MARBLE_ENCHANTED_BOOKSHELF.get(), new Item.Properties()));

    // Register smoked marble block items
    public static final RegistryObject<BlockItem> MARBLE_SMOKED = registerSupplier("marble_smoked", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_SLAB = registerSupplier("marble_smoked_slab", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_STAIRS = registerSupplier("marble_smoked_stairs", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_WALL = registerSupplier("marble_smoked_wall", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICKS = registerSupplier("marble_smoked_bricks", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_BRICKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_SLAB = registerSupplier("marble_smoked_brick_slab", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_STAIRS = registerSupplier("marble_smoked_brick_stairs", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_BRICK_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BRICK_WALL = registerSupplier("marble_smoked_brick_wall", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_PILLAR = registerSupplier("marble_smoked_pillar", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_PILLAR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_CHISELED = registerSupplier("marble_smoked_chiseled", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_CHISELED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_RUNED = registerSupplier("marble_smoked_runed", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_RUNED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_SMOKED_BOOKSHELF = registerSupplier("marble_smoked_bookshelf", () -> new BlockItem(BlockRegistration.MARBLE_SMOKED_BOOKSHELF.get(), new Item.Properties()));

    // Register hallowed marble block items
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED = registerSupplier("marble_hallowed", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_SLAB = registerSupplier("marble_hallowed_slab", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_STAIRS = registerSupplier("marble_hallowed_stairs", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_WALL = registerSupplier("marble_hallowed_wall", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICKS = registerSupplier("marble_hallowed_bricks", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_BRICKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_SLAB = registerSupplier("marble_hallowed_brick_slab", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_BRICK_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_STAIRS = registerSupplier("marble_hallowed_brick_stairs", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_BRICK_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BRICK_WALL = registerSupplier("marble_hallowed_brick_wall", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_BRICK_WALL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_PILLAR = registerSupplier("marble_hallowed_pillar", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_PILLAR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_CHISELED = registerSupplier("marble_hallowed_chiseled", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_CHISELED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_RUNED = registerSupplier("marble_hallowed_runed", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_RUNED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MARBLE_HALLOWED_BOOKSHELF = registerSupplier("marble_hallowed_bookshelf", () -> new BlockItem(BlockRegistration.MARBLE_HALLOWED_BOOKSHELF.get(), new Item.Properties()));

    // Register sunwood block items
    public static final RegistryObject<BlockItem> SUNWOOD_LOG = registerSupplier("sunwood_log", () -> new BlockItem(BlockRegistration.SUNWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_SUNWOOD_LOG = registerSupplier("stripped_sunwood_log", () -> new BlockItem(BlockRegistration.STRIPPED_SUNWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_WOOD = registerSupplier("sunwood_wood", () -> new BlockItem(BlockRegistration.SUNWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_SUNWOOD_WOOD = registerSupplier("stripped_sunwood_wood", () -> new BlockItem(BlockRegistration.STRIPPED_SUNWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_LEAVES = registerSupplier("sunwood_leaves", () -> new BlockItem(BlockRegistration.SUNWOOD_LEAVES.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_SAPLING = registerSupplier("sunwood_sapling", () -> new BlockItem(BlockRegistration.SUNWOOD_SAPLING.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_PLANKS = registerSupplier("sunwood_planks", () -> new BlockItem(BlockRegistration.SUNWOOD_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_SLAB = registerSupplier("sunwood_slab", () -> new BlockItem(BlockRegistration.SUNWOOD_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNWOOD_STAIRS = registerSupplier("sunwood_stairs", () -> new BlockItem(BlockRegistration.SUNWOOD_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> SUNWOOD_PILLAR = registerSupplier("sunwood_pillar", () -> new BurnableBlockItem(BlockRegistration.SUNWOOD_PILLAR.get(), 300, new Item.Properties()));

    // Register moonwood block items
    public static final RegistryObject<BlockItem> MOONWOOD_LOG = registerSupplier("moonwood_log", () -> new BlockItem(BlockRegistration.MOONWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_MOONWOOD_LOG = registerSupplier("stripped_moonwood_log", () -> new BlockItem(BlockRegistration.STRIPPED_MOONWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_WOOD = registerSupplier("moonwood_wood", () -> new BlockItem(BlockRegistration.MOONWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_MOONWOOD_WOOD = registerSupplier("stripped_moonwood_wood", () -> new BlockItem(BlockRegistration.STRIPPED_MOONWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_LEAVES = registerSupplier("moonwood_leaves", () -> new BlockItem(BlockRegistration.MOONWOOD_LEAVES.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_SAPLING = registerSupplier("moonwood_sapling", () -> new BlockItem(BlockRegistration.MOONWOOD_SAPLING.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_PLANKS = registerSupplier("moonwood_planks", () -> new BlockItem(BlockRegistration.MOONWOOD_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_SLAB = registerSupplier("moonwood_slab", () -> new BlockItem(BlockRegistration.MOONWOOD_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MOONWOOD_STAIRS = registerSupplier("moonwood_stairs", () -> new BlockItem(BlockRegistration.MOONWOOD_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> MOONWOOD_PILLAR = registerSupplier("moonwood_pillar", () -> new BurnableBlockItem(BlockRegistration.MOONWOOD_PILLAR.get(), 300, new Item.Properties()));
    
    // Register hallowood block items
    public static final RegistryObject<BlockItem> HALLOWOOD_LOG = registerSupplier("hallowood_log", () -> new BlockItem(BlockRegistration.HALLOWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_HALLOWOOD_LOG = registerSupplier("stripped_hallowood_log", () -> new BlockItem(BlockRegistration.STRIPPED_HALLOWOOD_LOG.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_WOOD = registerSupplier("hallowood_wood", () -> new BlockItem(BlockRegistration.HALLOWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STRIPPED_HALLOWOOD_WOOD = registerSupplier("stripped_hallowood_wood", () -> new BlockItem(BlockRegistration.STRIPPED_HALLOWOOD_WOOD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_LEAVES = registerSupplier("hallowood_leaves", () -> new BlockItem(BlockRegistration.HALLOWOOD_LEAVES.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_SAPLING = registerSupplier("hallowood_sapling", () -> new BlockItem(BlockRegistration.HALLOWOOD_SAPLING.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_PLANKS = registerSupplier("hallowood_planks", () -> new BlockItem(BlockRegistration.HALLOWOOD_PLANKS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_SLAB = registerSupplier("hallowood_slab", () -> new BlockItem(BlockRegistration.HALLOWOOD_SLAB.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWOOD_STAIRS = registerSupplier("hallowood_stairs", () -> new BlockItem(BlockRegistration.HALLOWOOD_STAIRS.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> HALLOWOOD_PILLAR = registerSupplier("hallowood_pillar", () -> new BurnableBlockItem(BlockRegistration.HALLOWOOD_PILLAR.get(), 300, new Item.Properties()));
    
    // Register crop items
    public static final RegistryObject<Item> HYDROMELON_SEEDS = registerSupplier("hydromelon_seeds", () -> new ItemNameBlockItem(BlockRegistration.HYRDOMELON_STEM.get(), new Item.Properties()));
    public static final RegistryObject<Item> HYDROMELON = registerSupplier("hydromelon", () -> new BlockItem(BlockRegistration.HYDROMELON.get(), new Item.Properties()));
    ...
    public static final RegistryObject<DoubleHighBlockItem> BLOOD_ROSE = registerSupplier("blood_rose", () -> new DoubleHighBlockItem(BlockRegistration.BLOOD_ROSE.get(), new Item.Properties()));
    public static final RegistryObject<DoubleHighBlockItem> EMBERFLOWER = registerSupplier("emberflower", () -> new DoubleHighBlockItem(BlockRegistration.EMBERFLOWER.get(), new Item.Properties()));

    // Register infused stone block items
    public static final RegistryObject<BlockItem> INFUSED_STONE_EARTH = registerSupplier("infused_stone_earth", () -> new BlockItem(BlockRegistration.INFUSED_STONE_EARTH.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SEA = registerSupplier("infused_stone_sea", () -> new BlockItem(BlockRegistration.INFUSED_STONE_SEA.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SKY = registerSupplier("infused_stone_sky", () -> new BlockItem(BlockRegistration.INFUSED_STONE_SKY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_SUN = registerSupplier("infused_stone_sun", () -> new BlockItem(BlockRegistration.INFUSED_STONE_SUN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> INFUSED_STONE_MOON = registerSupplier("infused_stone_moon", () -> new BlockItem(BlockRegistration.INFUSED_STONE_MOON.get(), new Item.Properties()));
    
    // Register budding gem block items
    public static final RegistryObject<BlockItem> SYNTHETIC_AMETHYST_CLUSTER = registerSupplier("synthetic_amethyst_cluster", () -> new BlockItem(BlockRegistration.SYNTHETIC_AMETHYST_CLUSTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_AMETHYST_BUD = registerSupplier("large_synthetic_amethyst_bud", () -> new BlockItem(BlockRegistration.LARGE_SYNTHETIC_AMETHYST_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_AMETHYST_BUD = registerSupplier("medium_synthetic_amethyst_bud", () -> new BlockItem(BlockRegistration.MEDIUM_SYNTHETIC_AMETHYST_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_AMETHYST_BUD = registerSupplier("small_synthetic_amethyst_bud", () -> new BlockItem(BlockRegistration.SMALL_SYNTHETIC_AMETHYST_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_AMETHYST_BLOCK = registerSupplier("damaged_budding_amethyst_block", () -> new BlockItem(BlockRegistration.DAMAGED_BUDDING_AMETHYST_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_AMETHYST_BLOCK = registerSupplier("chipped_budding_amethyst_block", () -> new BlockItem(BlockRegistration.CHIPPED_BUDDING_AMETHYST_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_AMETHYST_BLOCK = registerSupplier("flawed_budding_amethyst_block", () -> new BlockItem(BlockRegistration.FLAWED_BUDDING_AMETHYST_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_DIAMOND_CLUSTER = registerSupplier("synthetic_diamond_cluster", () -> new BlockItem(BlockRegistration.SYNTHETIC_DIAMOND_CLUSTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_DIAMOND_BUD = registerSupplier("large_synthetic_diamond_bud", () -> new BlockItem(BlockRegistration.LARGE_SYNTHETIC_DIAMOND_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_DIAMOND_BUD = registerSupplier("medium_synthetic_diamond_bud", () -> new BlockItem(BlockRegistration.MEDIUM_SYNTHETIC_DIAMOND_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_DIAMOND_BUD = registerSupplier("small_synthetic_diamond_bud", () -> new BlockItem(BlockRegistration.SMALL_SYNTHETIC_DIAMOND_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_DIAMOND_BLOCK = registerSupplier("damaged_budding_diamond_block", () -> new BlockItem(BlockRegistration.DAMAGED_BUDDING_DIAMOND_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_DIAMOND_BLOCK = registerSupplier("chipped_budding_diamond_block", () -> new BlockItem(BlockRegistration.CHIPPED_BUDDING_DIAMOND_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_DIAMOND_BLOCK = registerSupplier("flawed_budding_diamond_block", () -> new BlockItem(BlockRegistration.FLAWED_BUDDING_DIAMOND_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_EMERALD_CLUSTER = registerSupplier("synthetic_emerald_cluster", () -> new BlockItem(BlockRegistration.SYNTHETIC_EMERALD_CLUSTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_EMERALD_BUD = registerSupplier("large_synthetic_emerald_bud", () -> new BlockItem(BlockRegistration.LARGE_SYNTHETIC_EMERALD_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_EMERALD_BUD = registerSupplier("medium_synthetic_emerald_bud", () -> new BlockItem(BlockRegistration.MEDIUM_SYNTHETIC_EMERALD_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_EMERALD_BUD = registerSupplier("small_synthetic_emerald_bud", () -> new BlockItem(BlockRegistration.SMALL_SYNTHETIC_EMERALD_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_EMERALD_BLOCK = registerSupplier("damaged_budding_emerald_block", () -> new BlockItem(BlockRegistration.DAMAGED_BUDDING_EMERALD_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_EMERALD_BLOCK = registerSupplier("chipped_budding_emerald_block", () -> new BlockItem(BlockRegistration.CHIPPED_BUDDING_EMERALD_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_EMERALD_BLOCK = registerSupplier("flawed_budding_emerald_block", () -> new BlockItem(BlockRegistration.FLAWED_BUDDING_EMERALD_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SYNTHETIC_QUARTZ_CLUSTER = registerSupplier("synthetic_quartz_cluster", () -> new BlockItem(BlockRegistration.SYNTHETIC_QUARTZ_CLUSTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> LARGE_SYNTHETIC_QUARTZ_BUD = registerSupplier("large_synthetic_quartz_bud", () -> new BlockItem(BlockRegistration.LARGE_SYNTHETIC_QUARTZ_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MEDIUM_SYNTHETIC_QUARTZ_BUD = registerSupplier("medium_synthetic_quartz_bud", () -> new BlockItem(BlockRegistration.MEDIUM_SYNTHETIC_QUARTZ_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SMALL_SYNTHETIC_QUARTZ_BUD = registerSupplier("small_synthetic_quartz_bud", () -> new BlockItem(BlockRegistration.SMALL_SYNTHETIC_QUARTZ_BUD.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> DAMAGED_BUDDING_QUARTZ_BLOCK = registerSupplier("damaged_budding_quartz_block", () -> new BlockItem(BlockRegistration.DAMAGED_BUDDING_QUARTZ_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CHIPPED_BUDDING_QUARTZ_BLOCK = registerSupplier("chipped_budding_quartz_block", () -> new BlockItem(BlockRegistration.CHIPPED_BUDDING_QUARTZ_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> FLAWED_BUDDING_QUARTZ_BLOCK = registerSupplier("flawed_budding_quartz_block", () -> new BlockItem(BlockRegistration.FLAWED_BUDDING_QUARTZ_BLOCK.get(), new Item.Properties()));

    // Register skyglass block items
    public static final RegistryObject<BlockItem> SKYGLASS = registerSupplier("skyglass", () -> new BlockItem(BlockRegistration.SKYGLASS.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BLACK = registerSupplier("stained_skyglass_black", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_BLACK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BLUE = registerSupplier("stained_skyglass_blue", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_BROWN = registerSupplier("stained_skyglass_brown", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_BROWN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_CYAN = registerSupplier("stained_skyglass_cyan", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_CYAN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_GRAY = registerSupplier("stained_skyglass_gray", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_GREEN = registerSupplier("stained_skyglass_green", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_GREEN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIGHT_BLUE = registerSupplier("stained_skyglass_light_blue", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_LIGHT_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIGHT_GRAY = registerSupplier("stained_skyglass_light_gray", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_LIGHT_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_LIME = registerSupplier("stained_skyglass_lime", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_LIME.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_MAGENTA = registerSupplier("stained_skyglass_magenta", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_MAGENTA.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_ORANGE = registerSupplier("stained_skyglass_orange", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_ORANGE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PINK = registerSupplier("stained_skyglass_pink", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PINK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PURPLE = registerSupplier("stained_skyglass_purple", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PURPLE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_RED = registerSupplier("stained_skyglass_red", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_RED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_WHITE = registerSupplier("stained_skyglass_white", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_WHITE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_YELLOW = registerSupplier("stained_skyglass_yellow", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_YELLOW.get(), new Item.Properties()));

    // Register skyglass pane block items
    public static final RegistryObject<BlockItem> SKYGLASS_PANE = registerSupplier("skyglass_pane", () -> new BlockItem(BlockRegistration.SKYGLASS_PANE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BLACK = registerSupplier("stained_skyglass_pane_black", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_BLACK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BLUE = registerSupplier("stained_skyglass_pane_blue", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_BROWN = registerSupplier("stained_skyglass_pane_brown", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_BROWN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_CYAN = registerSupplier("stained_skyglass_pane_cyan", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_CYAN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_GRAY = registerSupplier("stained_skyglass_pane_gray", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_GREEN = registerSupplier("stained_skyglass_pane_green", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_GREEN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIGHT_BLUE = registerSupplier("stained_skyglass_pane_light_blue", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_LIGHT_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIGHT_GRAY = registerSupplier("stained_skyglass_pane_light_gray", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_LIGHT_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_LIME = registerSupplier("stained_skyglass_pane_lime", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_LIME.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_MAGENTA = registerSupplier("stained_skyglass_pane_magenta", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_MAGENTA.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_ORANGE = registerSupplier("stained_skyglass_pane_orange", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_ORANGE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_PINK = registerSupplier("stained_skyglass_pane_pink", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_PINK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_PURPLE = registerSupplier("stained_skyglass_pane_purple", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_PURPLE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_RED = registerSupplier("stained_skyglass_pane_red", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_RED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_WHITE = registerSupplier("stained_skyglass_pane_white", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_WHITE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> STAINED_SKYGLASS_PANE_YELLOW = registerSupplier("stained_skyglass_pane_yellow", () -> new BlockItem(BlockRegistration.STAINED_SKYGLASS_PANE_YELLOW.get(), new Item.Properties()));

    // Register ritual candle block items
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BLACK = registerSupplier("ritual_candle_black", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_BLACK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BLUE = registerSupplier("ritual_candle_blue", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_BROWN = registerSupplier("ritual_candle_brown", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_BROWN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_CYAN = registerSupplier("ritual_candle_cyan", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_CYAN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_GRAY = registerSupplier("ritual_candle_gray", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_GREEN = registerSupplier("ritual_candle_green", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_GREEN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIGHT_BLUE = registerSupplier("ritual_candle_light_blue", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_LIGHT_BLUE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIGHT_GRAY = registerSupplier("ritual_candle_light_gray", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_LIGHT_GRAY.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_LIME = registerSupplier("ritual_candle_lime", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_LIME.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_MAGENTA = registerSupplier("ritual_candle_magenta", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_MAGENTA.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_ORANGE = registerSupplier("ritual_candle_orange", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_ORANGE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_PINK = registerSupplier("ritual_candle_pink", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_PINK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_PURPLE = registerSupplier("ritual_candle_purple", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_PURPLE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_RED = registerSupplier("ritual_candle_red", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_RED.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_WHITE = registerSupplier("ritual_candle_white", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_WHITE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_CANDLE_YELLOW = registerSupplier("ritual_candle_yellow", () -> new BlockItem(BlockRegistration.RITUAL_CANDLE_YELLOW.get(), new Item.Properties()));

    // Register mana font block items
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_EARTH = registerSupplier("ancient_font_earth", () -> new ManaFontBlockItem(BlockRegistration.ANCIENT_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SEA = registerSupplier("ancient_font_sea", () -> new ManaFontBlockItem(BlockRegistration.ANCIENT_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SKY = registerSupplier("ancient_font_sky", () -> new ManaFontBlockItem(BlockRegistration.ANCIENT_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_SUN = registerSupplier("ancient_font_sun", () -> new ManaFontBlockItem(BlockRegistration.ANCIENT_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ANCIENT_FONT_MOON = registerSupplier("ancient_font_moon", () -> new ManaFontBlockItem(BlockRegistration.ANCIENT_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_EARTH = registerSupplier("artificial_font_earth", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SEA = registerSupplier("artificial_font_sea", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SKY = registerSupplier("artificial_font_sky", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_SUN = registerSupplier("artificial_font_sun", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_MOON = registerSupplier("artificial_font_moon", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_BLOOD = registerSupplier("artificial_font_blood", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_INFERNAL = registerSupplier("artificial_font_infernal", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_VOID = registerSupplier("artificial_font_void", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> ARTIFICIAL_FONT_HALLOWED = registerSupplier("artificial_font_hallowed", () -> new ManaFontBlockItem(BlockRegistration.ARTIFICIAL_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_EARTH = registerSupplier("forbidden_font_earth", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SEA = registerSupplier("forbidden_font_sea", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SKY = registerSupplier("forbidden_font_sky", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_SUN = registerSupplier("forbidden_font_sun", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_MOON = registerSupplier("forbidden_font_moon", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_BLOOD = registerSupplier("forbidden_font_blood", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_INFERNAL = registerSupplier("forbidden_font_infernal", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_VOID = registerSupplier("forbidden_font_void", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> FORBIDDEN_FONT_HALLOWED = registerSupplier("forbidden_font_hallowed", () -> new ManaFontBlockItem(BlockRegistration.FORBIDDEN_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_EARTH = registerSupplier("heavenly_font_earth", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SEA = registerSupplier("heavenly_font_sea", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SKY = registerSupplier("heavenly_font_sky", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_SUN = registerSupplier("heavenly_font_sun", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_MOON = registerSupplier("heavenly_font_moon", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_BLOOD = registerSupplier("heavenly_font_blood", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_INFERNAL = registerSupplier("heavenly_font_infernal", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_VOID = registerSupplier("heavenly_font_void", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final RegistryObject<ManaFontBlockItem> HEAVENLY_FONT_HALLOWED = registerSupplier("heavenly_font_hallowed", () -> new ManaFontBlockItem(BlockRegistration.HEAVENLY_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    
    // Register device block items
    public static final RegistryObject<BurnableBlockItem> ARCANE_WORKBENCH = registerSupplier("arcane_workbench", () -> new BurnableBlockItem(BlockRegistration.ARCANE_WORKBENCH.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> WAND_ASSEMBLY_TABLE = registerSupplier("wand_assembly_table", () -> new BlockItem(BlockRegistration.WAND_ASSEMBLY_TABLE.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> WOOD_TABLE = registerSupplier("wood_table", () -> new BurnableBlockItem(BlockRegistration.WOOD_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> ANALYSIS_TABLE = registerSupplier("analysis_table", () -> new BurnableBlockItem(BlockRegistration.ANALYSIS_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> ESSENCE_FURNACE = registerSupplier("essence_furnace", () -> new BlockItem(BlockRegistration.ESSENCE_FURNACE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CALCINATOR_BASIC = registerSupplier("calcinator_basic", () -> new BlockItem(BlockRegistration.CALCINATOR_BASIC.get(), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> CALCINATOR_ENCHANTED = registerSupplier("calcinator_enchanted", () -> new BlockItem(BlockRegistration.CALCINATOR_ENCHANTED.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> CALCINATOR_FORBIDDEN = registerSupplier("calcinator_forbidden", () -> new BlockItem(BlockRegistration.CALCINATOR_FORBIDDEN.get(), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> CALCINATOR_HEAVENLY = registerSupplier("calcinator_heavenly", () -> new BlockItem(BlockRegistration.CALCINATOR_HEAVENLY.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> WAND_INSCRIPTION_TABLE = registerSupplier("wand_inscription_table", () -> new BurnableBlockItem(BlockRegistration.WAND_INSCRIPTION_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<SpellcraftingAltarBlockItem> SPELLCRAFTING_ALTAR = registerSupplier("spellcrafting_altar", () -> new SpellcraftingAltarBlockItem(BlockRegistration.SPELLCRAFTING_ALTAR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> WAND_CHARGER = registerSupplier("wand_charger", () -> new BlockItem(BlockRegistration.WAND_CHARGER.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> RESEARCH_TABLE = registerSupplier("research_table", () -> new BurnableBlockItem(BlockRegistration.RESEARCH_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> SUNLAMP = registerSupplier("sunlamp", () -> new BlockItem(BlockRegistration.SUNLAMP.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SPIRIT_LANTERN = registerSupplier("spirit_lantern", () -> new BlockItem(BlockRegistration.SPIRIT_LANTERN.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_ALTAR = registerSupplier("ritual_altar", () -> new BlockItem(BlockRegistration.RITUAL_ALTAR.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> OFFERING_PEDESTAL = registerSupplier("offering_pedestal", () -> new BlockItem(BlockRegistration.OFFERING_PEDESTAL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> INCENSE_BRAZIER = registerSupplier("incense_brazier", () -> new BlockItem(BlockRegistration.INCENSE_BRAZIER.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> RITUAL_LECTERN = registerSupplier("ritual_lectern", () -> new BurnableBlockItem(BlockRegistration.RITUAL_LECTERN.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> RITUAL_BELL = registerSupplier("ritual_bell", () -> new BlockItem(BlockRegistration.RITUAL_BELL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> BLOODLETTER = registerSupplier("bloodletter", () -> new BlockItem(BlockRegistration.BLOODLETTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> SOUL_ANVIL = registerSupplier("soul_anvil", () -> new BlockItem(BlockRegistration.SOUL_ANVIL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_BASIC = registerSupplier("runescribing_altar_basic", () -> new BlockItem(BlockRegistration.RUNESCRIBING_ALTAR_BASIC.get(), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_ENCHANTED = registerSupplier("runescribing_altar_enchanted", () -> new BlockItem(BlockRegistration.RUNESCRIBING_ALTAR_ENCHANTED.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_FORBIDDEN = registerSupplier("runescribing_altar_forbidden", () -> new BlockItem(BlockRegistration.RUNESCRIBING_ALTAR_FORBIDDEN.get(), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> RUNESCRIBING_ALTAR_HEAVENLY = registerSupplier("runescribing_altar_heavenly", () -> new BlockItem(BlockRegistration.RUNESCRIBING_ALTAR_HEAVENLY.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> RUNECARVING_TABLE = registerSupplier("runecarving_table", () -> new BurnableBlockItem(BlockRegistration.RUNECARVING_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> RUNIC_GRINDSTONE = registerSupplier("runic_grindstone", () -> new BlockItem(BlockRegistration.RUNIC_GRINDSTONE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HONEY_EXTRACTOR = registerSupplier("honey_extractor", () -> new BlockItem(BlockRegistration.HONEY_EXTRACTOR.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> PRIMALITE_GOLEM_CONTROLLER = registerSupplier("primalite_golem_controller", () -> new BlockItem(BlockRegistration.PRIMALITE_GOLEM_CONTROLLER.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BlockItem> HEXIUM_GOLEM_CONTROLLER = registerSupplier("hexium_golem_controller", () -> new BlockItem(BlockRegistration.HEXIUM_GOLEM_CONTROLLER.get(), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> HALLOWSTEEL_GOLEM_CONTROLLER = registerSupplier("hallowsteel_golem_controller", () -> new BlockItem(BlockRegistration.HALLOWSTEEL_GOLEM_CONTROLLER.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BlockItem> SANGUINE_CRUCIBLE = registerSupplier("sanguine_crucible", () -> new BlockItem(BlockRegistration.SANGUINE_CRUCIBLE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> CONCOCTER = registerSupplier("concocter", () -> new BlockItem(BlockRegistration.CONCOCTER.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> CELESTIAL_HARP = registerSupplier("celestial_harp", () -> new BurnableBlockItem(BlockRegistration.CELESTIAL_HARP.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> ENTROPY_SINK = registerSupplier("entropy_sink", () -> new BlockItem(BlockRegistration.ENTROPY_SINK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> AUTO_CHARGER = registerSupplier("auto_charger", () -> new BlockItem(BlockRegistration.AUTO_CHARGER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> ESSENCE_TRANSMUTER = registerSupplier("essence_transmuter", () -> new BlockItem(BlockRegistration.ESSENCE_TRANSMUTER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> DISSOLUTION_CHAMBER = registerSupplier("dissolution_chamber", () -> new BlockItem(BlockRegistration.DISSOLUTION_CHAMBER.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> ZEPHYR_ENGINE = registerSupplier("zephyr_engine", () -> new BlockItem(BlockRegistration.ZEPHYR_ENGINE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> VOID_TURBINE = registerSupplier("void_turbine", () -> new BlockItem(BlockRegistration.VOID_TURBINE.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_ENCHANTED = registerSupplier("essence_cask_enchanted", () -> new BurnableBlockItem(BlockRegistration.ESSENCE_CASK_ENCHANTED.get(), 300, new Item.Properties().rarity(Rarity.UNCOMMON)));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_FORBIDDEN = registerSupplier("essence_cask_forbidden", () -> new BurnableBlockItem(BlockRegistration.ESSENCE_CASK_FORBIDDEN.get(), 300, new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BurnableBlockItem> ESSENCE_CASK_HEAVENLY = registerSupplier("essence_cask_heavenly", () -> new BurnableBlockItem(BlockRegistration.ESSENCE_CASK_HEAVENLY.get(), 300, new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> WAND_GLAMOUR_TABLE = registerSupplier("wand_glamour_table", () -> new BurnableBlockItem(BlockRegistration.WAND_GLAMOUR_TABLE.get(), 300, new Item.Properties()));
    public static final RegistryObject<BlockItem> INFERNAL_FURNACE = registerSupplier("infernal_furnace", () -> new BlockItem(BlockRegistration.INFERNAL_FURNACE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> MANA_NEXUS = registerSupplier("mana_nexus", () -> new BlockItem(BlockRegistration.MANA_NEXUS.get(), new Item.Properties().rarity(Rarity.RARE)));
    public static final RegistryObject<BlockItem> MANA_SINGULARITY = registerSupplier("mana_singularity", () -> new BlockItem(BlockRegistration.MANA_SINGULARITY.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BlockItem> MANA_SINGULARITY_CREATIVE = registerSupplier("mana_singularity_creative", () -> new BlockItem(BlockRegistration.MANA_SINGULARITY_CREATIVE.get(), new Item.Properties().rarity(Rarity.EPIC)));
    public static final RegistryObject<BurnableBlockItem> SCRIBE_TABLE = registerSupplier("scribe_table", () -> new BurnableBlockItem(BlockRegistration.SCRIBE_TABLE.get(), 300, new Item.Properties()));

    // Register miscellaneous block items
    public static final RegistryObject<ItemNameBlockItem> REFINED_SALT = registerSupplier("refined_salt", () -> new ItemNameBlockItem(BlockRegistration.SALT_TRAIL.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> ROCK_SALT_ORE = registerSupplier("rock_salt_ore", () -> new BlockItem(BlockRegistration.ROCK_SALT_ORE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> QUARTZ_ORE = registerSupplier("quartz_ore", () -> new BlockItem(BlockRegistration.QUARTZ_ORE.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> PRIMALITE_BLOCK = registerSupplier("primalite_block", () -> new BlockItem(BlockRegistration.PRIMALITE_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HEXIUM_BLOCK = registerSupplier("hexium_block", () -> new BlockItem(BlockRegistration.HEXIUM_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> HALLOWSTEEL_BLOCK = registerSupplier("hallowsteel_block", () -> new BlockItem(BlockRegistration.HALLOWSTEEL_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<BurnableBlockItem> IGNYX_BLOCK = registerSupplier("ignyx_block", () -> new BurnableBlockItem(BlockRegistration.IGNYX_BLOCK.get(), 128000, new Item.Properties()));
    public static final RegistryObject<BlockItem> SALT_BLOCK = registerSupplier("salt_block", () -> new BlockItem(BlockRegistration.SALT_BLOCK.get(), new Item.Properties()));
    public static final RegistryObject<ItemNameBlockItem> TREEFOLK_SEED = registerSupplier("treefolk_seed", () -> new ItemNameBlockItem(BlockRegistration.TREEFOLK_SPROUT.get(), new Item.Properties()));
    public static final RegistryObject<BlockItem> ENDERWARD = registerSupplier("enderward", () -> new BlockItem(BlockRegistration.ENDERWARD.get(), new Item.Properties().stacksTo(16)));
    ...
    public static final RegistryObject<ResearchGainItem> SHEEP_TOME = registerSupplier("sheep_tome", () -> new ResearchGainItem(() -> new ResearchEntryKey(ResearchEntries.SPELL_PAYLOAD_POLYMORPH_SHEEP), new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<SanguineCoreItem> SANGUINE_CORE_ARMADILLO = registerSupplier("sanguine_core_armadillo", () -> new SanguineCoreItem(() -> EntityType.ARMADILLO, 2, new Item.Properties().rarity(Rarity.UNCOMMON).durability(31)));
    ...
    public static final RegistryObject<SanguineCoreItem> SANGUINE_CORE_BOGGED = registerSupplier("sanguine_core_bogged", () -> new SanguineCoreItem(() -> EntityType.BOGGED, 4, new Item.Properties().rarity(Rarity.UNCOMMON).durability(15)));
    public static final RegistryObject<SanguineCoreItem> SANGUINE_CORE_BREEZE = registerSupplier("sanguine_core_breeze", () -> new SanguineCoreItem(() -> EntityType.BREEZE, 4, new Item.Properties().rarity(Rarity.UNCOMMON).durability(15)));
