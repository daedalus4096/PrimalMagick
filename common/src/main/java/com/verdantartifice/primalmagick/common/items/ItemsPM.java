...
public class ItemsPM {
    ...
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_EARTH_PIXIE = registerWithoutTab("drained_pixie_grand_earth", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.EARTH, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_EARTH_PIXIE = registerWithoutTab("drained_pixie_majestic_earth", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.EARTH, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_SEA_PIXIE = registerWithoutTab("drained_pixie_basic_sea", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.SEA, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_SEA_PIXIE = registerWithoutTab("drained_pixie_grand_sea", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.SEA, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_SEA_PIXIE = registerWithoutTab("drained_pixie_majestic_sea", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.SEA, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_SKY_PIXIE = registerWithoutTab("drained_pixie_basic_sky", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.SKY, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_SKY_PIXIE = registerWithoutTab("drained_pixie_grand_sky", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.SKY, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_SKY_PIXIE = registerWithoutTab("drained_pixie_majestic_sky", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.SKY, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_SUN_PIXIE = registerWithoutTab("drained_pixie_basic_sun", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.SUN, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_SUN_PIXIE = registerWithoutTab("drained_pixie_grand_sun", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.SUN, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_SUN_PIXIE = registerWithoutTab("drained_pixie_majestic_sun", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.SUN, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_MOON_PIXIE = registerWithoutTab("drained_pixie_basic_moon", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.MOON, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_MOON_PIXIE = registerWithoutTab("drained_pixie_grand_moon", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.MOON, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_MOON_PIXIE = registerWithoutTab("drained_pixie_majestic_moon", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.MOON, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_BLOOD_PIXIE = registerWithoutTab("drained_pixie_basic_blood", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.BLOOD, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_BLOOD_PIXIE = registerWithoutTab("drained_pixie_grand_blood", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.BLOOD, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_BLOOD_PIXIE = registerWithoutTab("drained_pixie_majestic_blood", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.BLOOD, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_INFERNAL_PIXIE = registerWithoutTab("drained_pixie_basic_infernal", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.INFERNAL, new Item.Properties().stacksTo(16).fireResistant().rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_INFERNAL_PIXIE = registerWithoutTab("drained_pixie_grand_infernal", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.INFERNAL, new Item.Properties().stacksTo(16).fireResistant().rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_INFERNAL_PIXIE = registerWithoutTab("drained_pixie_majestic_infernal", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.INFERNAL, new Item.Properties().stacksTo(16).fireResistant().rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_VOID_PIXIE = registerWithoutTab("drained_pixie_basic_void", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.VOID, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_VOID_PIXIE = registerWithoutTab("drained_pixie_grand_void", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.VOID, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_VOID_PIXIE = registerWithoutTab("drained_pixie_majestic_void", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.VOID, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_BASIC_HALLOWED_PIXIE = registerWithoutTab("drained_pixie_basic_hallowed", () -> new DrainedPixieItem(PixieRank.BASIC, Sources.HALLOWED, new Item.Properties().stacksTo(16).rarity(Rarity.COMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_GRAND_HALLOWED_PIXIE = registerWithoutTab("drained_pixie_grand_hallowed", () -> new DrainedPixieItem(PixieRank.GRAND, Sources.HALLOWED, new Item.Properties().stacksTo(16).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, DrainedPixieItem> DRAINED_MAJESTIC_HALLOWED_PIXIE = registerWithoutTab("drained_pixie_majestic_hallowed", () -> new DrainedPixieItem(PixieRank.MAJESTIC, Sources.HALLOWED, new Item.Properties().stacksTo(16).rarity(Rarity.RARE)));
