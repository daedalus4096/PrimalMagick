...
public class ItemsPM {
    ...
    public static final IRegistryItem<Item, ManaFontBlockItem> ANCIENT_FONT_EARTH = registerSupplier("ancient_font_earth", () -> new ManaFontBlockItem(BlocksPM.ANCIENT_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ANCIENT_FONT_SEA = registerSupplier("ancient_font_sea", () -> new ManaFontBlockItem(BlocksPM.ANCIENT_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ANCIENT_FONT_SKY = registerSupplier("ancient_font_sky", () -> new ManaFontBlockItem(BlocksPM.ANCIENT_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ANCIENT_FONT_SUN = registerSupplier("ancient_font_sun", () -> new ManaFontBlockItem(BlocksPM.ANCIENT_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ANCIENT_FONT_MOON = registerSupplier("ancient_font_moon", () -> new ManaFontBlockItem(BlocksPM.ANCIENT_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_EARTH = registerSupplier("artificial_font_earth", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_SEA = registerSupplier("artificial_font_sea", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_SKY = registerSupplier("artificial_font_sky", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_SUN = registerSupplier("artificial_font_sun", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_MOON = registerSupplier("artificial_font_moon", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_BLOOD = registerSupplier("artificial_font_blood", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_INFERNAL = registerSupplier("artificial_font_infernal", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_VOID = registerSupplier("artificial_font_void", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> ARTIFICIAL_FONT_HALLOWED = registerSupplier("artificial_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.ARTIFICIAL_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_EARTH = registerSupplier("forbidden_font_earth", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_SEA = registerSupplier("forbidden_font_sea", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_SKY = registerSupplier("forbidden_font_sky", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_SUN = registerSupplier("forbidden_font_sun", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_MOON = registerSupplier("forbidden_font_moon", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_BLOOD = registerSupplier("forbidden_font_blood", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_INFERNAL = registerSupplier("forbidden_font_infernal", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_VOID = registerSupplier("forbidden_font_void", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> FORBIDDEN_FONT_HALLOWED = registerSupplier("forbidden_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.FORBIDDEN_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_EARTH = registerSupplier("heavenly_font_earth", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_EARTH.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_SEA = registerSupplier("heavenly_font_sea", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_SEA.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_SKY = registerSupplier("heavenly_font_sky", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_SKY.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_SUN = registerSupplier("heavenly_font_sun", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_SUN.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_MOON = registerSupplier("heavenly_font_moon", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_MOON.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_BLOOD = registerSupplier("heavenly_font_blood", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_BLOOD.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_INFERNAL = registerSupplier("heavenly_font_infernal", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_INFERNAL.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_VOID = registerSupplier("heavenly_font_void", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_VOID.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    public static final IRegistryItem<Item, ManaFontBlockItem> HEAVENLY_FONT_HALLOWED = registerSupplier("heavenly_font_hallowed", () -> new ManaFontBlockItem(BlocksPM.HEAVENLY_FONT_HALLOWED.get(), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)));
    ...
    public static final IRegistryItem<Item, PrimaliteTridentItem> PRIMALITE_TRIDENT = registerSupplier("primalite_trident", () -> new PrimaliteTridentItem(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final IRegistryItem<Item, PrimaliteShieldItem> PRIMALITE_SHIELD = registerSupplier("primalite_shield", () -> new PrimaliteShieldItem(new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final IRegistryItem<Item, HexiumTridentItem> HEXIUM_TRIDENT = registerSupplier("hexium_trident", () -> new HexiumTridentItem(new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final IRegistryItem<Item, HexiumShieldItem> HEXIUM_SHIELD = registerSupplier("hexium_shield", () -> new HexiumShieldItem(new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final IRegistryItem<Item, HallowsteelTridentItem> HALLOWSTEEL_TRIDENT = registerSupplier("hallowsteel_trident", () -> new HallowsteelTridentItem(new Item.Properties().rarity(Rarity.EPIC)));
    ...
    public static final IRegistryItem<Item, HallowsteelShieldItem> HALLOWSTEEL_SHIELD = registerSupplier("hallowsteel_shield", () -> new HallowsteelShieldItem(new Item.Properties().rarity(Rarity.EPIC)));
    ...
    public static final IRegistryItem<Item, ForbiddenTridentItem> FORBIDDEN_TRIDENT = registerDefaultInstance("forbidden_trident", () -> new ForbiddenTridentItem(new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> IMBUED_WOOL_CHEST = registerSupplier("imbued_wool_chest", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(8)).component(DataComponentsPM.MANA_DISCOUNT.get(), 2)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> IMBUED_WOOL_FEET = registerSupplier("imbued_wool_feet", () -> new RobeArmorItem(ArmorMaterialsPM.IMBUED_WOOL.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.COMMON).durability(ArmorItem.Type.BOOTS.getDurability(8)).component(DataComponentsPM.MANA_DISCOUNT.get(), 1)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> SPELLCLOTH_CHEST = registerSupplier("spellcloth_chest", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(20)).component(DataComponentsPM.MANA_DISCOUNT.get(), 3)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> SPELLCLOTH_FEET = registerSupplier("spellcloth_feet", () -> new RobeArmorItem(ArmorMaterialsPM.SPELLCLOTH.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.BOOTS.getDurability(20)).component(DataComponentsPM.MANA_DISCOUNT.get(), 2)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> HEXWEAVE_LEGS = registerSupplier("hexweave_legs", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.LEGGINGS.getDurability(35)).component(DataComponentsPM.MANA_DISCOUNT.get(), 4)));
    public static final IRegistryItem<Item, RobeArmorItem> HEXWEAVE_FEET = registerSupplier("hexweave_feet", () -> new RobeArmorItem(ArmorMaterialsPM.HEXWEAVE.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.BOOTS.getDurability(35)).component(DataComponentsPM.MANA_DISCOUNT.get(), 3)));
    public static final IRegistryItem<Item, RobeArmorItem> SAINTSWOOL_HEAD = registerSupplier("saintswool_head", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.HELMET.getDurability(50)).component(DataComponentsPM.MANA_DISCOUNT.get(), 4)));
    ...
    public static final IRegistryItem<Item, RobeArmorItem> SAINTSWOOL_LEGS = registerSupplier("saintswool_legs", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.LEGGINGS.getDurability(50)).component(DataComponentsPM.MANA_DISCOUNT.get(), 6)));
    public static final IRegistryItem<Item, RobeArmorItem> SAINTSWOOL_FEET = registerSupplier("saintswool_feet", () -> new RobeArmorItem(ArmorMaterialsPM.SAINTSWOOL.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.BOOTS.getDurability(50)).component(DataComponentsPM.MANA_DISCOUNT.get(), 4)));
    public static final IRegistryItem<Item, ArmorItem> PRIMALITE_HEAD = registerSupplier("primalite_head", () -> new ArmorItem(ArmorMaterialsPM.PRIMALITE.getHolder().get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.HELMET.getDurability(30))));
    public static final IRegistryItem<Item, ArmorItem> PRIMALITE_CHEST = registerSupplier("primalite_chest", () -> new ArmorItem(ArmorMaterialsPM.PRIMALITE.getHolder().get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.CHESTPLATE.getDurability(30))));
    public static final IRegistryItem<Item, ArmorItem> PRIMALITE_LEGS = registerSupplier("primalite_legs", () -> new ArmorItem(ArmorMaterialsPM.PRIMALITE.getHolder().get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.LEGGINGS.getDurability(30))));
    public static final IRegistryItem<Item, ArmorItem> PRIMALITE_FEET = registerSupplier("primalite_feet", () -> new ArmorItem(ArmorMaterialsPM.PRIMALITE.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.UNCOMMON).durability(ArmorItem.Type.BOOTS.getDurability(30))));
    public static final IRegistryItem<Item, ArmorItem> HEXIUM_HEAD = registerSupplier("hexium_head", () -> new ArmorItem(ArmorMaterialsPM.HEXIUM.getHolder().get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.HELMET.getDurability(45))));
    public static final IRegistryItem<Item, ArmorItem> HEXIUM_CHEST = registerSupplier("hexium_chest", () -> new ArmorItem(ArmorMaterialsPM.HEXIUM.getHolder().get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.CHESTPLATE.getDurability(45))));
    public static final IRegistryItem<Item, ArmorItem> HEXIUM_LEGS = registerSupplier("hexium_legs", () -> new ArmorItem(ArmorMaterialsPM.HEXIUM.getHolder().get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.LEGGINGS.getDurability(45))));
    public static final IRegistryItem<Item, ArmorItem> HEXIUM_FEET = registerSupplier("hexium_feet", () -> new ArmorItem(ArmorMaterialsPM.HEXIUM.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.RARE).durability(ArmorItem.Type.BOOTS.getDurability(45))));
    public static final IRegistryItem<Item, ArmorItem> HALLOWSTEEL_HEAD = registerSupplier("hallowsteel_head", () -> new ArmorItem(ArmorMaterialsPM.HALLOWSTEEL.getHolder().get(), ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.HELMET.getDurability(60))));
    public static final IRegistryItem<Item, ArmorItem> HALLOWSTEEL_CHEST = registerSupplier("hallowsteel_chest", () -> new ArmorItem(ArmorMaterialsPM.HALLOWSTEEL.getHolder().get(), ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.CHESTPLATE.getDurability(60))));
    public static final IRegistryItem<Item, ArmorItem> HALLOWSTEEL_LEGS = registerSupplier("hallowsteel_legs", () -> new ArmorItem(ArmorMaterialsPM.HALLOWSTEEL.getHolder().get(), ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.LEGGINGS.getDurability(60))));
    public static final IRegistryItem<Item, ArmorItem> HALLOWSTEEL_FEET = registerSupplier("hallowsteel_feet", () -> new ArmorItem(ArmorMaterialsPM.HALLOWSTEEL.getHolder().get(), ArmorItem.Type.BOOTS, new Item.Properties().rarity(Rarity.EPIC).durability(ArmorItem.Type.BOOTS.getDurability(60))));
